...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/v17/secretmanagerregionalsecretversion"
...
&secretmanagerregionalsecretversion.SecretManagerRegionalSecretVersionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google/v17.secretManagerRegionalSecretVersion.SecretManagerRegionalSecretVersionTimeouts,
}
```
