...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/secretmanagerregionalsecretversion"
...
&secretmanagerregionalsecretversion.SecretManagerRegionalSecretVersionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.secretManagerRegionalSecretVersion.SecretManagerRegionalSecretVersionTimeouts,
}
```
