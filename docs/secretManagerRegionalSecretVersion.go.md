...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/v18/secretmanagerregionalsecretversion"
...
&secretmanagerregionalsecretversion.SecretManagerRegionalSecretVersionConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google/v18.secretManagerRegionalSecretVersion.SecretManagerRegionalSecretVersionTimeouts,
}
```
