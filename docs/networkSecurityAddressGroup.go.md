...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/networksecurityaddressgroup"
...
&networksecurityaddressgroup.NetworkSecurityAddressGroupConfig {
	...
	Parent: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.networkSecurityAddressGroup.NetworkSecurityAddressGroupTimeouts,
}
```
