...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/apigeeendpointattachment"
...
&apigeeendpointattachment.ApigeeEndpointAttachmentConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.apigeeEndpointAttachment.ApigeeEndpointAttachmentTimeouts,
}
```
