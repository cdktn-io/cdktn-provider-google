...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/v17/loggingfoldersettings"
...
&loggingfoldersettings.LoggingFolderSettingsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google/v17.loggingFolderSettings.LoggingFolderSettingsTimeouts,
}
```
