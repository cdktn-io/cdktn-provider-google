...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/gkebackupbackupchannel"
...
&gkebackupbackupchannel.GkeBackupBackupChannelConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.gkeBackupBackupChannel.GkeBackupBackupChannelTimeouts,
}
```
