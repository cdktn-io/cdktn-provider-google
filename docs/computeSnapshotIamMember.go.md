...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/computesnapshotiammember"
...
&computesnapshotiammember.ComputeSnapshotIamMemberConfig {
	...
	Name: *string,
	Role: *string,
	Condition: github.com/cdktn-io/cdktn-provider-google-go/google.computeSnapshotIamMember.ComputeSnapshotIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
