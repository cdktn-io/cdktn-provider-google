...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/developerconnectgitrepositorylink"
...
&developerconnectgitrepositorylink.DeveloperConnectGitRepositoryLinkConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.developerConnectGitRepositoryLink.DeveloperConnectGitRepositoryLinkTimeouts,
}
```
