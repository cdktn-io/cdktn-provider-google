...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/networksecuritymirroringdeployment"
...
&networksecuritymirroringdeployment.NetworkSecurityMirroringDeploymentConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.networkSecurityMirroringDeployment.NetworkSecurityMirroringDeploymentTimeouts,
}
```
