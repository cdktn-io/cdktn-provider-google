...
| <code><a href="#@cdktn/provider-google.loggingProjectSink.LoggingProjectSinkConfig.property.uniqueWriterIdentity">UniqueWriterIdentity</a></code> | <code>interface{}</code> | Whether to use a service agent as the writer_identity for this sink. |
