...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/oracledatabaseodbsubnet"
...
&oracledatabaseodbsubnet.OracleDatabaseOdbSubnetConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.oracleDatabaseOdbSubnet.OracleDatabaseOdbSubnetTimeouts,
}
```
