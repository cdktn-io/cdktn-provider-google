...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/biglaketable"
...
&biglaketable.BiglakeTableConfig {
	...
	Name: *string,
	Database: *string,
	HiveOptions: github.com/cdktn-io/cdktn-provider-google-go/google.biglakeTable.BiglakeTableHiveOptions,
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.biglakeTable.BiglakeTableTimeouts,
	Type: *string,
}
```
...
&biglaketable.BiglakeTableHiveOptions {
	...
	StorageDescriptor: github.com/cdktn-io/cdktn-provider-google-go/google.biglakeTable.BiglakeTableHiveOptionsStorageDescriptor,
	TableType: *string,
}
```
