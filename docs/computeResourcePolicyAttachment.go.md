...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/computeresourcepolicyattachment"
...
&computeresourcepolicyattachment.ComputeResourcePolicyAttachmentConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.computeResourcePolicyAttachment.ComputeResourcePolicyAttachmentTimeouts,
	Zone: *string,
}
```
