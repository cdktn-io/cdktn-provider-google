...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/gkehubscope"
...
&gkehubscope.GkeHubScopeConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.gkeHubScope.GkeHubScopeTimeouts,
}
```
