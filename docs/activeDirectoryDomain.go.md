...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/activedirectorydomain"
...
&activedirectorydomain.ActiveDirectoryDomainConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.activeDirectoryDomain.ActiveDirectoryDomainTimeouts,
}
```
