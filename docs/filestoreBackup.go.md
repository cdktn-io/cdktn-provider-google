...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/v17/filestorebackup"
...
&filestorebackup.FilestoreBackupConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google/v17.filestoreBackup.FilestoreBackupTimeouts,
}
```
