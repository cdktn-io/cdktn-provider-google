...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/v18/filestorebackup"
...
&filestorebackup.FilestoreBackupConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google/v18.filestoreBackup.FilestoreBackupTimeouts,
}
```
