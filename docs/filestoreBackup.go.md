...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/v19/filestorebackup"
...
&filestorebackup.FilestoreBackupConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google/v19.filestoreBackup.FilestoreBackupTimeouts,
}
```
