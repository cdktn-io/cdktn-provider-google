...
##### `privateKey`<sup>Required</sup> <a name="privateKey" id="@cdktn/provider-google.computeRegionSslCertificate.ComputeRegionSslCertificate.Initializer.parameter.privateKey"></a>
