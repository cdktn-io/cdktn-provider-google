...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/edgenetworknetwork"
...
&edgenetworknetwork.EdgenetworkNetworkConfig {
	...
	Mtu: *f64,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.edgenetworkNetwork.EdgenetworkNetworkTimeouts,
}
```
