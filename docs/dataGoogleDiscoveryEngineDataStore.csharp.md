...
| <code><a href="#@cdktn/provider-google.dataGoogleDiscoveryEngineDataStore.DataGoogleDiscoveryEngineDataStore.property.aclEnabled">AclEnabled</a></code> | <code>Io.Cdktn.IResolvable</code> | *No description.* |
...
```csharp
public IResolvable AclEnabled { get; }
```
