...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/networkserviceslbtrafficextension"
...
&networkserviceslbtrafficextension.NetworkServicesLbTrafficExtensionConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.networkServicesLbTrafficExtension.NetworkServicesLbTrafficExtensionTimeouts,
}
```
...
&networkserviceslbtrafficextension.NetworkServicesLbTrafficExtensionExtensionChains {
	...
	MatchCondition: github.com/cdktn-io/cdktn-provider-google-go/google.networkServicesLbTrafficExtension.NetworkServicesLbTrafficExtensionExtensionChainsMatchCondition,
	Name: *string,
}
```
