...
| <code><a href="#@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.toHclTerraform">ToHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.addMoveTarget">AddMoveTarget</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.hasResourceMove">HasResourceMove</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.importFrom">ImportFrom</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.moveFromId">MoveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.moveTo">MoveTo</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.moveToId">MoveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `ToHclTerraform` <a name="ToHclTerraform" id="@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.toHclTerraform"></a>
...
##### `AddMoveTarget` <a name="AddMoveTarget" id="@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.addMoveTarget"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.addMoveTarget.parameter.moveTarget"></a>
...
##### `HasResourceMove` <a name="HasResourceMove" id="@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.hasResourceMove"></a>

```go
func HasResourceMove() interface{}
```

##### `ImportFrom` <a name="ImportFrom" id="@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.importFrom"></a>
...
##### `MoveFromId` <a name="MoveFromId" id="@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.moveFromId"></a>
...
##### `MoveTo` <a name="MoveTo" id="@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.moveTo"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.moveTo.parameter.moveTarget"></a>
...
##### `MoveToId` <a name="MoveToId" id="@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.moveToId"></a>
...
| <code><a href="#@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.generateConfigForImport">GenerateConfigForImport</a></code> | Generates CDKTF code for importing a EndpointsServiceIamPolicy resource upon running "cdktf plan <stack-name>". |
...
###### `importToId`<sup>Required</sup> <a name="importToId" id="@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.generateConfigForImport.parameter.importToId"></a>
...
###### `importFromId`<sup>Required</sup> <a name="importFromId" id="@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.generateConfigForImport.parameter.importFromId"></a>
...
| <code><a href="#@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicy.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicyConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.endpointsServiceIamPolicy.EndpointsServiceIamPolicyConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/endpoints_service_iam_policy#id EndpointsServiceIamPolicy#id}. |
