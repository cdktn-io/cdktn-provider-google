...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/v16/parallelstoreinstance"
...
&parallelstoreinstance.ParallelstoreInstanceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google/v16.parallelstoreInstance.ParallelstoreInstanceTimeouts,
}
```
