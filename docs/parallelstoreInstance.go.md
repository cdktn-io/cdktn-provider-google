...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/parallelstoreinstance"
...
&parallelstoreinstance.ParallelstoreInstanceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.parallelstoreInstance.ParallelstoreInstanceTimeouts,
}
```
