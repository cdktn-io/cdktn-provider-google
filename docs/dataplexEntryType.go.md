...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/dataplexentrytype"
...
&dataplexentrytype.DataplexEntryTypeConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.dataplexEntryType.DataplexEntryTypeTimeouts,
	TypeAliases: *[]*string,
}
```
