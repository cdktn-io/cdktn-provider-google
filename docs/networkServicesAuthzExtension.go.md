...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/networkservicesauthzextension"
...
&networkservicesauthzextension.NetworkServicesAuthzExtensionConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.networkServicesAuthzExtension.NetworkServicesAuthzExtensionTimeouts,
	WireFormat: *string,
}
```
