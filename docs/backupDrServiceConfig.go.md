...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/backupdrserviceconfig"
...
&backupdrserviceconfig.BackupDrServiceConfigConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.backupDrServiceConfig.BackupDrServiceConfigTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.backupDrServiceConfig.BackupDrServiceConfigConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/backup_dr_service_config#id BackupDrServiceConfig#id}. |
