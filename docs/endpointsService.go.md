...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/endpointsservice"
...
&endpointsservice.EndpointsServiceConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.endpointsService.EndpointsServiceTimeouts,
}
```
