...
&storagetransferjob.StorageTransferJobTransferSpecAzureBlobStorageDataSource {
	...
	FederatedIdentityConfig: github.com/cdktf/cdktf-provider-google-go/google.storageTransferJob.StorageTransferJobTransferSpecAzureBlobStorageDataSourceFederatedIdentityConfig,
	Path: *string,
}
```
