...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/networkservicesservicebinding"
...
&networkservicesservicebinding.NetworkServicesServiceBindingConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.networkServicesServiceBinding.NetworkServicesServiceBindingTimeouts,
}
```
