...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/oracledatabaseodbnetwork"
...
&oracledatabaseodbnetwork.OracleDatabaseOdbNetworkConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.oracleDatabaseOdbNetwork.OracleDatabaseOdbNetworkTimeouts,
}
```
