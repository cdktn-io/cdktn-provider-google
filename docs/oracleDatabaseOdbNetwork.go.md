...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/oracledatabaseodbnetwork"
...
&oracledatabaseodbnetwork.OracleDatabaseOdbNetworkConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.oracleDatabaseOdbNetwork.OracleDatabaseOdbNetworkTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.oracleDatabaseOdbNetwork.OracleDatabaseOdbNetworkConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/oracle_database_odb_network#id OracleDatabaseOdbNetwork#id}. |
