...
&identityplatformtenant.IdentityPlatformTenantClient {
	Permissions: github.com/cdktf/cdktf-provider-google-go/google.identityPlatformTenant.IdentityPlatformTenantClientPermissions,
}
```
...
&identityplatformtenant.IdentityPlatformTenantConfig {
	...
	Client: github.com/cdktf/cdktf-provider-google-go/google.identityPlatformTenant.IdentityPlatformTenantClient,
