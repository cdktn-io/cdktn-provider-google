...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/networkservicestlsroute"
...
&networkservicestlsroute.NetworkServicesTlsRouteConfig {
	...
	Meshes: *[]*string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.networkServicesTlsRoute.NetworkServicesTlsRouteTimeouts,
}
```
...
&networkservicestlsroute.NetworkServicesTlsRouteRules {
	Action: github.com/cdktf/cdktf-provider-google-go/google.networkServicesTlsRoute.NetworkServicesTlsRouteRulesAction,
	Matches: interface{},
}
```
