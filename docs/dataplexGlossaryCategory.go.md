...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/dataplexglossarycategory"
...
&dataplexglossarycategory.DataplexGlossaryCategoryConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.dataplexGlossaryCategory.DataplexGlossaryCategoryTimeouts,
}
```
