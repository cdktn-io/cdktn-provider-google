...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/parametermanagerparameter"
...
&parametermanagerparameter.ParameterManagerParameterConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.parameterManagerParameter.ParameterManagerParameterTimeouts,
}
```
