...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/parametermanagerparameter"
...
&parametermanagerparameter.ParameterManagerParameterConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.parameterManagerParameter.ParameterManagerParameterTimeouts,
}
```
