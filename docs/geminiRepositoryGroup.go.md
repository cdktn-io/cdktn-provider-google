...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/geminirepositorygroup"
...
&geminirepositorygroup.GeminiRepositoryGroupConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.geminiRepositoryGroup.GeminiRepositoryGroupTimeouts,
}
```
