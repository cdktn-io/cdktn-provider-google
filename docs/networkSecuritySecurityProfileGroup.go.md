...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/networksecuritysecurityprofilegroup"
...
&networksecuritysecurityprofilegroup.NetworkSecuritySecurityProfileGroupConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.networkSecuritySecurityProfileGroup.NetworkSecuritySecurityProfileGroupTimeouts,
}
```
