...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/apigeesharedflow"
...
&apigeesharedflow.ApigeeSharedflowConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.apigeeSharedflow.ApigeeSharedflowTimeouts,
}
```
