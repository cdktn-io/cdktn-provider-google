...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/lustreinstance"
...
&lustreinstance.LustreInstanceConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.lustreInstance.LustreInstanceTimeouts,
}
```
