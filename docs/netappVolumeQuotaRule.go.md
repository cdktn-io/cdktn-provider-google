...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/netappvolumequotarule"
...
&netappvolumequotarule.NetappVolumeQuotaRuleConfig {
	...
	Project: *string,
	Target: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.netappVolumeQuotaRule.NetappVolumeQuotaRuleTimeouts,
}
```
...
| <code><a href="#@cdktf/provider-google.netappVolumeQuotaRule.NetappVolumeQuotaRuleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/netapp_volume_quota_rule#id NetappVolumeQuotaRule#id}. |
