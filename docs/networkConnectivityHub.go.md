...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/networkconnectivityhub"
...
&networkconnectivityhub.NetworkConnectivityHubConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.networkConnectivityHub.NetworkConnectivityHubTimeouts,
}
```
