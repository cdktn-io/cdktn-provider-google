...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/activedirectorydomaintrust"
...
&activedirectorydomaintrust.ActiveDirectoryDomainTrustConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.activeDirectoryDomainTrust.ActiveDirectoryDomainTrustTimeouts,
}
```
