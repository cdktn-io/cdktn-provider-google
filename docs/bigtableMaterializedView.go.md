...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/bigtablematerializedview"
...
&bigtablematerializedview.BigtableMaterializedViewConfig {
	...
	Instance: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.bigtableMaterializedView.BigtableMaterializedViewTimeouts,
}
```
