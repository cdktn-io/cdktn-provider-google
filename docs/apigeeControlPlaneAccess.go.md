...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/apigeecontrolplaneaccess"
...
&apigeecontrolplaneaccess.ApigeeControlPlaneAccessConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.apigeeControlPlaneAccess.ApigeeControlPlaneAccessTimeouts,
}
```
