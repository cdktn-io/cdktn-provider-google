...
```csharp
private void PutScheduleCustomizations(ChronicleRuleDeploymentScheduleCustomizations Value)
```
...
```csharp
public ChronicleRuleDeploymentScheduleCustomizationsOutputReference ScheduleCustomizations { get; }
```
...
```csharp
public ChronicleRuleDeploymentScheduleCustomizations ScheduleCustomizationsInput { get; }
```
...
new ChronicleRuleDeploymentConfig {
    ...
    ChronicleRuleDeploymentScheduleCustomizations ScheduleCustomizations = null,
...
```csharp
public ChronicleRuleDeploymentScheduleCustomizations ScheduleCustomizations { get; set; }
```
...
new ChronicleRuleDeploymentScheduleCustomizations {
...
new ChronicleRuleDeploymentScheduleCustomizationsOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google.chronicleRuleDeployment.ChronicleRuleDeploymentScheduleCustomizationsOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-google.chronicleRuleDeployment.ChronicleRuleDeploymentScheduleCustomizationsOutputReference.resolve.parameter._context"></a>
...
| <code><a href="#@cdktn/provider-google.chronicleRuleDeployment.ChronicleRuleDeploymentScheduleCustomizationsOutputReference.property.ensureEnrichmentCompletenessInput">EnsureEnrichmentCompletenessInput</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.chronicleRuleDeployment.ChronicleRuleDeploymentScheduleCustomizationsOutputReference.property.ensureEnrichmentCompleteness">EnsureEnrichmentCompleteness</a></code> | <code>bool\|Io.Cdktn.IResolvable</code> | *No description.* |
...
```csharp
public ChronicleRuleDeploymentScheduleCustomizations InternalValue { get; }
```
