...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/netappactivedirectory"
...
&netappactivedirectory.NetappActiveDirectoryConfig {
	...
	Site: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.netappActiveDirectory.NetappActiveDirectoryTimeouts,
}
```
