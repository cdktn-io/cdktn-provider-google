...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/kmsautokeyconfig"
...
&kmsautokeyconfig.KmsAutokeyConfigConfig {
	...
	Id: *string,
	KeyProject: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.kmsAutokeyConfig.KmsAutokeyConfigTimeouts,
}
```
