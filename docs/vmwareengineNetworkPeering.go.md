...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/vmwareenginenetworkpeering"
...
&vmwareenginenetworkpeering.VmwareengineNetworkPeeringConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.vmwareengineNetworkPeering.VmwareengineNetworkPeeringTimeouts,
}
```
