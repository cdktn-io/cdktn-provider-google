...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/storagebucketiambinding"
...
&storagebucketiambinding.StorageBucketIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktn-io/cdktn-provider-google-go/google.storageBucketIamBinding.StorageBucketIamBindingCondition,
	Id: *string,
}
```
