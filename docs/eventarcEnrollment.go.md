...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/eventarcenrollment"
...
&eventarcenrollment.EventarcEnrollmentConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.eventarcEnrollment.EventarcEnrollmentTimeouts,
}
```
