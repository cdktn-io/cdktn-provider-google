...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/eventarcenrollment"
...
&eventarcenrollment.EventarcEnrollmentConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.eventarcEnrollment.EventarcEnrollmentTimeouts,
}
```
