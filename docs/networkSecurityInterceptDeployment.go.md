...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/networksecurityinterceptdeployment"
...
&networksecurityinterceptdeployment.NetworkSecurityInterceptDeploymentConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.networkSecurityInterceptDeployment.NetworkSecurityInterceptDeploymentTimeouts,
}
```
