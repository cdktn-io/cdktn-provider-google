...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/networksecurityinterceptdeployment"
...
&networksecurityinterceptdeployment.NetworkSecurityInterceptDeploymentConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.networkSecurityInterceptDeployment.NetworkSecurityInterceptDeploymentTimeouts,
}
```
