...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/v18/eventarcchannel"
...
&eventarcchannel.EventarcChannelConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google/v18.eventarcChannel.EventarcChannelTimeouts,
}
```
