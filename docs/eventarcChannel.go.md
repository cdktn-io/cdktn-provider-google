...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/eventarcchannel"
...
&eventarcchannel.EventarcChannelConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.eventarcChannel.EventarcChannelTimeouts,
}
```
