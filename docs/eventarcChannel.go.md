...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/v17/eventarcchannel"
...
&eventarcchannel.EventarcChannelConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google/v17.eventarcChannel.EventarcChannelTimeouts,
}
```
