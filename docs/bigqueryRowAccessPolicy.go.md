...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/bigqueryrowaccesspolicy"
...
&bigqueryrowaccesspolicy.BigqueryRowAccessPolicyConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.bigqueryRowAccessPolicy.BigqueryRowAccessPolicyTimeouts,
}
```
