...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/securesourcemanagerbranchrule"
...
&securesourcemanagerbranchrule.SecureSourceManagerBranchRuleConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.secureSourceManagerBranchRule.SecureSourceManagerBranchRuleTimeouts,
}
```
