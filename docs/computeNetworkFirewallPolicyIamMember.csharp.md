...
new ComputeNetworkFirewallPolicyIamMember(Construct Scope, string Id, ComputeNetworkFirewallPolicyIamMemberConfig Config);
```
...
```csharp
private void PutCondition(ComputeNetworkFirewallPolicyIamMemberCondition Value)
```
...
ComputeNetworkFirewallPolicyIamMember.IsConstruct(object X);
```
...
ComputeNetworkFirewallPolicyIamMember.IsTerraformElement(object X);
```
...
ComputeNetworkFirewallPolicyIamMember.IsTerraformResource(object X);
```
...
ComputeNetworkFirewallPolicyIamMember.GenerateConfigForImport(Construct Scope, string ImportToId, string ImportFromId, TerraformProvider Provider = null);
```
...
| <code><a href="#@cdktn/provider-google.computeNetworkFirewallPolicyIamMember.ComputeNetworkFirewallPolicyIamMember.property.cdktfStack">CdktfStack</a></code> | <code>Io.Cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.computeNetworkFirewallPolicyIamMember.ComputeNetworkFirewallPolicyIamMember.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>System.Collections.Generic.IDictionary<string, object></code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.computeNetworkFirewallPolicyIamMember.ComputeNetworkFirewallPolicyIamMember.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>Io.Cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.computeNetworkFirewallPolicyIamMember.ComputeNetworkFirewallPolicyIamMember.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.computeNetworkFirewallPolicyIamMember.ComputeNetworkFirewallPolicyIamMember.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.computeNetworkFirewallPolicyIamMember.ComputeNetworkFirewallPolicyIamMember.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.computeNetworkFirewallPolicyIamMember.ComputeNetworkFirewallPolicyIamMember.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.computeNetworkFirewallPolicyIamMember.ComputeNetworkFirewallPolicyIamMember.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.computeNetworkFirewallPolicyIamMember.ComputeNetworkFirewallPolicyIamMember.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```csharp
public ComputeNetworkFirewallPolicyIamMemberConditionOutputReference Condition { get; }
```
...
```csharp
public ComputeNetworkFirewallPolicyIamMemberCondition ConditionInput { get; }
```
...
new ComputeNetworkFirewallPolicyIamMemberCondition {
    string Expression,
    string Title,
...
new ComputeNetworkFirewallPolicyIamMemberConfig {
    ...
    string Name,
    string Role,
    ComputeNetworkFirewallPolicyIamMemberCondition Condition = null,
    string Id = null,
    string Project = null
};
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google.computeNetworkFirewallPolicyIamMember.ComputeNetworkFirewallPolicyIamMemberConfig.property.connection">Connection</a></code> | <code>Io.Cdktn.SSHProvisionerConnection\|Io.Cdktn.WinrmProvisionerConnection</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.computeNetworkFirewallPolicyIamMember.ComputeNetworkFirewallPolicyIamMemberConfig.property.count">Count</a></code> | <code>double\|Io.Cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.computeNetworkFirewallPolicyIamMember.ComputeNetworkFirewallPolicyIamMemberConfig.property.dependsOn">DependsOn</a></code> | <code>Io.Cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.computeNetworkFirewallPolicyIamMember.ComputeNetworkFirewallPolicyIamMemberConfig.property.forEach">ForEach</a></code> | <code>Io.Cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.computeNetworkFirewallPolicyIamMember.ComputeNetworkFirewallPolicyIamMemberConfig.property.lifecycle">Lifecycle</a></code> | <code>Io.Cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.computeNetworkFirewallPolicyIamMember.ComputeNetworkFirewallPolicyIamMemberConfig.property.provider">Provider</a></code> | <code>Io.Cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.computeNetworkFirewallPolicyIamMember.ComputeNetworkFirewallPolicyIamMemberConfig.property.provisioners">Provisioners</a></code> | <code>Io.Cdktn.FileProvisioner\|Io.Cdktn.LocalExecProvisioner\|Io.Cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```csharp
public ComputeNetworkFirewallPolicyIamMemberCondition Condition { get; set; }
```
...
new ComputeNetworkFirewallPolicyIamMemberConditionOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google.computeNetworkFirewallPolicyIamMember.ComputeNetworkFirewallPolicyIamMemberConditionOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-google.computeNetworkFirewallPolicyIamMember.ComputeNetworkFirewallPolicyIamMemberConditionOutputReference.resolve.parameter._context"></a>
...
```csharp
public ComputeNetworkFirewallPolicyIamMemberCondition InternalValue { get; }
```
