...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/storagemanagedfolder"
...
&storagemanagedfolder.StorageManagedFolderConfig {
	...
	Id: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.storageManagedFolder.StorageManagedFolderTimeouts,
}
```
