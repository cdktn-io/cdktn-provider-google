...
&beyondcorpapplication.BeyondcorpApplicationUpstreams {
	EgressPolicy: github.com/cdktf/cdktf-provider-google-go/google.beyondcorpApplication.BeyondcorpApplicationUpstreamsEgressPolicy,
	Network: github.com/cdktf/cdktf-provider-google-go/google.beyondcorpApplication.BeyondcorpApplicationUpstreamsNetwork,
}
```
