...
new BiglakeTableHiveOptionsStorageDescriptor {
    ...
    BiglakeTableHiveOptionsStorageDescriptorSerdeInfo SerdeInfo = null
};
```
...
```csharp
public BiglakeTableHiveOptionsStorageDescriptorSerdeInfo SerdeInfo { get; set; }
```
...
new BiglakeTableHiveOptionsStorageDescriptorSerdeInfo {
...
```csharp
private void PutSerdeInfo(BiglakeTableHiveOptionsStorageDescriptorSerdeInfo Value)
```
...
```csharp
public BiglakeTableHiveOptionsStorageDescriptorSerdeInfoOutputReference SerdeInfo { get; }
```
...
```csharp
public BiglakeTableHiveOptionsStorageDescriptorSerdeInfo SerdeInfoInput { get; }
```
...
new BiglakeTableHiveOptionsStorageDescriptorSerdeInfoOutputReference(IInterpolatingParent TerraformResource, string TerraformAttribute);
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google.biglakeTable.BiglakeTableHiveOptionsStorageDescriptorSerdeInfoOutputReference.Initializer.parameter.terraformResource">TerraformResource</a></code> | <code>Io.Cdktn.IInterpolatingParent</code> | The parent resource. |
...
###### `Context`<sup>Required</sup> <a name="Context" id="@cdktn/provider-google.biglakeTable.BiglakeTableHiveOptionsStorageDescriptorSerdeInfoOutputReference.resolve.parameter._context"></a>
...
```csharp
public BiglakeTableHiveOptionsStorageDescriptorSerdeInfo InternalValue { get; }
```
