...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/integrationconnectorsmanagedzone"
...
&integrationconnectorsmanagedzone.IntegrationConnectorsManagedZoneConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.integrationConnectorsManagedZone.IntegrationConnectorsManagedZoneTimeouts,
}
```
