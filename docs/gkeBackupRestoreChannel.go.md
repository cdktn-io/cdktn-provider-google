...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/gkebackuprestorechannel"
...
&gkebackuprestorechannel.GkeBackupRestoreChannelConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.gkeBackupRestoreChannel.GkeBackupRestoreChannelTimeouts,
}
```
