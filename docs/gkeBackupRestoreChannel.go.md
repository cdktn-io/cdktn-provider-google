...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/gkebackuprestorechannel"
...
&gkebackuprestorechannel.GkeBackupRestoreChannelConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.gkeBackupRestoreChannel.GkeBackupRestoreChannelTimeouts,
}
```
