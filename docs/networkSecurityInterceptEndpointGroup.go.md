...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/networksecurityinterceptendpointgroup"
...
&networksecurityinterceptendpointgroup.NetworkSecurityInterceptEndpointGroupConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.networkSecurityInterceptEndpointGroup.NetworkSecurityInterceptEndpointGroupTimeouts,
}
```
