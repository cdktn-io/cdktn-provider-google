...
| <code><a href="#@cdktn/provider-google.workstationsWorkstationConfig.WorkstationsWorkstationConfigHostGceInstance.property.instanceMetadata">instanceMetadata</a></code> | <code>{[ key: string ]: string}</code> | Client-specified metadata key-value pairs, to be passed to the start-up script in the VM. |
...
| <code><a href="#@cdktn/provider-google.workstationsWorkstationConfig.WorkstationsWorkstationConfigHostGceInstanceOutputReference.property.instanceMetadataInput">instanceMetadataInput</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.workstationsWorkstationConfig.WorkstationsWorkstationConfigHostGceInstanceOutputReference.property.instanceMetadata">instanceMetadata</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
