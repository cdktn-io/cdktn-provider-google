...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/edgenetworksubnet"
...
&edgenetworksubnet.EdgenetworkSubnetConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.edgenetworkSubnet.EdgenetworkSubnetTimeouts,
	VlanId: *f64,
}
```
