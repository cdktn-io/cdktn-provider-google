...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/computestoragepooliambinding"
...
&computestoragepooliambinding.ComputeStoragePoolIamBindingConfig {
	...
	Name: *string,
	Role: *string,
	Condition: github.com/cdktf/cdktf-provider-google-go/google.computeStoragePoolIamBinding.ComputeStoragePoolIamBindingCondition,
	Id: *string,
	Project: *string,
	Zone: *string,
}
