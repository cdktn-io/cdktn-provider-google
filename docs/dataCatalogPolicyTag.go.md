...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/v17/datacatalogpolicytag"
...
&datacatalogpolicytag.DataCatalogPolicyTagConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google/v17.dataCatalogPolicyTag.DataCatalogPolicyTagTimeouts,
}
```
