...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/datacatalogpolicytag"
...
&datacatalogpolicytag.DataCatalogPolicyTagConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.dataCatalogPolicyTag.DataCatalogPolicyTagTimeouts,
}
```
