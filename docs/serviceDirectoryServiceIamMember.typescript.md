...
```typescript
import { serviceDirectoryServiceIamMember } from '@cdktn/provider-google'

new serviceDirectoryServiceIamMember.ServiceDirectoryServiceIamMember(scope: Construct, id: string, config: ServiceDirectoryServiceIamMemberConfig)
```
...
```typescript
public putCondition(value: ServiceDirectoryServiceIamMemberCondition): void
```
...
serviceDirectoryServiceIamMember.ServiceDirectoryServiceIamMember.isConstruct(x: any)
```
...
serviceDirectoryServiceIamMember.ServiceDirectoryServiceIamMember.isTerraformElement(x: any)
```
...
serviceDirectoryServiceIamMember.ServiceDirectoryServiceIamMember.isTerraformResource(x: any)
```
...
serviceDirectoryServiceIamMember.ServiceDirectoryServiceIamMember.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-google.serviceDirectoryServiceIamMember.ServiceDirectoryServiceIamMember.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.serviceDirectoryServiceIamMember.ServiceDirectoryServiceIamMember.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.serviceDirectoryServiceIamMember.ServiceDirectoryServiceIamMember.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.serviceDirectoryServiceIamMember.ServiceDirectoryServiceIamMember.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.serviceDirectoryServiceIamMember.ServiceDirectoryServiceIamMember.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.serviceDirectoryServiceIamMember.ServiceDirectoryServiceIamMember.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly condition: ServiceDirectoryServiceIamMemberConditionOutputReference;
```
...
```typescript
public readonly conditionInput: ServiceDirectoryServiceIamMemberCondition;
```
...
const serviceDirectoryServiceIamMemberCondition: serviceDirectoryServiceIamMember.ServiceDirectoryServiceIamMemberCondition = { ... }
```
...
const serviceDirectoryServiceIamMemberConfig: serviceDirectoryServiceIamMember.ServiceDirectoryServiceIamMemberConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-google.serviceDirectoryServiceIamMember.ServiceDirectoryServiceIamMemberConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.serviceDirectoryServiceIamMember.ServiceDirectoryServiceIamMemberConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.serviceDirectoryServiceIamMember.ServiceDirectoryServiceIamMemberConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.serviceDirectoryServiceIamMember.ServiceDirectoryServiceIamMemberConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly condition: ServiceDirectoryServiceIamMemberCondition;
```
...
new serviceDirectoryServiceIamMember.ServiceDirectoryServiceIamMemberConditionOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google.serviceDirectoryServiceIamMember.ServiceDirectoryServiceIamMemberConditionOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: ServiceDirectoryServiceIamMemberCondition;
```
