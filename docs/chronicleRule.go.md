...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/chroniclerule"
...
&chroniclerule.ChronicleRuleConfig {
	...
	Scope: *string,
	Text: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.chronicleRule.ChronicleRuleTimeouts,
}
```
