...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/firebasedataconnectservice"
...
&firebasedataconnectservice.FirebaseDataConnectServiceConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.firebaseDataConnectService.FirebaseDataConnectServiceTimeouts,
}
```
