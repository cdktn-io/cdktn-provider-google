...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/sccorganizationsccbigqueryexport"
...
&sccorganizationsccbigqueryexport.SccOrganizationSccBigQueryExportConfig {
	...
	Filter: *string,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.sccOrganizationSccBigQueryExport.SccOrganizationSccBigQueryExportTimeouts,
}
```
