...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/migrationcentergroup"
...
&migrationcentergroup.MigrationCenterGroupConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.migrationCenterGroup.MigrationCenterGroupTimeouts,
}
```
