...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/appenginefirewallrule"
...
&appenginefirewallrule.AppEngineFirewallRuleConfig {
	...
	Priority: *f64,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.appEngineFirewallRule.AppEngineFirewallRuleTimeouts,
}
```
