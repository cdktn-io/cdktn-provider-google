...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/edgenetworkinterconnectattachment"
...
&edgenetworkinterconnectattachment.EdgenetworkInterconnectAttachmentConfig {
	...
	Mtu: *f64,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.edgenetworkInterconnectAttachment.EdgenetworkInterconnectAttachmentTimeouts,
}
```
