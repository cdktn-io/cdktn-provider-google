...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/dataplexglossaryterm"
...
&dataplexglossaryterm.DataplexGlossaryTermConfig {
	...
	Project: *string,
	TermId: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.dataplexGlossaryTerm.DataplexGlossaryTermTimeouts,
}
```
