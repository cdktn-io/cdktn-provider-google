...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/computenetworkpeering"
...
&computenetworkpeering.ComputeNetworkPeeringConfig {
	...
	StackType: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.computeNetworkPeering.ComputeNetworkPeeringTimeouts,
}
```
