...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/v16/loggingorganizationsettings"
...
&loggingorganizationsettings.LoggingOrganizationSettingsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google/v16.loggingOrganizationSettings.LoggingOrganizationSettingsTimeouts,
}
```
