...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/loggingorganizationsettings"
...
&loggingorganizationsettings.LoggingOrganizationSettingsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.loggingOrganizationSettings.LoggingOrganizationSettingsTimeouts,
}
```
