...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/v18/loggingorganizationsettings"
...
&loggingorganizationsettings.LoggingOrganizationSettingsConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google/v18.loggingOrganizationSettings.LoggingOrganizationSettingsTimeouts,
}
```
