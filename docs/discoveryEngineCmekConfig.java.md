...
##### `cmekConfigId`<sup>Optional</sup> <a name="cmekConfigId" id="@cdktn/provider-google.discoveryEngineCmekConfig.DiscoveryEngineCmekConfig.Initializer.parameter.cmekConfigId"></a>
