...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/spannerinstancepartition"
...
&spannerinstancepartition.SpannerInstancePartitionConfig {
	...
	ProcessingUnits: *f64,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.spannerInstancePartition.SpannerInstancePartitionTimeouts,
}
```
