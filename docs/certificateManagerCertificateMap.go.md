...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/certificatemanagercertificatemap"
...
&certificatemanagercertificatemap.CertificateManagerCertificateMapConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.certificateManagerCertificateMap.CertificateManagerCertificateMapTimeouts,
}
```
