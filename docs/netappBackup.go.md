...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/netappbackup"
...
&netappbackup.NetappBackupConfig {
	...
	SourceVolume: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.netappBackup.NetappBackupTimeouts,
}
```
