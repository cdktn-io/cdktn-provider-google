...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/v16/folder"
...
&folder.FolderConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google/v16.folder.FolderTimeouts,
}
```
