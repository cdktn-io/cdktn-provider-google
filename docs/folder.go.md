...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/v20/folder"
...
&folder.FolderConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google/v20.folder.FolderTimeouts,
}
```
