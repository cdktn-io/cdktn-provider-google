...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/parametermanagerregionalparameter"
...
&parametermanagerregionalparameter.ParameterManagerRegionalParameterConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.parameterManagerRegionalParameter.ParameterManagerRegionalParameterTimeouts,
}
```
