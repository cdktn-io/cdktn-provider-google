...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/iamoauthclient"
...
&iamoauthclient.IamOauthClientConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.iamOauthClient.IamOauthClientTimeouts,
}
```
