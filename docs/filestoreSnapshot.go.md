...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/filestoresnapshot"
...
&filestoresnapshot.FilestoreSnapshotConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.filestoreSnapshot.FilestoreSnapshotTimeouts,
}
```
