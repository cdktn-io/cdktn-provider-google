...
| <code><a href="#@cdktn/provider-google.dataGoogleSqlDatabaseInstance.DataGoogleSqlDatabaseInstance.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/data-sources/sql_database_instance#id DataGoogleSqlDatabaseInstance#id}. |
...
| <code><a href="#@cdktn/provider-google.dataGoogleSqlDatabaseInstance.DataGoogleSqlDatabaseInstanceSettingsOutputReference.property.replicationLagMaxSeconds">replication_lag_max_seconds</a></code> | <code>typing.Union[int, float]</code> | *No description.* |
...
##### `replication_lag_max_seconds`<sup>Required</sup> <a name="replication_lag_max_seconds" id="@cdktn/provider-google.dataGoogleSqlDatabaseInstance.DataGoogleSqlDatabaseInstanceSettingsOutputReference.property.replicationLagMaxSeconds"></a>

```python
replication_lag_max_seconds: typing.Union[int, float]
```
