...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google.projectIamMember.ProjectIamMemberCondition.property.expression">Expression</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/project_iam_member#expression ProjectIamMember#expression}. |
| <code><a href="#@cdktn/provider-google.projectIamMember.ProjectIamMemberCondition.property.title">Title</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/project_iam_member#title ProjectIamMember#title}. |
| <code><a href="#@cdktn/provider-google.projectIamMember.ProjectIamMemberCondition.property.description">Description</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/project_iam_member#description ProjectIamMember#description}. |
...
| <code><a href="#@cdktn/provider-google.projectIamMember.ProjectIamMemberConfig.property.member">Member</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/project_iam_member#member ProjectIamMember#member}. |
| <code><a href="#@cdktn/provider-google.projectIamMember.ProjectIamMemberConfig.property.project">Project</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/project_iam_member#project ProjectIamMember#project}. |
| <code><a href="#@cdktn/provider-google.projectIamMember.ProjectIamMemberConfig.property.role">Role</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/project_iam_member#role ProjectIamMember#role}. |
...
| <code><a href="#@cdktn/provider-google.projectIamMember.ProjectIamMemberConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/project_iam_member#id ProjectIamMember#id}. |
