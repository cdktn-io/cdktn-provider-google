...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/geminicodetoolssetting"
...
&geminicodetoolssetting.GeminiCodeToolsSettingConfig {
	...
	Location: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.geminiCodeToolsSetting.GeminiCodeToolsSettingTimeouts,
}
```
