...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/apigeednszone"
...
&apigeednszone.ApigeeDnsZoneConfig {
	...
	Domain: *string,
	OrgId: *string,
	PeeringConfig: github.com/cdktf/cdktf-provider-google-go/google.apigeeDnsZone.ApigeeDnsZonePeeringConfig,
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.apigeeDnsZone.ApigeeDnsZoneTimeouts,
}
```
