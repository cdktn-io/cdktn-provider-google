...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/discoveryenginecmekconfig"
...
&discoveryenginecmekconfig.DiscoveryEngineCmekConfigConfig {
	...
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.discoveryEngineCmekConfig.DiscoveryEngineCmekConfigTimeouts,
}
```
