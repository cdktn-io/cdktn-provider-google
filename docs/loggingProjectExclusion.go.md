...
| <code><a href="#@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.toHclTerraform">ToHclTerraform</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.addMoveTarget">AddMoveTarget</a></code> | Adds a user defined moveTarget string to this resource to be later used in .moveTo(moveTarget) to resolve the location of the move. |
...
| <code><a href="#@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.hasResourceMove">HasResourceMove</a></code> | *No description.* |
| <code><a href="#@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.importFrom">ImportFrom</a></code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.moveFromId">MoveFromId</a></code> | Move the resource corresponding to "id" to this resource. |
| <code><a href="#@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.moveTo">MoveTo</a></code> | Moves this resource to the target resource given by moveTarget. |
| <code><a href="#@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.moveToId">MoveToId</a></code> | Moves this resource to the resource corresponding to "id". |
...
##### `ToHclTerraform` <a name="ToHclTerraform" id="@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.toHclTerraform"></a>
...
##### `AddMoveTarget` <a name="AddMoveTarget" id="@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.addMoveTarget"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.addMoveTarget.parameter.moveTarget"></a>
...
##### `HasResourceMove` <a name="HasResourceMove" id="@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.hasResourceMove"></a>

```go
func HasResourceMove() interface{}
```

##### `ImportFrom` <a name="ImportFrom" id="@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.importFrom"></a>
...
##### `MoveFromId` <a name="MoveFromId" id="@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.moveFromId"></a>
...
##### `MoveTo` <a name="MoveTo" id="@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.moveTo"></a>
...
###### `moveTarget`<sup>Required</sup> <a name="moveTarget" id="@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.moveTo.parameter.moveTarget"></a>
...
##### `MoveToId` <a name="MoveToId" id="@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.moveToId"></a>
...
| <code><a href="#@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.generateConfigForImport">GenerateConfigForImport</a></code> | Generates CDKTF code for importing a LoggingProjectExclusion resource upon running "cdktf plan <stack-name>". |
...
##### `GenerateConfigForImport` <a name="GenerateConfigForImport" id="@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.generateConfigForImport"></a>
...
###### `importToId`<sup>Required</sup> <a name="importToId" id="@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.generateConfigForImport.parameter.importToId"></a>
...
###### `importFromId`<sup>Required</sup> <a name="importFromId" id="@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.generateConfigForImport.parameter.importFromId"></a>
...
| <code><a href="#@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusion.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusionConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktf/provider-google.loggingProjectExclusion.LoggingProjectExclusionConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/logging_project_exclusion#id LoggingProjectExclusion#id}. |
