...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/v19/computeregioninstantsnapshotiampolicy"

computeregioninstantsnapshotiampolicy.NewComputeRegionInstantSnapshotIamPolicy(scope Construct, id *string, config ComputeRegionInstantSnapshotIamPolicyConfig) ComputeRegionInstantSnapshotIamPolicy
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google.computeRegionInstantSnapshotIamPolicy.ComputeRegionInstantSnapshotIamPolicy.Initializer.parameter.scope">scope</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Construct</code> | The scope in which to define this construct. |
...
computeregioninstantsnapshotiampolicy.ComputeRegionInstantSnapshotIamPolicy_IsConstruct(x interface{}) *bool
```
...
computeregioninstantsnapshotiampolicy.ComputeRegionInstantSnapshotIamPolicy_IsTerraformElement(x interface{}) *bool
```
...
computeregioninstantsnapshotiampolicy.ComputeRegionInstantSnapshotIamPolicy_IsTerraformResource(x interface{}) *bool
```
...
computeregioninstantsnapshotiampolicy.ComputeRegionInstantSnapshotIamPolicy_GenerateConfigForImport(scope Construct, importToId *string, importFromId *string, provider TerraformProvider) ImportableResource
```
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google.computeRegionInstantSnapshotIamPolicy.ComputeRegionInstantSnapshotIamPolicy.property.node">Node</a></code> | <code>github.com/aws/constructs-go/constructs/v10.Node</code> | The tree node. |
| <code><a href="#@cdktn/provider-google.computeRegionInstantSnapshotIamPolicy.ComputeRegionInstantSnapshotIamPolicy.property.cdktfStack">CdktfStack</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.computeRegionInstantSnapshotIamPolicy.ComputeRegionInstantSnapshotIamPolicy.property.terraformMetaArguments">TerraformMetaArguments</a></code> | <code>*map[string]interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.computeRegionInstantSnapshotIamPolicy.ComputeRegionInstantSnapshotIamPolicy.property.terraformGeneratorMetadata">TerraformGeneratorMetadata</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.computeRegionInstantSnapshotIamPolicy.ComputeRegionInstantSnapshotIamPolicy.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.computeRegionInstantSnapshotIamPolicy.ComputeRegionInstantSnapshotIamPolicy.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.computeRegionInstantSnapshotIamPolicy.ComputeRegionInstantSnapshotIamPolicy.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.computeRegionInstantSnapshotIamPolicy.ComputeRegionInstantSnapshotIamPolicy.property.lifecycle">Lifecycle</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformResourceLifecycle</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.computeRegionInstantSnapshotIamPolicy.ComputeRegionInstantSnapshotIamPolicy.property.provider">Provider</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.TerraformProvider</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.computeRegionInstantSnapshotIamPolicy.ComputeRegionInstantSnapshotIamPolicy.property.provisioners">Provisioners</a></code> | <code>*[]interface{}</code> | *No description.* |
...
&computeregioninstantsnapshotiampolicy.ComputeRegionInstantSnapshotIamPolicyConfig {
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google.computeRegionInstantSnapshotIamPolicy.ComputeRegionInstantSnapshotIamPolicyConfig.property.connection">Connection</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.computeRegionInstantSnapshotIamPolicy.ComputeRegionInstantSnapshotIamPolicyConfig.property.count">Count</a></code> | <code>interface{}</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.computeRegionInstantSnapshotIamPolicy.ComputeRegionInstantSnapshotIamPolicyConfig.property.dependsOn">DependsOn</a></code> | <code>*[]github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformDependable</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.computeRegionInstantSnapshotIamPolicy.ComputeRegionInstantSnapshotIamPolicyConfig.property.forEach">ForEach</a></code> | <code>github.com/open-constructs/cdk-terrain-go/cdktn.ITerraformIterator</code> | *No description.* |
