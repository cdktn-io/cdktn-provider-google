...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/healthcaredatasetiammember"
...
&healthcaredatasetiammember.HealthcareDatasetIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktn-io/cdktn-provider-google-go/google.healthcareDatasetIamMember.HealthcareDatasetIamMemberCondition,
	Id: *string,
}
```
