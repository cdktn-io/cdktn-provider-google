...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/networksecurityinterceptdeploymentgroup"
...
&networksecurityinterceptdeploymentgroup.NetworkSecurityInterceptDeploymentGroupConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.networkSecurityInterceptDeploymentGroup.NetworkSecurityInterceptDeploymentGroupTimeouts,
}
```
