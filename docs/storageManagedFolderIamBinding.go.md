...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/storagemanagedfolderiambinding"
...
&storagemanagedfolderiambinding.StorageManagedFolderIamBindingConfig {
	...
	Members: *[]*string,
	Role: *string,
	Condition: github.com/cdktn-io/cdktn-provider-google-go/google.storageManagedFolderIamBinding.StorageManagedFolderIamBindingCondition,
	Id: *string,
}
```
