...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/dialogflowintent"
...
&dialogflowintent.DialogflowIntentConfig {
	...
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.dialogflowIntent.DialogflowIntentTimeouts,
	WebhookState: *string,
}
```
