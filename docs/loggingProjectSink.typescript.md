...
| <code><a href="#@cdktn/provider-google.loggingProjectSink.LoggingProjectSinkConfig.property.uniqueWriterIdentity">uniqueWriterIdentity</a></code> | <code>boolean \| cdktn.IResolvable</code> | Whether to use a service agent as the writer_identity for this sink. |
