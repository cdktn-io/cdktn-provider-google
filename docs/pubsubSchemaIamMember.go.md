...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/pubsubschemaiammember"
...
&pubsubschemaiammember.PubsubSchemaIamMemberConfig {
	...
	Role: *string,
	Schema: *string,
	Condition: github.com/cdktn-io/cdktn-provider-google-go/google.pubsubSchemaIamMember.PubsubSchemaIamMemberCondition,
	Id: *string,
	Project: *string,
}
```
