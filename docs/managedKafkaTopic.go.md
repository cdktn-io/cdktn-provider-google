...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/managedkafkatopic"
...
&managedkafkatopic.ManagedKafkaTopicConfig {
	...
	PartitionCount: *f64,
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.managedKafkaTopic.ManagedKafkaTopicTimeouts,
}
```
