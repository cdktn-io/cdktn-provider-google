...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/kmskeyhandle"
...
&kmskeyhandle.KmsKeyHandleConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.kmsKeyHandle.KmsKeyHandleTimeouts,
}
```
