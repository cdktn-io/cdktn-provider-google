...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/dataplexaspecttype"
...
&dataplexaspecttype.DataplexAspectTypeConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.dataplexAspectType.DataplexAspectTypeTimeouts,
}
```
