...
```typescript
import { iapAgentRegistryIamMember } from '@cdktn/provider-google'

new iapAgentRegistryIamMember.IapAgentRegistryIamMember(scope: Construct, id: string, config: IapAgentRegistryIamMemberConfig)
```
...
```typescript
public putCondition(value: IapAgentRegistryIamMemberCondition): void
```
...
iapAgentRegistryIamMember.IapAgentRegistryIamMember.isConstruct(x: any)
```
...
iapAgentRegistryIamMember.IapAgentRegistryIamMember.isTerraformElement(x: any)
```
...
iapAgentRegistryIamMember.IapAgentRegistryIamMember.isTerraformResource(x: any)
```
...
iapAgentRegistryIamMember.IapAgentRegistryIamMember.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-google.iapAgentRegistryIamMember.IapAgentRegistryIamMember.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.iapAgentRegistryIamMember.IapAgentRegistryIamMember.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.iapAgentRegistryIamMember.IapAgentRegistryIamMember.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.iapAgentRegistryIamMember.IapAgentRegistryIamMember.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.iapAgentRegistryIamMember.IapAgentRegistryIamMember.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.iapAgentRegistryIamMember.IapAgentRegistryIamMember.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly condition: IapAgentRegistryIamMemberConditionOutputReference;
```
...
```typescript
public readonly conditionInput: IapAgentRegistryIamMemberCondition;
```
...
const iapAgentRegistryIamMemberCondition: iapAgentRegistryIamMember.IapAgentRegistryIamMemberCondition = { ... }
```
...
const iapAgentRegistryIamMemberConfig: iapAgentRegistryIamMember.IapAgentRegistryIamMemberConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-google.iapAgentRegistryIamMember.IapAgentRegistryIamMemberConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.iapAgentRegistryIamMember.IapAgentRegistryIamMemberConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.iapAgentRegistryIamMember.IapAgentRegistryIamMemberConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.iapAgentRegistryIamMember.IapAgentRegistryIamMemberConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly condition: IapAgentRegistryIamMemberCondition;
```
...
new iapAgentRegistryIamMember.IapAgentRegistryIamMemberConditionOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google.iapAgentRegistryIamMember.IapAgentRegistryIamMemberConditionOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
```typescript
public readonly internalValue: IapAgentRegistryIamMemberCondition;
```
