...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/storagebucketiammember"
...
&storagebucketiammember.StorageBucketIamMemberConfig {
	...
	Member: *string,
	Role: *string,
	Condition: github.com/cdktn-io/cdktn-provider-google-go/google.storageBucketIamMember.StorageBucketIamMemberCondition,
	Id: *string,
}
```
