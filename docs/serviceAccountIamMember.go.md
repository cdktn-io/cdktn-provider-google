...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/serviceaccountiammember"
...
&serviceaccountiammember.ServiceAccountIamMemberConfig {
	...
	Condition: github.com/cdktn-io/cdktn-provider-google-go/google.serviceAccountIamMember.ServiceAccountIamMemberCondition,
	Id: *string,
}
```
