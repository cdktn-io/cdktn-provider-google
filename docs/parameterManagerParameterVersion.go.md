...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/parametermanagerparameterversion"
...
&parametermanagerparameterversion.ParameterManagerParameterVersionConfig {
	...
	Disabled: interface{},
	Id: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.parameterManagerParameterVersion.ParameterManagerParameterVersionTimeouts,
}
```
