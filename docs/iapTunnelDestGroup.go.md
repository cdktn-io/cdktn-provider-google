...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/iaptunneldestgroup"
...
&iaptunneldestgroup.IapTunnelDestGroupConfig {
	...
	Project: *string,
	Region: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.iapTunnelDestGroup.IapTunnelDestGroupTimeouts,
}
```
