...
```typescript
import { dataformFolder } from '@cdktn/provider-google'

new dataformFolder.DataformFolder(scope: Construct, id: string, config: DataformFolderConfig)
```
...
```typescript
public putTimeouts(value: DataformFolderTimeouts): void
```
...
dataformFolder.DataformFolder.isConstruct(x: any)
```
...
dataformFolder.DataformFolder.isTerraformElement(x: any)
```
...
dataformFolder.DataformFolder.isTerraformResource(x: any)
```
...
dataformFolder.DataformFolder.generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: TerraformProvider)
```
...
| <code><a href="#@cdktn/provider-google.dataformFolder.DataformFolder.property.cdktfStack">cdktfStack</a></code> | <code>cdktn.TerraformStack</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.dataformFolder.DataformFolder.property.terraformMetaArguments">terraformMetaArguments</a></code> | <code>{[ key: string ]: any}</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.dataformFolder.DataformFolder.property.terraformGeneratorMetadata">terraformGeneratorMetadata</a></code> | <code>cdktn.TerraformProviderGeneratorMetadata</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.dataformFolder.DataformFolder.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.dataformFolder.DataformFolder.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.dataformFolder.DataformFolder.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.dataformFolder.DataformFolder.property.timeoutsInput">timeoutsInput</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-google.dataformFolder.DataformFolderTimeouts">DataformFolderTimeouts</a></code> | *No description.* |
...
```typescript
public readonly timeouts: DataformFolderTimeoutsOutputReference;
```
...
```typescript
public readonly timeoutsInput: IResolvable | DataformFolderTimeouts;
```
...
const dataformFolderConfig: dataformFolder.DataformFolderConfig = { ... }
```
...
| <code><a href="#@cdktn/provider-google.dataformFolder.DataformFolderConfig.property.count">count</a></code> | <code>number \| cdktn.TerraformCount</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.dataformFolder.DataformFolderConfig.property.dependsOn">dependsOn</a></code> | <code>cdktn.ITerraformDependable[]</code> | *No description.* |
| <code><a href="#@cdktn/provider-google.dataformFolder.DataformFolderConfig.property.forEach">forEach</a></code> | <code>cdktn.ITerraformIterator</code> | *No description.* |
...
| <code><a href="#@cdktn/provider-google.dataformFolder.DataformFolderConfig.property.provisioners">provisioners</a></code> | <code>cdktn.FileProvisioner \| cdktn.LocalExecProvisioner \| cdktn.RemoteExecProvisioner[]</code> | *No description.* |
...
```typescript
public readonly timeouts: DataformFolderTimeouts;
```
...
const dataformFolderTimeouts: dataformFolder.DataformFolderTimeouts = { ... }
```
...
new dataformFolder.DataformFolderTimeoutsOutputReference(terraformResource: IInterpolatingParent, terraformAttribute: string)
```

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#@cdktn/provider-google.dataformFolder.DataformFolderTimeoutsOutputReference.Initializer.parameter.terraformResource">terraformResource</a></code> | <code>cdktn.IInterpolatingParent</code> | The parent resource. |
...
| <code><a href="#@cdktn/provider-google.dataformFolder.DataformFolderTimeoutsOutputReference.property.internalValue">internalValue</a></code> | <code>cdktn.IResolvable \| <a href="#@cdktn/provider-google.dataformFolder.DataformFolderTimeouts">DataformFolderTimeouts</a></code> | *No description.* |
...
```typescript
public readonly internalValue: IResolvable | DataformFolderTimeouts;
```
