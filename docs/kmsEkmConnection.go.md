...
```go
import "github.com/cdktn-io/cdktn-provider-google-go/google/kmsekmconnection"
...
&kmsekmconnection.KmsEkmConnectionConfig {
	...
	Project: *string,
	Timeouts: github.com/cdktn-io/cdktn-provider-google-go/google.kmsEkmConnection.KmsEkmConnectionTimeouts,
}
```
