...
```go
import "github.com/cdktf/cdktf-provider-google-go/google/discoveryenginesitemap"
...
&discoveryenginesitemap.DiscoveryEngineSitemapConfig {
	...
	Id: *string,
	Project: *string,
	Timeouts: github.com/cdktf/cdktf-provider-google-go/google.discoveryEngineSitemap.DiscoveryEngineSitemapTimeouts,
	Uri: *string,
}
```
