...
# CDKTN prebuilt bindings for hashicorp/google provider version 7.46.0

This repo builds and publishes the [Terraform google provider](https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs) bindings for [CDK Terrain](https://cdktn.io).
...
- [Terraform google provider](https://registry.terraform.io/providers/hashicorp/google/7.46.0)
