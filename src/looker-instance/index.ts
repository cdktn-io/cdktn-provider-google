...
// https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/looker_instance
...
export class LookerInstance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LookerInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/looker_instance#import import section} in the documentation of this resource for the id to use
