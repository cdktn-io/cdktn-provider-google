...
// https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/kms_autokey_config
...
export class KmsAutokeyConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsAutokeyConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/kms_autokey_config#import import section} in the documentation of this resource for the id to use
