...
// https://registry.terraform.io/providers/hashicorp/google/7.33.0/docs/resources/eventarc_google_api_source
...
export interface EventarcGoogleApiSourceConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function eventarcGoogleApiSourceLoggingConfigToTerraform(struct?: EventarcGoogleApiSourceLoggingConfigOutputReference | EventarcGoogleApiSourceLoggingConfig): any {
...
export function eventarcGoogleApiSourceLoggingConfigToHclTerraform(struct?: EventarcGoogleApiSourceLoggingConfigOutputReference | EventarcGoogleApiSourceLoggingConfig): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class EventarcGoogleApiSourceLoggingConfigOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): EventarcGoogleApiSourceLoggingConfig | undefined {
  ...
  public set internalValue(value: EventarcGoogleApiSourceLoggingConfig | undefined) {
    if (value === undefined) {
...
export function eventarcGoogleApiSourceTimeoutsToTerraform(struct?: EventarcGoogleApiSourceTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function eventarcGoogleApiSourceTimeoutsToHclTerraform(struct?: EventarcGoogleApiSourceTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class EventarcGoogleApiSourceTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): EventarcGoogleApiSourceTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: EventarcGoogleApiSourceTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class EventarcGoogleApiSource extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EventarcGoogleApiSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.33.0/docs/resources/eventarc_google_api_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_eventarc_google_api_source", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.33.0/docs/resources/eventarc_google_api_source google_eventarc_google_api_source} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options EventarcGoogleApiSourceConfig
  */
  public constructor(scope: Construct, id: string, config: EventarcGoogleApiSourceConfig) {
    super(scope, id, {
  ...
  private _loggingConfig = new EventarcGoogleApiSourceLoggingConfigOutputReference(this, "logging_config");
  public get loggingConfig() {
    return this._loggingConfig;
  }
  public putLoggingConfig(value: EventarcGoogleApiSourceLoggingConfig) {
  ...
  private _timeouts = new EventarcGoogleApiSourceTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: EventarcGoogleApiSourceTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      google_api_source_id: cdktn.stringToTerraform(this._googleApiSourceId),
      id: cdktn.stringToTerraform(this._id),
      labels: cdktn.hashMapper(cdktn.stringToTerraform)(this._labels),
      location: cdktn.stringToTerraform(this._location),
      project: cdktn.stringToTerraform(this._project),
      logging_config: eventarcGoogleApiSourceLoggingConfigToTerraform(this._loggingConfig.internalValue),
      timeouts: eventarcGoogleApiSourceTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      google_api_source_id: {
        value: cdktn.stringToHclTerraform(this._googleApiSourceId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      logging_config: {
        value: eventarcGoogleApiSourceLoggingConfigToHclTerraform(this._loggingConfig.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "EventarcGoogleApiSourceLoggingConfigList",
      },
      timeouts: {
        value: eventarcGoogleApiSourceTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "EventarcGoogleApiSourceTimeouts",
      },
    };
