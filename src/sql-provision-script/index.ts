...
// https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/resources/sql_provision_script
...
export class SqlProvisionScript extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SqlProvisionScript that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/resources/sql_provision_script#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/resources/sql_provision_script google_sql_provision_script} Resource
  *
  * @param scope The scope in which to define this construct
