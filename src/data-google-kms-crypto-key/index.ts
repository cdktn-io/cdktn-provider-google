...
// https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/kms_crypto_key
...
export interface DataGoogleKmsCryptoKeyConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/kms_crypto_key#id DataGoogleKmsCryptoKey#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/kms_crypto_key#key_ring DataGoogleKmsCryptoKey#key_ring}
  */
  readonly keyRing: string;
  /**
  * The resource name for the CryptoKey.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/kms_crypto_key#name DataGoogleKmsCryptoKey#name}
  */
...
export class DataGoogleKmsCryptoKeyPrimaryOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleKmsCryptoKeyPrimaryList extends cdktn.ComplexList {
...
export class DataGoogleKmsCryptoKeyVersionTemplateOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleKmsCryptoKeyVersionTemplateList extends cdktn.ComplexList {
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/kms_crypto_key google_kms_crypto_key}
*/
export class DataGoogleKmsCryptoKey extends cdktn.TerraformDataSource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DataGoogleKmsCryptoKey resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DataGoogleKmsCryptoKey to import
  * @param importFromId The id of the existing DataGoogleKmsCryptoKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/kms_crypto_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/kms_crypto_key google_kms_crypto_key} Data Source
  *
  * @param scope The scope in which to define this construct
