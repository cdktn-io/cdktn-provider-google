...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dns_managed_zone_iam_policy
...
export class DnsManagedZoneIamPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsManagedZoneIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dns_managed_zone_iam_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dns_managed_zone_iam_policy google_dns_managed_zone_iam_policy} Resource
  *
  * @param scope The scope in which to define this construct
