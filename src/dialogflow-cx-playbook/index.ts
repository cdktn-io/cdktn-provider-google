...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook
...
export interface DialogflowCxPlaybookConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#deletion_policy DialogflowCxPlaybook#deletion_policy}
  */
  readonly deletionPolicy?: string;
  /**
  * The human-readable name of the playbook, unique within an agent.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#display_name DialogflowCxPlaybook#display_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#goal DialogflowCxPlaybook#goal}
  */
  readonly goal: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#id DialogflowCxPlaybook#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#parent DialogflowCxPlaybook#parent}
  */
  readonly parent?: string;
  /**
  * Type of the playbook. Possible values: ["PLAYBOOK_TYPE_UNSPECIFIED", "TASK", "ROUTINE"]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#playbook_type DialogflowCxPlaybook#playbook_type}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#referenced_tools DialogflowCxPlaybook#referenced_tools}
  */
  readonly referencedTools?: string[];
  /**
  * instruction block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#instruction DialogflowCxPlaybook#instruction}
  */
  readonly instruction?: DialogflowCxPlaybookInstruction;
  /**
  * llm_model_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#llm_model_settings DialogflowCxPlaybook#llm_model_settings}
  */
  readonly llmModelSettings?: DialogflowCxPlaybookLlmModelSettings;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#timeouts DialogflowCxPlaybook#timeouts}
  */
...
export interface DialogflowCxPlaybookInstructionSteps {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#steps DialogflowCxPlaybook#steps}
  */
  readonly steps?: string;
  /**
  * Step instruction in text format.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#text DialogflowCxPlaybook#text}
  */
  readonly text?: string;
}

export function dialogflowCxPlaybookInstructionStepsToTerraform(struct?: DialogflowCxPlaybookInstructionSteps | cdktn.IResolvable): any {
...
export function dialogflowCxPlaybookInstructionStepsToHclTerraform(struct?: DialogflowCxPlaybookInstructionSteps | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DialogflowCxPlaybookInstructionStepsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DialogflowCxPlaybookInstructionSteps | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DialogflowCxPlaybookInstructionSteps | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class DialogflowCxPlaybookInstructionStepsList extends cdktn.ComplexList {
  public internalValue? : DialogflowCxPlaybookInstructionSteps[] | cdktn.IResolvable
...
export interface DialogflowCxPlaybookInstruction {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#guidelines DialogflowCxPlaybook#guidelines}
  */
  ...
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#steps DialogflowCxPlaybook#steps}
  */
  readonly steps?: DialogflowCxPlaybookInstructionSteps[] | cdktn.IResolvable;
}
...
export function dialogflowCxPlaybookInstructionToTerraform(struct?: DialogflowCxPlaybookInstructionOutputReference | DialogflowCxPlaybookInstruction): any {
  ...
  return {
    ...
    steps: cdktn.listMapper(dialogflowCxPlaybookInstructionStepsToTerraform, true)(struct!.steps),
  }
}
...
export function dialogflowCxPlaybookInstructionToHclTerraform(struct?: DialogflowCxPlaybookInstructionOutputReference | DialogflowCxPlaybookInstruction): any {
  ...
  const attrs = {
    ...
    steps: {
      value: cdktn.listMapperHcl(dialogflowCxPlaybookInstructionStepsToHclTerraform, true)(struct!.steps),
      isBlock: true,
      type: "list",
...
export class DialogflowCxPlaybookInstructionOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public putSteps(value: DialogflowCxPlaybookInstructionSteps[] | cdktn.IResolvable) {
...
export interface DialogflowCxPlaybookLlmModelSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#model DialogflowCxPlaybook#model}
  */
  readonly model?: string;
  /**
  * The custom prompt to use.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#prompt_text DialogflowCxPlaybook#prompt_text}
  */
...
export class DialogflowCxPlaybookLlmModelSettingsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface DialogflowCxPlaybookTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#create DialogflowCxPlaybook#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#delete DialogflowCxPlaybook#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#update DialogflowCxPlaybook#update}
  */
  readonly update?: string;
}

export function dialogflowCxPlaybookTimeoutsToTerraform(struct?: DialogflowCxPlaybookTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dialogflowCxPlaybookTimeoutsToHclTerraform(struct?: DialogflowCxPlaybookTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DialogflowCxPlaybookTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): DialogflowCxPlaybookTimeouts | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DialogflowCxPlaybookTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook google_dialogflow_cx_playbook}
*/
export class DialogflowCxPlaybook extends cdktn.TerraformResource {
  ...
  // ==============
  /**
  * Generates CDKTN code for importing a DialogflowCxPlaybook resource upon running "cdktn plan <stack-name>"
  * @param scope The scope in which to define this construct
  * @param importToId The construct id used in the generated config for the DialogflowCxPlaybook to import
  * @param importFromId The id of the existing DialogflowCxPlaybook that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_playbook google_dialogflow_cx_playbook} Resource
  *
  * @param scope The scope in which to define this construct
