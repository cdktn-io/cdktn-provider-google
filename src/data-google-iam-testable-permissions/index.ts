...
// https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/iam_testable_permissions
...
export class DataGoogleIamTestablePermissions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleIamTestablePermissions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/iam_testable_permissions#import import section} in the documentation of this resource for the id to use
