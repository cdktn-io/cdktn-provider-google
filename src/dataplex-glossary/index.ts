...
export interface DataplexGlossaryConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function dataplexGlossaryTimeoutsToTerraform(struct?: DataplexGlossaryTimeouts | cdktf.IResolvable): any {
...
export function dataplexGlossaryTimeoutsToHclTerraform(struct?: DataplexGlossaryTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataplexGlossaryTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataplexGlossaryTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataplexGlossaryTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class DataplexGlossary extends cdktf.TerraformResource {
