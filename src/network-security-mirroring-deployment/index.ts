...
export function networkSecurityMirroringDeploymentTimeoutsToTerraform(struct?: NetworkSecurityMirroringDeploymentTimeouts | cdktf.IResolvable): any {
...
export function networkSecurityMirroringDeploymentTimeoutsToHclTerraform(struct?: NetworkSecurityMirroringDeploymentTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class NetworkSecurityMirroringDeploymentTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): NetworkSecurityMirroringDeploymentTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: NetworkSecurityMirroringDeploymentTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class NetworkSecurityMirroringDeployment extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_network_security_mirroring_deployment", importId: importFromId, provider });
      }
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      mirroring_deployment_id: cdktf.stringToTerraform(this._mirroringDeploymentId),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      mirroring_deployment_id: {
        value: cdktf.stringToHclTerraform(this._mirroringDeploymentId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
