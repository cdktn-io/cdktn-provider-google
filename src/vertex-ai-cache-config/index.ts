...
// https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/resources/vertex_ai_cache_config
...
export class VertexAiCacheConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VertexAiCacheConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/resources/vertex_ai_cache_config#import import section} in the documentation of this resource for the id to use
