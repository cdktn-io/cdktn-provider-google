...
// https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/storage_batch_operations_job
...
export class StorageBatchOperationsJob extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageBatchOperationsJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/storage_batch_operations_job#import import section} in the documentation of this resource for the id to use
