...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/vertex_ai_index
...
export class DataGoogleVertexAiIndex extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleVertexAiIndex that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/vertex_ai_index#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/vertex_ai_index google_vertex_ai_index} Data Source
  *
  * @param scope The scope in which to define this construct
