...
// https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/data-sources/kms_crypto_key_versions
...
export class DataGoogleKmsCryptoKeyVersions extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleKmsCryptoKeyVersions that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/data-sources/kms_crypto_key_versions#import import section} in the documentation of this resource for the id to use
