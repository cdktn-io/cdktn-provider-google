...
// https://registry.terraform.io/providers/hashicorp/google/7.33.0/docs/resources/netapp_backup_vault
...
export class NetappBackupVault extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NetappBackupVault that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.33.0/docs/resources/netapp_backup_vault#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.33.0/docs/resources/netapp_backup_vault google_netapp_backup_vault} Resource
  *
  * @param scope The scope in which to define this construct
