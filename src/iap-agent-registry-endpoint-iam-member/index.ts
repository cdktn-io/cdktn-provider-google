...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/iap_agent_registry_endpoint_iam_member
...
export class IapAgentRegistryEndpointIamMember extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IapAgentRegistryEndpointIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/iap_agent_registry_endpoint_iam_member#import import section} in the documentation of this resource for the id to use
