...
// https://registry.terraform.io/providers/hashicorp/google/7.32.0/docs/data-sources/monitoring_uptime_check_ips
...
export class DataGoogleMonitoringUptimeCheckIps extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleMonitoringUptimeCheckIps that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.32.0/docs/data-sources/monitoring_uptime_check_ips#import import section} in the documentation of this resource for the id to use
