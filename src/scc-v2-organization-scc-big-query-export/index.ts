...
export interface SccV2OrganizationSccBigQueryExportConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function sccV2OrganizationSccBigQueryExportTimeoutsToTerraform(struct?: SccV2OrganizationSccBigQueryExportTimeouts | cdktf.IResolvable): any {
...
export function sccV2OrganizationSccBigQueryExportTimeoutsToHclTerraform(struct?: SccV2OrganizationSccBigQueryExportTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SccV2OrganizationSccBigQueryExportTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SccV2OrganizationSccBigQueryExportTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SccV2OrganizationSccBigQueryExportTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class SccV2OrganizationSccBigQueryExport extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_scc_v2_organization_scc_big_query_export", importId: importFromId, provider });
      }
