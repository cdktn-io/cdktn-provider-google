...
// https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/oracle_database_cloud_exadata_infrastructure_exascale_config
...
export class OracleDatabaseCloudExadataInfrastructureExascaleConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OracleDatabaseCloudExadataInfrastructureExascaleConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/oracle_database_cloud_exadata_infrastructure_exascale_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/oracle_database_cloud_exadata_infrastructure_exascale_config google_oracle_database_cloud_exadata_infrastructure_exascale_config} Resource
  *
  * @param scope The scope in which to define this construct
