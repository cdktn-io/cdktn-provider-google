...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/healthcare_dicom_store
...
export interface HealthcareDicomStoreConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class HealthcareDicomStoreNotificationConfigOutputReference extends cdktn.ComplexObject {
...
export function healthcareDicomStoreTimeoutsToTerraform(struct?: HealthcareDicomStoreTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function healthcareDicomStoreTimeoutsToHclTerraform(struct?: HealthcareDicomStoreTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class HealthcareDicomStoreTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): HealthcareDicomStoreTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: HealthcareDicomStoreTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class HealthcareDicomStore extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing HealthcareDicomStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/healthcare_dicom_store#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/healthcare_dicom_store google_healthcare_dicom_store} Resource
  *
  * @param scope The scope in which to define this construct
