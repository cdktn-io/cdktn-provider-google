...
// https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/iam_folders_policy_binding
...
export interface IamFoldersPolicyBindingConfig extends cdktf.TerraformMetaArguments {
  /**
...
export interface IamFoldersPolicyBindingCondition {
  /**
...
export class IamFoldersPolicyBindingConditionOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IamFoldersPolicyBindingCondition | undefined {
  ...
  public set internalValue(value: IamFoldersPolicyBindingCondition | undefined) {
    if (value === undefined) {
...
export interface IamFoldersPolicyBindingTarget {
  /**
...
export class IamFoldersPolicyBindingTargetOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): IamFoldersPolicyBindingTarget | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: IamFoldersPolicyBindingTarget | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export function iamFoldersPolicyBindingTimeoutsToTerraform(struct?: IamFoldersPolicyBindingTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function iamFoldersPolicyBindingTimeoutsToHclTerraform(struct?: IamFoldersPolicyBindingTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class IamFoldersPolicyBindingTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): IamFoldersPolicyBindingTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: IamFoldersPolicyBindingTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class IamFoldersPolicyBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing IamFoldersPolicyBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/iam_folders_policy_binding#import import section} in the documentation of this resource for the id to use
  ...
  * @param options IamFoldersPolicyBindingConfig
  */
  public constructor(scope: Construct, id: string, config: IamFoldersPolicyBindingConfig) {
    super(scope, id, {
  ...
  private _condition = new IamFoldersPolicyBindingConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: IamFoldersPolicyBindingCondition) {
  ...
  private _target = new IamFoldersPolicyBindingTargetOutputReference(this, "target");
  public get target() {
    return this._target;
  }
  public putTarget(value: IamFoldersPolicyBindingTarget) {
  ...
  private _timeouts = new IamFoldersPolicyBindingTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: IamFoldersPolicyBindingTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: iamFoldersPolicyBindingConditionToTerraform(this._condition.internalValue),
      target: iamFoldersPolicyBindingTargetToTerraform(this._target.internalValue),
      timeouts: iamFoldersPolicyBindingTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      condition: {
        value: iamFoldersPolicyBindingConditionToHclTerraform(this._condition.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "IamFoldersPolicyBindingConditionList",
      },
      target: {
        value: iamFoldersPolicyBindingTargetToHclTerraform(this._target.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "IamFoldersPolicyBindingTargetList",
      },
      timeouts: {
        value: iamFoldersPolicyBindingTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "IamFoldersPolicyBindingTimeouts",
      },
    };
