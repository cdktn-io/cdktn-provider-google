...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/iap_tunnel_dest_group
...
export class IapTunnelDestGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IapTunnelDestGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/iap_tunnel_dest_group#import import section} in the documentation of this resource for the id to use
