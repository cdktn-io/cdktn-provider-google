...
// https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/data-sources/cloud_asset_search_all_resources
...
export class DataGoogleCloudAssetSearchAllResources extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleCloudAssetSearchAllResources that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/data-sources/cloud_asset_search_all_resources#import import section} in the documentation of this resource for the id to use
