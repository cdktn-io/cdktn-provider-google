...
// https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/project_iam_member
...
export class ProjectIamMember extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/project_iam_member#import import section} in the documentation of this resource for the id to use
