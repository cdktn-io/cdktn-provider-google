...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/apigee_env_keystore
...
export interface ApigeeEnvKeystoreConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function apigeeEnvKeystoreTimeoutsToTerraform(struct?: ApigeeEnvKeystoreTimeouts | cdktn.IResolvable): any {
...
export function apigeeEnvKeystoreTimeoutsToHclTerraform(struct?: ApigeeEnvKeystoreTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ApigeeEnvKeystoreTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApigeeEnvKeystoreTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ApigeeEnvKeystoreTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class ApigeeEnvKeystore extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigeeEnvKeystore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/apigee_env_keystore#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ApigeeEnvKeystore to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_apigee_env_keystore", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/apigee_env_keystore google_apigee_env_keystore} Resource
  *
  * @param scope The scope in which to define this construct
