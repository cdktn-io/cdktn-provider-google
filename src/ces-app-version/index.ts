...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/ces_app_version google_ces_app_version}
*/
export class CesAppVersion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CesAppVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/ces_app_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/ces_app_version google_ces_app_version} Resource
  *
  * @param scope The scope in which to define this construct
