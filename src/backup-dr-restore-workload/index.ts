...
// https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/resources/backup_dr_restore_workload
...
export class BackupDrRestoreWorkload extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BackupDrRestoreWorkload that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/resources/backup_dr_restore_workload#import import section} in the documentation of this resource for the id to use
