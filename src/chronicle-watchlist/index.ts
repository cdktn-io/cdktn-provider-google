...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/chronicle_watchlist
...
export interface ChronicleWatchlistConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class ChronicleWatchlistEntityCountOutputReference extends cdktn.ComplexObject {
...
export class ChronicleWatchlistEntityCountList extends cdktn.ComplexList {
...
export class ChronicleWatchlistEntityPopulationMechanismManualOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class ChronicleWatchlistEntityPopulationMechanismOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function chronicleWatchlistTimeoutsToTerraform(struct?: ChronicleWatchlistTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function chronicleWatchlistTimeoutsToHclTerraform(struct?: ChronicleWatchlistTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ChronicleWatchlistTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ChronicleWatchlistTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ChronicleWatchlistTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class ChronicleWatchlistWatchlistUserPreferencesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
*/
export class ChronicleWatchlist extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ChronicleWatchlist that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/chronicle_watchlist#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/chronicle_watchlist google_chronicle_watchlist} Resource
  *
  * @param scope The scope in which to define this construct
