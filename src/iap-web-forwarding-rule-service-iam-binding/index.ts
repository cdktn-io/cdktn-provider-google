...
// https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/iap_web_forwarding_rule_service_iam_binding
...
export class IapWebForwardingRuleServiceIamBinding extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IapWebForwardingRuleServiceIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/iap_web_forwarding_rule_service_iam_binding#import import section} in the documentation of this resource for the id to use
