...
// https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/logging_saved_query
...
export class LoggingSavedQuery extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingSavedQuery that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/logging_saved_query#import import section} in the documentation of this resource for the id to use
