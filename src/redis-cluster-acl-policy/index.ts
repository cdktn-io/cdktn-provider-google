...
// https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/redis_cluster_acl_policy
...
export interface RedisClusterAclPolicyConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly rules: RedisClusterAclPolicyRules[] | cdktn.IResolvable;
  /**
  * timeouts block
  *
  ...
  */
  readonly timeouts?: RedisClusterAclPolicyTimeouts;
}
export interface RedisClusterAclPolicyRules {
  /**
...
export function redisClusterAclPolicyRulesToTerraform(struct?: RedisClusterAclPolicyRules | cdktn.IResolvable): any {
...
export function redisClusterAclPolicyRulesToHclTerraform(struct?: RedisClusterAclPolicyRules | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class RedisClusterAclPolicyRulesOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): RedisClusterAclPolicyRules | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: RedisClusterAclPolicyRules | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class RedisClusterAclPolicyRulesList extends cdktn.ComplexList {
  public internalValue? : RedisClusterAclPolicyRules[] | cdktn.IResolvable
  ...
  */
  public get(index: number): RedisClusterAclPolicyRulesOutputReference {
    return new RedisClusterAclPolicyRulesOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface RedisClusterAclPolicyTimeouts {
  /**
...
export function redisClusterAclPolicyTimeoutsToTerraform(struct?: RedisClusterAclPolicyTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function redisClusterAclPolicyTimeoutsToHclTerraform(struct?: RedisClusterAclPolicyTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class RedisClusterAclPolicyTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): RedisClusterAclPolicyTimeouts | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: RedisClusterAclPolicyTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
*/
export class RedisClusterAclPolicy extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the RedisClusterAclPolicy to import
  * @param importFromId The id of the existing RedisClusterAclPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/redis_cluster_acl_policy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the RedisClusterAclPolicy to import is found
  */
  ...
  * @param options RedisClusterAclPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: RedisClusterAclPolicyConfig) {
    super(scope, id, {
  ...
  private _rules = new RedisClusterAclPolicyRulesList(this, "rules", false);
  public get rules() {
    return this._rules;
  }
  public putRules(value: RedisClusterAclPolicyRules[] | cdktn.IResolvable) {
  ...
  private _timeouts = new RedisClusterAclPolicyTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: RedisClusterAclPolicyTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      rules: cdktn.listMapper(redisClusterAclPolicyRulesToTerraform, true)(this._rules.internalValue),
      timeouts: redisClusterAclPolicyTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      rules: {
        value: cdktn.listMapperHcl(redisClusterAclPolicyRulesToHclTerraform, true)(this._rules.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "RedisClusterAclPolicyRulesList",
      },
      timeouts: {
        value: redisClusterAclPolicyTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "RedisClusterAclPolicyTimeouts",
      },
    };
