...
// https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/data-sources/sql_database_instance_latest_recovery_time
...
export class DataGoogleSqlDatabaseInstanceLatestRecoveryTime extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleSqlDatabaseInstanceLatestRecoveryTime that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/data-sources/sql_database_instance_latest_recovery_time#import import section} in the documentation of this resource for the id to use
