...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/data-sources/folder
...
export class DataGoogleFolder extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleFolder that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/data-sources/folder#import import section} in the documentation of this resource for the id to use
