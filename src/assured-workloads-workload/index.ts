...
// https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/resources/assured_workloads_workload
...
export interface AssuredWorkloadsWorkloadConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly workloadOptions?: AssuredWorkloadsWorkloadWorkloadOptions;
}
...
export class AssuredWorkloadsWorkloadWorkloadOptionsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): AssuredWorkloadsWorkloadWorkloadOptions | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: AssuredWorkloadsWorkloadWorkloadOptions | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class AssuredWorkloadsWorkload extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AssuredWorkloadsWorkload that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/resources/assured_workloads_workload#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/resources/assured_workloads_workload google_assured_workloads_workload} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _workloadOptions = new AssuredWorkloadsWorkloadWorkloadOptionsOutputReference(this, "workload_options");
  public get workloadOptions() {
    return this._workloadOptions;
  }
  public putWorkloadOptions(value: AssuredWorkloadsWorkloadWorkloadOptions) {
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      workload_options: {
        value: assuredWorkloadsWorkloadWorkloadOptionsToHclTerraform(this._workloadOptions.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "AssuredWorkloadsWorkloadWorkloadOptionsList",
      },
    };
