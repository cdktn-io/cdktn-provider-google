...
// https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/gemini_code_tools_setting_binding
...
export interface GeminiCodeToolsSettingBindingConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function geminiCodeToolsSettingBindingTimeoutsToTerraform(struct?: GeminiCodeToolsSettingBindingTimeouts | cdktf.IResolvable): any {
...
export function geminiCodeToolsSettingBindingTimeoutsToHclTerraform(struct?: GeminiCodeToolsSettingBindingTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GeminiCodeToolsSettingBindingTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GeminiCodeToolsSettingBindingTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GeminiCodeToolsSettingBindingTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GeminiCodeToolsSettingBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GeminiCodeToolsSettingBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/gemini_code_tools_setting_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_gemini_code_tools_setting_binding", importId: importFromId, provider });
      }
