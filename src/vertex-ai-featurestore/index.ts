...
// https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/vertex_ai_featurestore
...
export interface VertexAiFeaturestoreConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class VertexAiFeaturestoreEncryptionSpecOutputReference extends cdktn.ComplexObject {
...
export class VertexAiFeaturestoreOnlineServingConfigScalingOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function vertexAiFeaturestoreOnlineServingConfigToHclTerraform(struct?: VertexAiFeaturestoreOnlineServingConfigOutputReference | VertexAiFeaturestoreOnlineServingConfig): any {
  ...
  const attrs = {
    fixed_node_count: {
      value: cdktn.numberToHclTerraform(struct!.fixedNodeCount),
      isBlock: false,
      type: "simple",
      storageClassType: "number",
    },
...
export class VertexAiFeaturestoreOnlineServingConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function vertexAiFeaturestoreTimeoutsToTerraform(struct?: VertexAiFeaturestoreTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function vertexAiFeaturestoreTimeoutsToHclTerraform(struct?: VertexAiFeaturestoreTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class VertexAiFeaturestoreTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): VertexAiFeaturestoreTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: VertexAiFeaturestoreTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class VertexAiFeaturestore extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VertexAiFeaturestore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/vertex_ai_featurestore#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_vertex_ai_featurestore", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/vertex_ai_featurestore google_vertex_ai_featurestore} Resource
  *
  * @param scope The scope in which to define this construct
