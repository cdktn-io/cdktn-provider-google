...
// https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/document_ai_warehouse_location
...
export class DocumentAiWarehouseLocation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DocumentAiWarehouseLocation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/document_ai_warehouse_location#import import section} in the documentation of this resource for the id to use
