...
// https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/vertex_ai_tensorboard_run
...
export interface VertexAiTensorboardRunConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function vertexAiTensorboardRunTimeoutsToTerraform(struct?: VertexAiTensorboardRunTimeouts | cdktn.IResolvable): any {
...
export function vertexAiTensorboardRunTimeoutsToHclTerraform(struct?: VertexAiTensorboardRunTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class VertexAiTensorboardRunTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): VertexAiTensorboardRunTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: VertexAiTensorboardRunTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class VertexAiTensorboardRun extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VertexAiTensorboardRun that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/vertex_ai_tensorboard_run#import import section} in the documentation of this resource for the id to use
  ...
  * @param options VertexAiTensorboardRunConfig
  */
  public constructor(scope: Construct, id: string, config: VertexAiTensorboardRunConfig) {
    super(scope, id, {
  ...
  private _timeouts = new VertexAiTensorboardRunTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: VertexAiTensorboardRunTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: vertexAiTensorboardRunTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: vertexAiTensorboardRunTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "VertexAiTensorboardRunTimeouts",
      },
    };
