...
// https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/dataform_repository_iam_binding
...
export interface DataformRepositoryIamBindingConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: DataformRepositoryIamBindingCondition;
}
export interface DataformRepositoryIamBindingCondition {
  /**
...
export function dataformRepositoryIamBindingConditionToTerraform(struct?: DataformRepositoryIamBindingConditionOutputReference | DataformRepositoryIamBindingCondition): any {
...
export function dataformRepositoryIamBindingConditionToHclTerraform(struct?: DataformRepositoryIamBindingConditionOutputReference | DataformRepositoryIamBindingCondition): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataformRepositoryIamBindingConditionOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataformRepositoryIamBindingCondition | undefined {
  ...
  public set internalValue(value: DataformRepositoryIamBindingCondition | undefined) {
    if (value === undefined) {
...
*/
export class DataformRepositoryIamBinding extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the DataformRepositoryIamBinding to import
  * @param importFromId The id of the existing DataformRepositoryIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/dataform_repository_iam_binding#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataformRepositoryIamBinding to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/dataform_repository_iam_binding google_dataform_repository_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataformRepositoryIamBindingConfig
  */
  public constructor(scope: Construct, id: string, config: DataformRepositoryIamBindingConfig) {
    super(scope, id, {
  ...
  private _condition = new DataformRepositoryIamBindingConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: DataformRepositoryIamBindingCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: dataformRepositoryIamBindingConditionToTerraform(this._condition.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      condition: {
        value: dataformRepositoryIamBindingConditionToHclTerraform(this._condition.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataformRepositoryIamBindingConditionList",
      },
    };
