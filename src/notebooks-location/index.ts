...
export function notebooksLocationTimeoutsToTerraform(struct?: NotebooksLocationTimeouts | cdktf.IResolvable): any {
...
export function notebooksLocationTimeoutsToHclTerraform(struct?: NotebooksLocationTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class NotebooksLocationTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): NotebooksLocationTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: NotebooksLocationTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
