...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apigee_dns_zone
...
export class ApigeeDnsZone extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigeeDnsZone that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apigee_dns_zone#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apigee_dns_zone google_apigee_dns_zone} Resource
  *
  * @param scope The scope in which to define this construct
