...
// https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/resources/compute_region_instant_snapshot
...
export interface ComputeRegionInstantSnapshotConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly params?: ComputeRegionInstantSnapshotParams;
  /**
  * timeouts block
  *
  ...
  */
  readonly timeouts?: ComputeRegionInstantSnapshotTimeouts;
}
export interface ComputeRegionInstantSnapshotResourceStatus {
}

export function computeRegionInstantSnapshotResourceStatusToTerraform(struct?: ComputeRegionInstantSnapshotResourceStatus): any {
...
export function computeRegionInstantSnapshotResourceStatusToHclTerraform(struct?: ComputeRegionInstantSnapshotResourceStatus): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ComputeRegionInstantSnapshotResourceStatusOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ComputeRegionInstantSnapshotResourceStatus | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: ComputeRegionInstantSnapshotResourceStatus | undefined) {
    if (value === undefined) {
...
export class ComputeRegionInstantSnapshotResourceStatusList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): ComputeRegionInstantSnapshotResourceStatusOutputReference {
    return new ComputeRegionInstantSnapshotResourceStatusOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
export interface ComputeRegionInstantSnapshotParams {
  /**
...
export function computeRegionInstantSnapshotParamsToTerraform(struct?: ComputeRegionInstantSnapshotParamsOutputReference | ComputeRegionInstantSnapshotParams): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function computeRegionInstantSnapshotParamsToHclTerraform(struct?: ComputeRegionInstantSnapshotParamsOutputReference | ComputeRegionInstantSnapshotParams): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ComputeRegionInstantSnapshotParamsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ComputeRegionInstantSnapshotParams | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: ComputeRegionInstantSnapshotParams | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface ComputeRegionInstantSnapshotTimeouts {
  /**
...
export function computeRegionInstantSnapshotTimeoutsToTerraform(struct?: ComputeRegionInstantSnapshotTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function computeRegionInstantSnapshotTimeoutsToHclTerraform(struct?: ComputeRegionInstantSnapshotTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ComputeRegionInstantSnapshotTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ComputeRegionInstantSnapshotTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ComputeRegionInstantSnapshotTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class ComputeRegionInstantSnapshot extends cdktn.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_compute_region_instant_snapshot";
  ...
  * @param importToId The construct id used in the generated config for the ComputeRegionInstantSnapshot to import
  * @param importFromId The id of the existing ComputeRegionInstantSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/resources/compute_region_instant_snapshot#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ComputeRegionInstantSnapshot to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_compute_region_instant_snapshot", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/resources/compute_region_instant_snapshot google_compute_region_instant_snapshot} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ComputeRegionInstantSnapshotConfig
  */
  public constructor(scope: Construct, id: string, config: ComputeRegionInstantSnapshotConfig) {
    super(scope, id, {
      terraformResourceType: 'google_compute_region_instant_snapshot',
  ...
  private _resourceStatus = new ComputeRegionInstantSnapshotResourceStatusList(this, "resource_status", false);
  ...
  // source_instant_snapshot_group - computed: true, optional: false, required: false
  public get sourceInstantSnapshotGroup() {
    return this.getStringAttribute('source_instant_snapshot_group');
  }

  // source_instant_snapshot_group_id - computed: true, optional: false, required: false
  public get sourceInstantSnapshotGroupId() {
    return this.getStringAttribute('source_instant_snapshot_group_id');
  }
  ...
  private _params = new ComputeRegionInstantSnapshotParamsOutputReference(this, "params");
  public get params() {
    return this._params;
  }
  public putParams(value: ComputeRegionInstantSnapshotParams) {
  ...
  private _timeouts = new ComputeRegionInstantSnapshotTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: ComputeRegionInstantSnapshotTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      params: computeRegionInstantSnapshotParamsToTerraform(this._params.internalValue),
      timeouts: computeRegionInstantSnapshotTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      params: {
        value: computeRegionInstantSnapshotParamsToHclTerraform(this._params.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ComputeRegionInstantSnapshotParamsList",
      },
      timeouts: {
        value: computeRegionInstantSnapshotTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ComputeRegionInstantSnapshotTimeouts",
      },
    };
