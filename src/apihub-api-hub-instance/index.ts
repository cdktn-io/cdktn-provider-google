...
// https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/apihub_api_hub_instance
...
export interface ApihubApiHubInstanceConfig extends cdktn.TerraformMetaArguments {
  ...
  * are '/a-z[0-9]-_/'.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/apihub_api_hub_instance#api_hub_instance_id ApihubApiHubInstance#api_hub_instance_id}
  */
  readonly apiHubInstanceId?: string;
  /**
  * Optional. Description of the ApiHub instance.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/apihub_api_hub_instance#description ApihubApiHubInstance#description}
  */
  readonly description?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/apihub_api_hub_instance#id ApihubApiHubInstance#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/apihub_api_hub_instance#labels ApihubApiHubInstance#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * Resource ID segment making up resource 'name'. It identifies the resource within its parent collection as described in https://google.aip.dev/122.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/apihub_api_hub_instance#location ApihubApiHubInstance#location}
  */
  readonly location: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/apihub_api_hub_instance#project ApihubApiHubInstance#project}
  */
  readonly project?: string;
  /**
  * config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/apihub_api_hub_instance#config ApihubApiHubInstance#config}
  */
  readonly config: ApihubApiHubInstanceConfigA;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/apihub_api_hub_instance#timeouts ApihubApiHubInstance#timeouts}
  */
...
export interface ApihubApiHubInstanceConfigA {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/apihub_api_hub_instance#cmek_key_name ApihubApiHubInstance#cmek_key_name}
  */
  ...
  * is false.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/apihub_api_hub_instance#disable_search ApihubApiHubInstance#disable_search}
  */
  ...
  * CMEK
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/apihub_api_hub_instance#encryption_type ApihubApiHubInstance#encryption_type}
  */
  readonly encryptionType?: string;
  /**
  * Optional. The name of the Vertex AI location where the data store is stored.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/apihub_api_hub_instance#vertex_location ApihubApiHubInstance#vertex_location}
  */
...
export interface ApihubApiHubInstanceTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/apihub_api_hub_instance#create ApihubApiHubInstance#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/apihub_api_hub_instance#delete ApihubApiHubInstance#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/apihub_api_hub_instance#update ApihubApiHubInstance#update}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/apihub_api_hub_instance google_apihub_api_hub_instance}
*/
export class ApihubApiHubInstance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApihubApiHubInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/apihub_api_hub_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/apihub_api_hub_instance google_apihub_api_hub_instance} Resource
  *
  * @param scope The scope in which to define this construct
