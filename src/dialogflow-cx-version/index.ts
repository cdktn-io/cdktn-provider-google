...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/dialogflow_cx_version
...
export class DialogflowCxVersion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DialogflowCxVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/dialogflow_cx_version#import import section} in the documentation of this resource for the id to use
