...
// https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/data-sources/backup_dr_management_server
...
export interface DataGoogleBackupDrManagementServerConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataGoogleBackupDrManagementServerManagementUriOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleBackupDrManagementServerManagementUriList extends cdktn.ComplexList {
...
export class DataGoogleBackupDrManagementServerNetworksOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleBackupDrManagementServerNetworksList extends cdktn.ComplexList {
...
*/
export class DataGoogleBackupDrManagementServer extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleBackupDrManagementServer that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/data-sources/backup_dr_management_server#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/data-sources/backup_dr_management_server google_backup_dr_management_server} Data Source
  *
  * @param scope The scope in which to define this construct
