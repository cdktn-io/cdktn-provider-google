...
// https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/workflows_workflow
...
export interface WorkflowsWorkflowConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function workflowsWorkflowTimeoutsToTerraform(struct?: WorkflowsWorkflowTimeouts | cdktn.IResolvable): any {
...
export function workflowsWorkflowTimeoutsToHclTerraform(struct?: WorkflowsWorkflowTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class WorkflowsWorkflowTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): WorkflowsWorkflowTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: WorkflowsWorkflowTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class WorkflowsWorkflow extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkflowsWorkflow that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/workflows_workflow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/workflows_workflow google_workflows_workflow} Resource
  *
  * @param scope The scope in which to define this construct
