...
// https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/access_context_manager_ingress_policy
...
export class AccessContextManagerIngressPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AccessContextManagerIngressPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/access_context_manager_ingress_policy#import import section} in the documentation of this resource for the id to use
