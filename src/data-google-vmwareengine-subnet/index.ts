...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/vmwareengine_subnet
...
export interface DataGoogleVmwareengineSubnetConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataGoogleVmwareengineSubnetDhcpAddressRangesOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleVmwareengineSubnetDhcpAddressRangesList extends cdktn.ComplexList {
...
*/
export class DataGoogleVmwareengineSubnet extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleVmwareengineSubnet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/vmwareengine_subnet#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/vmwareengine_subnet google_vmwareengine_subnet} Data Source
  *
  * @param scope The scope in which to define this construct
