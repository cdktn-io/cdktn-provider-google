...
// https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/data-sources/vmwareengine_subnet
...
export class DataGoogleVmwareengineSubnet extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleVmwareengineSubnet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/data-sources/vmwareengine_subnet#import import section} in the documentation of this resource for the id to use
