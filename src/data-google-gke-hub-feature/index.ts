...
// https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/data-sources/gke_hub_feature
...
export class DataGoogleGkeHubFeature extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleGkeHubFeature that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/data-sources/gke_hub_feature#import import section} in the documentation of this resource for the id to use
