...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/cloud_identity_group_membership
...
export class CloudIdentityGroupMembership extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudIdentityGroupMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/cloud_identity_group_membership#import import section} in the documentation of this resource for the id to use
