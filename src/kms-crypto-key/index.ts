...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/kms_crypto_key
...
export class KmsCryptoKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsCryptoKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/kms_crypto_key#import import section} in the documentation of this resource for the id to use
