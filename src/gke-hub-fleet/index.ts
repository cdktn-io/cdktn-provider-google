...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/gke_hub_fleet
...
export class GkeHubFleet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GkeHubFleet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/gke_hub_fleet#import import section} in the documentation of this resource for the id to use
