...
// https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/resources/database_migration_service_private_connection
...
export class DatabaseMigrationServicePrivateConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DatabaseMigrationServicePrivateConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/resources/database_migration_service_private_connection#import import section} in the documentation of this resource for the id to use
