...
// https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/data-sources/certificate_manager_dns_authorization
...
export class DataGoogleCertificateManagerDnsAuthorization extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleCertificateManagerDnsAuthorization that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/data-sources/certificate_manager_dns_authorization#import import section} in the documentation of this resource for the id to use
