...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/discovery_engine_search_engine_iam_binding
...
export interface DiscoveryEngineSearchEngineIamBindingConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: DiscoveryEngineSearchEngineIamBindingCondition;
}
export interface DiscoveryEngineSearchEngineIamBindingCondition {
  /**
...
export function discoveryEngineSearchEngineIamBindingConditionToTerraform(struct?: DiscoveryEngineSearchEngineIamBindingConditionOutputReference | DiscoveryEngineSearchEngineIamBindingCondition): any {
...
export function discoveryEngineSearchEngineIamBindingConditionToHclTerraform(struct?: DiscoveryEngineSearchEngineIamBindingConditionOutputReference | DiscoveryEngineSearchEngineIamBindingCondition): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DiscoveryEngineSearchEngineIamBindingConditionOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DiscoveryEngineSearchEngineIamBindingCondition | undefined {
  ...
  public set internalValue(value: DiscoveryEngineSearchEngineIamBindingCondition | undefined) {
    if (value === undefined) {
...
*/
export class DiscoveryEngineSearchEngineIamBinding extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the DiscoveryEngineSearchEngineIamBinding to import
  * @param importFromId The id of the existing DiscoveryEngineSearchEngineIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/discovery_engine_search_engine_iam_binding#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DiscoveryEngineSearchEngineIamBinding to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/discovery_engine_search_engine_iam_binding google_discovery_engine_search_engine_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DiscoveryEngineSearchEngineIamBindingConfig
  */
  public constructor(scope: Construct, id: string, config: DiscoveryEngineSearchEngineIamBindingConfig) {
    super(scope, id, {
  ...
  private _condition = new DiscoveryEngineSearchEngineIamBindingConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: DiscoveryEngineSearchEngineIamBindingCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: discoveryEngineSearchEngineIamBindingConditionToTerraform(this._condition.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      condition: {
        value: discoveryEngineSearchEngineIamBindingConditionToHclTerraform(this._condition.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DiscoveryEngineSearchEngineIamBindingConditionList",
      },
    };
