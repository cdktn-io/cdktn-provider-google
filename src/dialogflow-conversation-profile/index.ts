...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/dialogflow_conversation_profile
...
export class DialogflowConversationProfile extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DialogflowConversationProfile that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/dialogflow_conversation_profile#import import section} in the documentation of this resource for the id to use
