...
// https://registry.terraform.io/providers/hashicorp/google/7.32.0/docs/resources/apphub_service_project_attachment
...
export class ApphubServiceProjectAttachment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApphubServiceProjectAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.32.0/docs/resources/apphub_service_project_attachment#import import section} in the documentation of this resource for the id to use
