...
// https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/dataplex_metadata_feed
...
export class DataplexMetadataFeed extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DataplexMetadataFeed that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/dataplex_metadata_feed#import import section} in the documentation of this resource for the id to use
