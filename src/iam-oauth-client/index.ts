...
// https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/iam_oauth_client
...
export class IamOauthClient extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IamOauthClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/iam_oauth_client#import import section} in the documentation of this resource for the id to use
