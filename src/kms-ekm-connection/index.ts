...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/kms_ekm_connection
...
export class KmsEkmConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsEkmConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/kms_ekm_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/kms_ekm_connection google_kms_ekm_connection} Resource
  *
  * @param scope The scope in which to define this construct
