...
// https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/integrations_client
...
export class IntegrationsClient extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationsClient that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/integrations_client#import import section} in the documentation of this resource for the id to use
