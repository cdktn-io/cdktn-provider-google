...
// https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/compute_instant_snapshot_iam_member
...
export interface ComputeInstantSnapshotIamMemberConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class ComputeInstantSnapshotIamMemberConditionOutputReference extends cdktf.ComplexObject {
...
*/
export class ComputeInstantSnapshotIamMember extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ComputeInstantSnapshotIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/compute_instant_snapshot_iam_member#import import section} in the documentation of this resource for the id to use
