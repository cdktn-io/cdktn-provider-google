...
// https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/gkeonprem_vmware_admin_cluster
...
export interface GkeonpremVmwareAdminClusterConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly proxy?: GkeonpremVmwareAdminClusterProxy;
  /**
  * timeouts block
  *
...
export interface GkeonpremVmwareAdminClusterProxy {
  /**
...
export function gkeonpremVmwareAdminClusterProxyToTerraform(struct?: GkeonpremVmwareAdminClusterProxyOutputReference | GkeonpremVmwareAdminClusterProxy): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function gkeonpremVmwareAdminClusterProxyToHclTerraform(struct?: GkeonpremVmwareAdminClusterProxyOutputReference | GkeonpremVmwareAdminClusterProxy): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GkeonpremVmwareAdminClusterProxyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): GkeonpremVmwareAdminClusterProxy | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: GkeonpremVmwareAdminClusterProxy | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class GkeonpremVmwareAdminCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GkeonpremVmwareAdminCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/gkeonprem_vmware_admin_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/gkeonprem_vmware_admin_cluster google_gkeonprem_vmware_admin_cluster} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _proxy = new GkeonpremVmwareAdminClusterProxyOutputReference(this, "proxy");
  public get proxy() {
    return this._proxy;
  }
  public putProxy(value: GkeonpremVmwareAdminClusterProxy) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      proxy: gkeonpremVmwareAdminClusterProxyToTerraform(this._proxy.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      proxy: {
        value: gkeonpremVmwareAdminClusterProxyToHclTerraform(this._proxy.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "GkeonpremVmwareAdminClusterProxyList",
      },
      timeouts: {
