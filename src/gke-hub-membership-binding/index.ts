...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/gke_hub_membership_binding
...
export class GkeHubMembershipBinding extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GkeHubMembershipBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/gke_hub_membership_binding#import import section} in the documentation of this resource for the id to use
