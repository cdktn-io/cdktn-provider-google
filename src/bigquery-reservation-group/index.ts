...
// https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/bigquery_reservation_group
...
export class BigqueryReservationGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BigqueryReservationGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/bigquery_reservation_group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/bigquery_reservation_group google_bigquery_reservation_group} Resource
  *
  * @param scope The scope in which to define this construct
