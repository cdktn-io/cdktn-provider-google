...
// https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/resources/kms_project_autokey_config
...
export class KmsProjectAutokeyConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsProjectAutokeyConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/resources/kms_project_autokey_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/resources/kms_project_autokey_config google_kms_project_autokey_config} Resource
  *
  * @param scope The scope in which to define this construct
