...
// https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/dns_managed_zone_iam_member
...
export class DnsManagedZoneIamMember extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsManagedZoneIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/dns_managed_zone_iam_member#import import section} in the documentation of this resource for the id to use
