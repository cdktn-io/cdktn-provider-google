...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/logging_folder_sink
...
export class LoggingFolderSink extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingFolderSink that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/logging_folder_sink#import import section} in the documentation of this resource for the id to use
