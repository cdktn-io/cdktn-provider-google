...
export interface SccV2ProjectNotificationConfigConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class SccV2ProjectNotificationConfigStreamingConfigOutputReference extends cdktf.ComplexObject {
...
export function sccV2ProjectNotificationConfigTimeoutsToTerraform(struct?: SccV2ProjectNotificationConfigTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function sccV2ProjectNotificationConfigTimeoutsToHclTerraform(struct?: SccV2ProjectNotificationConfigTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SccV2ProjectNotificationConfigTimeoutsOutputReference extends cdktf.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): SccV2ProjectNotificationConfigTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SccV2ProjectNotificationConfigTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class SccV2ProjectNotificationConfig extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_scc_v2_project_notification_config", importId: importFromId, provider });
      }
