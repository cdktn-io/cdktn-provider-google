...
// https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/data-sources/compute_reservation_sub_block
...
export class DataGoogleComputeReservationSubBlock extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeReservationSubBlock that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/data-sources/compute_reservation_sub_block#import import section} in the documentation of this resource for the id to use
