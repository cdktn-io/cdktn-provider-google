...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/org_policy_policy
...
export class OrgPolicyPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OrgPolicyPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/org_policy_policy#import import section} in the documentation of this resource for the id to use
