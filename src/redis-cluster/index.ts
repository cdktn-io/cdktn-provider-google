...
// https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/redis_cluster
...
export class RedisCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing RedisCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/redis_cluster#import import section} in the documentation of this resource for the id to use
