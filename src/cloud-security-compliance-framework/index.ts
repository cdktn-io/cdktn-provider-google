...
// https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/cloud_security_compliance_framework
...
export class CloudSecurityComplianceFramework extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudSecurityComplianceFramework that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/resources/cloud_security_compliance_framework#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  public get supportedEnforcementModes() {
    return cdktn.Fn.tolist(this.getListAttribute('supported_enforcement_modes'));
  }
