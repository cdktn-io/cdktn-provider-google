...
// https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/workbench_instance
...
export class WorkbenchInstance extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing WorkbenchInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/workbench_instance#import import section} in the documentation of this resource for the id to use
