...
// https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/integration_connectors_endpoint_attachment
...
export class IntegrationConnectorsEndpointAttachment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationConnectorsEndpointAttachment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/integration_connectors_endpoint_attachment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/integration_connectors_endpoint_attachment google_integration_connectors_endpoint_attachment} Resource
  *
  * @param scope The scope in which to define this construct
