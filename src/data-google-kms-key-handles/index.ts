...
// https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/data-sources/kms_key_handles
...
export class DataGoogleKmsKeyHandles extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleKmsKeyHandles that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/data-sources/kms_key_handles#import import section} in the documentation of this resource for the id to use
