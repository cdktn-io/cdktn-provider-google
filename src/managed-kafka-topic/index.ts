...
// https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/managed_kafka_topic
...
export class ManagedKafkaTopic extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedKafkaTopic that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/managed_kafka_topic#import import section} in the documentation of this resource for the id to use
