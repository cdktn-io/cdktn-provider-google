...
// https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/data-sources/compute_storage_pool
...
export class DataGoogleComputeStoragePool extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeStoragePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/data-sources/compute_storage_pool#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/data-sources/compute_storage_pool google_compute_storage_pool} Data Source
  *
  * @param scope The scope in which to define this construct
