...
// https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/chronicle_rule_deployment
...
export interface ChronicleRuleDeploymentConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly scheduleCustomizations?: ChronicleRuleDeploymentScheduleCustomizations;
  /**
  * timeouts block
  *
...
export interface ChronicleRuleDeploymentScheduleCustomizations {
  /**
  ...
  */
  readonly ensureEnrichmentCompleteness?: boolean | cdktn.IResolvable;
  /**
  ...
  */
  readonly lateArrivingDataAdjustment?: string;
}

export function chronicleRuleDeploymentScheduleCustomizationsToTerraform(struct?: ChronicleRuleDeploymentScheduleCustomizationsOutputReference | ChronicleRuleDeploymentScheduleCustomizations): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  return {
    ensure_enrichment_completeness: cdktn.booleanToTerraform(struct!.ensureEnrichmentCompleteness),
    late_arriving_data_adjustment: cdktn.stringToTerraform(struct!.lateArrivingDataAdjustment),
  }
}


export function chronicleRuleDeploymentScheduleCustomizationsToHclTerraform(struct?: ChronicleRuleDeploymentScheduleCustomizationsOutputReference | ChronicleRuleDeploymentScheduleCustomizations): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
  const attrs = {
    ensure_enrichment_completeness: {
      value: cdktn.booleanToHclTerraform(struct!.ensureEnrichmentCompleteness),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
    late_arriving_data_adjustment: {
      value: cdktn.stringToHclTerraform(struct!.lateArrivingDataAdjustment),
      isBlock: false,
      type: "simple",
...
export class ChronicleRuleDeploymentScheduleCustomizationsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ChronicleRuleDeploymentScheduleCustomizations | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._ensureEnrichmentCompleteness !== undefined) {
      hasAnyValues = true;
      internalValueResult.ensureEnrichmentCompleteness = this._ensureEnrichmentCompleteness;
    }
    if (this._lateArrivingDataAdjustment !== undefined) {
      hasAnyValues = true;
      internalValueResult.lateArrivingDataAdjustment = this._lateArrivingDataAdjustment;
    }
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: ChronicleRuleDeploymentScheduleCustomizations | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._ensureEnrichmentCompleteness = undefined;
      this._lateArrivingDataAdjustment = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      this._ensureEnrichmentCompleteness = value.ensureEnrichmentCompleteness;
      this._lateArrivingDataAdjustment = value.lateArrivingDataAdjustment;
    }
  }

  // ensure_enrichment_completeness - computed: false, optional: true, required: false
  private _ensureEnrichmentCompleteness?: boolean | cdktn.IResolvable; 
  public get ensureEnrichmentCompleteness() {
    return this.getBooleanAttribute('ensure_enrichment_completeness');
  }
  public set ensureEnrichmentCompleteness(value: boolean | cdktn.IResolvable) {
    this._ensureEnrichmentCompleteness = value;
  }
  public resetEnsureEnrichmentCompleteness() {
    this._ensureEnrichmentCompleteness = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get ensureEnrichmentCompletenessInput() {
    return this._ensureEnrichmentCompleteness;
  }

  // late_arriving_data_adjustment - computed: false, optional: true, required: false
  private _lateArrivingDataAdjustment?: string; 
  public get lateArrivingDataAdjustment() {
    return this.getStringAttribute('late_arriving_data_adjustment');
  }
  public set lateArrivingDataAdjustment(value: string) {
    this._lateArrivingDataAdjustment = value;
  }
  public resetLateArrivingDataAdjustment() {
    this._lateArrivingDataAdjustment = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get lateArrivingDataAdjustmentInput() {
    return this._lateArrivingDataAdjustment;
  }
}
...
export function chronicleRuleDeploymentTimeoutsToTerraform(struct?: ChronicleRuleDeploymentTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function chronicleRuleDeploymentTimeoutsToHclTerraform(struct?: ChronicleRuleDeploymentTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ChronicleRuleDeploymentTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ChronicleRuleDeploymentTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ChronicleRuleDeploymentTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class ChronicleRuleDeployment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ChronicleRuleDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/chronicle_rule_deployment#import import section} in the documentation of this resource for the id to use
  ...
  */
  public constructor(scope: Construct, id: string, config: ChronicleRuleDeploymentConfig) {
    ...
    this._scheduleCustomizations.internalValue = config.scheduleCustomizations;
  ...
  // schedule_customizations - computed: false, optional: true, required: false
  private _scheduleCustomizations = new ChronicleRuleDeploymentScheduleCustomizationsOutputReference(this, "schedule_customizations");
  public get scheduleCustomizations() {
    return this._scheduleCustomizations;
  }
  public putScheduleCustomizations(value: ChronicleRuleDeploymentScheduleCustomizations) {
    this._scheduleCustomizations.internalValue = value;
  }
  public resetScheduleCustomizations() {
    this._scheduleCustomizations.internalValue = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get scheduleCustomizationsInput() {
    return this._scheduleCustomizations.internalValue;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      schedule_customizations: chronicleRuleDeploymentScheduleCustomizationsToTerraform(this._scheduleCustomizations.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      schedule_customizations: {
        value: chronicleRuleDeploymentScheduleCustomizationsToHclTerraform(this._scheduleCustomizations.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ChronicleRuleDeploymentScheduleCustomizationsList",
      },
      timeouts: {
