...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/compute_packet_mirroring
...
export class ComputePacketMirroringMirroredResourcesOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  private _instances = new ComputePacketMirroringMirroredResourcesInstancesList(this, "instances", true);
  ...
  private _subnetworks = new ComputePacketMirroringMirroredResourcesSubnetworksList(this, "subnetworks", true);
...
export class ComputePacketMirroring extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ComputePacketMirroring that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/compute_packet_mirroring#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/compute_packet_mirroring google_compute_packet_mirroring} Resource
  *
  * @param scope The scope in which to define this construct
