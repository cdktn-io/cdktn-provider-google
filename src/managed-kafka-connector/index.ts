...
// https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/managed_kafka_connector
...
export class ManagedKafkaConnector extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ManagedKafkaConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/managed_kafka_connector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/managed_kafka_connector google_managed_kafka_connector} Resource
  *
  * @param scope The scope in which to define this construct
