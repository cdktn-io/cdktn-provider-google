...
// https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/data-sources/secret_manager_regional_secret
...
export class DataGoogleSecretManagerRegionalSecret extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleSecretManagerRegionalSecret that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/data-sources/secret_manager_regional_secret#import import section} in the documentation of this resource for the id to use
