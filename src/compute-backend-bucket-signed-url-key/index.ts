...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/compute_backend_bucket_signed_url_key
...
export interface ComputeBackendBucketSignedUrlKeyConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function computeBackendBucketSignedUrlKeyTimeoutsToTerraform(struct?: ComputeBackendBucketSignedUrlKeyTimeouts | cdktn.IResolvable): any {
...
export function computeBackendBucketSignedUrlKeyTimeoutsToHclTerraform(struct?: ComputeBackendBucketSignedUrlKeyTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ComputeBackendBucketSignedUrlKeyTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ComputeBackendBucketSignedUrlKeyTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ComputeBackendBucketSignedUrlKeyTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class ComputeBackendBucketSignedUrlKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ComputeBackendBucketSignedUrlKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/compute_backend_bucket_signed_url_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/compute_backend_bucket_signed_url_key google_compute_backend_bucket_signed_url_key} Resource
  *
  * @param scope The scope in which to define this construct
