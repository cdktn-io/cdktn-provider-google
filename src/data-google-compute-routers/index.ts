...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/data-sources/compute_routers
...
export class DataGoogleComputeRouters extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeRouters that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/data-sources/compute_routers#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/data-sources/compute_routers google_compute_routers} Data Source
  *
  * @param scope The scope in which to define this construct
