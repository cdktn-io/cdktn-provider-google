...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/biglake_iceberg_catalog
...
export class BiglakeIcebergCatalog extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BiglakeIcebergCatalog that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/biglake_iceberg_catalog#import import section} in the documentation of this resource for the id to use
