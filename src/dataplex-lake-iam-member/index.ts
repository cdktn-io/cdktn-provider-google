...
// https://registry.terraform.io/providers/hashicorp/google/7.33.0/docs/resources/dataplex_lake_iam_member
...
export class DataplexLakeIamMember extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DataplexLakeIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.33.0/docs/resources/dataplex_lake_iam_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.33.0/docs/resources/dataplex_lake_iam_member google_dataplex_lake_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
