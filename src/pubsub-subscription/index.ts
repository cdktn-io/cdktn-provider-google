...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/pubsub_subscription
...
export interface PubsubSubscriptionMessageTransformsJavascriptUdf {
  ...
  * ```
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/pubsub_subscription#code PubsubSubscription#code}
   *
...
export class PubsubSubscription extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PubsubSubscription that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/pubsub_subscription#import import section} in the documentation of this resource for the id to use
