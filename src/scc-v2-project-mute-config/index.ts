...
export function sccV2ProjectMuteConfigTimeoutsToTerraform(struct?: SccV2ProjectMuteConfigTimeouts | cdktf.IResolvable): any {
...
export function sccV2ProjectMuteConfigTimeoutsToHclTerraform(struct?: SccV2ProjectMuteConfigTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class SccV2ProjectMuteConfigTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): SccV2ProjectMuteConfigTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: SccV2ProjectMuteConfigTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class SccV2ProjectMuteConfig extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_scc_v2_project_mute_config", importId: importFromId, provider });
      }
