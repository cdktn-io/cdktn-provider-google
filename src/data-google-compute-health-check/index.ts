...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/data-sources/compute_health_check
...
export class DataGoogleComputeHealthCheck extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeHealthCheck that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/data-sources/compute_health_check#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/data-sources/compute_health_check google_compute_health_check} Data Source
  *
  * @param scope The scope in which to define this construct
