...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings
...
export interface DialogflowCxGenerativeSettingsConfig extends cdktn.TerraformMetaArguments {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#id DialogflowCxGenerativeSettings#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#language_code DialogflowCxGenerativeSettings#language_code}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#parent DialogflowCxGenerativeSettings#parent}
  */
  readonly parent?: string;
  /**
  * fallback_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#fallback_settings DialogflowCxGenerativeSettings#fallback_settings}
  */
  readonly fallbackSettings?: DialogflowCxGenerativeSettingsFallbackSettings;
  /**
  * generative_safety_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#generative_safety_settings DialogflowCxGenerativeSettings#generative_safety_settings}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#knowledge_connector_settings DialogflowCxGenerativeSettings#knowledge_connector_settings}
  */
  readonly knowledgeConnectorSettings?: DialogflowCxGenerativeSettingsKnowledgeConnectorSettings;
  /**
  * llm_model_settings block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#llm_model_settings DialogflowCxGenerativeSettings#llm_model_settings}
  */
  readonly llmModelSettings?: DialogflowCxGenerativeSettingsLlmModelSettings;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#timeouts DialogflowCxGenerativeSettings#timeouts}
  */
...
export interface DialogflowCxGenerativeSettingsFallbackSettingsPromptTemplates {
  ...
  * Prompt name.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#display_name DialogflowCxGenerativeSettings#display_name}
  */
  readonly displayName?: string;
  /**
  * If the flag is true, the prompt is frozen and cannot be modified by users.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#frozen DialogflowCxGenerativeSettings#frozen}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#prompt_text DialogflowCxGenerativeSettings#prompt_text}
  */
  readonly promptText?: string;
}

export function dialogflowCxGenerativeSettingsFallbackSettingsPromptTemplatesToTerraform(struct?: DialogflowCxGenerativeSettingsFallbackSettingsPromptTemplates | cdktn.IResolvable): any {
...
export function dialogflowCxGenerativeSettingsFallbackSettingsPromptTemplatesToHclTerraform(struct?: DialogflowCxGenerativeSettingsFallbackSettingsPromptTemplates | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DialogflowCxGenerativeSettingsFallbackSettingsPromptTemplatesOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DialogflowCxGenerativeSettingsFallbackSettingsPromptTemplates | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DialogflowCxGenerativeSettingsFallbackSettingsPromptTemplates | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
export class DialogflowCxGenerativeSettingsFallbackSettingsPromptTemplatesList extends cdktn.ComplexList {
  public internalValue? : DialogflowCxGenerativeSettingsFallbackSettingsPromptTemplates[] | cdktn.IResolvable
...
export interface DialogflowCxGenerativeSettingsFallbackSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#selected_prompt DialogflowCxGenerativeSettings#selected_prompt}
  */
  readonly selectedPrompt?: string;
  /**
  * prompt_templates block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#prompt_templates DialogflowCxGenerativeSettings#prompt_templates}
  */
  readonly promptTemplates?: DialogflowCxGenerativeSettingsFallbackSettingsPromptTemplates[] | cdktn.IResolvable;
}
...
export function dialogflowCxGenerativeSettingsFallbackSettingsToTerraform(struct?: DialogflowCxGenerativeSettingsFallbackSettingsOutputReference | DialogflowCxGenerativeSettingsFallbackSettings): any {
  ...
  return {
    ...
    prompt_templates: cdktn.listMapper(dialogflowCxGenerativeSettingsFallbackSettingsPromptTemplatesToTerraform, true)(struct!.promptTemplates),
  }
}
...
export function dialogflowCxGenerativeSettingsFallbackSettingsToHclTerraform(struct?: DialogflowCxGenerativeSettingsFallbackSettingsOutputReference | DialogflowCxGenerativeSettingsFallbackSettings): any {
  ...
  const attrs = {
    ...
    prompt_templates: {
      value: cdktn.listMapperHcl(dialogflowCxGenerativeSettingsFallbackSettingsPromptTemplatesToHclTerraform, true)(struct!.promptTemplates),
      isBlock: true,
      type: "list",
...
export class DialogflowCxGenerativeSettingsFallbackSettingsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public putPromptTemplates(value: DialogflowCxGenerativeSettingsFallbackSettingsPromptTemplates[] | cdktn.IResolvable) {
...
export interface DialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrases {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#text DialogflowCxGenerativeSettings#text}
  */
  readonly text: string;
}

export function dialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrasesToTerraform(struct?: DialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrases | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrasesToHclTerraform(struct?: DialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrases | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrasesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): DialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrases | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrases | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
export class DialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrasesList extends cdktn.ComplexList {
  public internalValue? : DialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrases[] | cdktn.IResolvable
...
export interface DialogflowCxGenerativeSettingsGenerativeSafetySettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#default_banned_phrase_match_strategy DialogflowCxGenerativeSettings#default_banned_phrase_match_strategy}
  */
  readonly defaultBannedPhraseMatchStrategy?: string;
  /**
  * banned_phrases block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#banned_phrases DialogflowCxGenerativeSettings#banned_phrases}
  */
  readonly bannedPhrases?: DialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrases[] | cdktn.IResolvable;
}
...
export function dialogflowCxGenerativeSettingsGenerativeSafetySettingsToTerraform(struct?: DialogflowCxGenerativeSettingsGenerativeSafetySettingsOutputReference | DialogflowCxGenerativeSettingsGenerativeSafetySettings): any {
  ...
  return {
    ...
    banned_phrases: cdktn.listMapper(dialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrasesToTerraform, true)(struct!.bannedPhrases),
  }
}
...
export function dialogflowCxGenerativeSettingsGenerativeSafetySettingsToHclTerraform(struct?: DialogflowCxGenerativeSettingsGenerativeSafetySettingsOutputReference | DialogflowCxGenerativeSettingsGenerativeSafetySettings): any {
  ...
  const attrs = {
    ...
    banned_phrases: {
      value: cdktn.listMapperHcl(dialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrasesToHclTerraform, true)(struct!.bannedPhrases),
      isBlock: true,
      type: "list",
...
export class DialogflowCxGenerativeSettingsGenerativeSafetySettingsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public putBannedPhrases(value: DialogflowCxGenerativeSettingsGenerativeSafetySettingsBannedPhrases[] | cdktn.IResolvable) {
...
export interface DialogflowCxGenerativeSettingsKnowledgeConnectorSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#agent DialogflowCxGenerativeSettings#agent}
  */
  readonly agent?: string;
  /**
  * Identity of the agent, e.g. "virtual agent", "AI assistant".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#agent_identity DialogflowCxGenerativeSettings#agent_identity}
  */
  readonly agentIdentity?: string;
  /**
  * Agent scope, e.g. "Example company website", "internal Example company website for employees", "manual of car owner".
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#agent_scope DialogflowCxGenerativeSettings#agent_scope}
  */
  readonly agentScope?: string;
  /**
  * Name of the company, organization or other entity that the agent represents. Used for knowledge connector LLM prompt and for knowledge search.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#business DialogflowCxGenerativeSettings#business}
  */
  readonly business?: string;
  /**
  * Company description, used for LLM prompt, e.g. "a family company selling freshly roasted coffee beans".''
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#business_description DialogflowCxGenerativeSettings#business_description}
  */
  readonly businessDescription?: string;
  /**
  * Whether to disable fallback to Data Store search results (in case the LLM couldn't pick a proper answer). Per default the feature is enabled.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#disable_data_store_fallback DialogflowCxGenerativeSettings#disable_data_store_fallback}
  */
...
export class DialogflowCxGenerativeSettingsKnowledgeConnectorSettingsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface DialogflowCxGenerativeSettingsLlmModelSettings {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#model DialogflowCxGenerativeSettings#model}
  */
...
export class DialogflowCxGenerativeSettingsLlmModelSettingsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface DialogflowCxGenerativeSettingsTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#create DialogflowCxGenerativeSettings#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#delete DialogflowCxGenerativeSettings#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#update DialogflowCxGenerativeSettings#update}
  */
  readonly update?: string;
}

export function dialogflowCxGenerativeSettingsTimeoutsToTerraform(struct?: DialogflowCxGenerativeSettingsTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dialogflowCxGenerativeSettingsTimeoutsToHclTerraform(struct?: DialogflowCxGenerativeSettingsTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DialogflowCxGenerativeSettingsTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): DialogflowCxGenerativeSettingsTimeouts | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: DialogflowCxGenerativeSettingsTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings google_dialogflow_cx_generative_settings}
*/
export class DialogflowCxGenerativeSettings extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DialogflowCxGenerativeSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_generative_settings google_dialogflow_cx_generative_settings} Resource
  *
  * @param scope The scope in which to define this construct
