...
// https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/biglake_iceberg_table_iam_member
...
export class BiglakeIcebergTableIamMember extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BiglakeIcebergTableIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/biglake_iceberg_table_iam_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/biglake_iceberg_table_iam_member google_biglake_iceberg_table_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
