...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/cloudfunctions_function
...
export class CloudfunctionsFunction extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudfunctionsFunction that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/cloudfunctions_function#import import section} in the documentation of this resource for the id to use
