...
// https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/dataplex_glossary_category
...
export interface DataplexGlossaryCategoryConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function dataplexGlossaryCategoryTimeoutsToTerraform(struct?: DataplexGlossaryCategoryTimeouts | cdktf.IResolvable): any {
...
export function dataplexGlossaryCategoryTimeoutsToHclTerraform(struct?: DataplexGlossaryCategoryTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class DataplexGlossaryCategoryTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataplexGlossaryCategoryTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: DataplexGlossaryCategoryTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class DataplexGlossaryCategory extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataplexGlossaryCategory that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/dataplex_glossary_category#import import section} in the documentation of this resource for the id to use
