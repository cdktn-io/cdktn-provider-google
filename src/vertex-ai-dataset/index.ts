...
// https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/vertex_ai_dataset
...
export class VertexAiDataset extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing VertexAiDataset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/vertex_ai_dataset#import import section} in the documentation of this resource for the id to use
