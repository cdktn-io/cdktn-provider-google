...
// https://registry.terraform.io/providers/hashicorp/google/7.39.0/docs/data-sources/beyondcorp_app_connector
...
export class DataGoogleBeyondcorpAppConnector extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleBeyondcorpAppConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.39.0/docs/data-sources/beyondcorp_app_connector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.39.0/docs/data-sources/beyondcorp_app_connector google_beyondcorp_app_connector} Data Source
  *
  * @param scope The scope in which to define this construct
