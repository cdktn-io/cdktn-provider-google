...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/netapp_volume_snapshot
...
export interface NetappVolumeSnapshotConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function netappVolumeSnapshotTimeoutsToTerraform(struct?: NetappVolumeSnapshotTimeouts | cdktn.IResolvable): any {
...
export function netappVolumeSnapshotTimeoutsToHclTerraform(struct?: NetappVolumeSnapshotTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class NetappVolumeSnapshotTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): NetappVolumeSnapshotTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: NetappVolumeSnapshotTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class NetappVolumeSnapshot extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NetappVolumeSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/netapp_volume_snapshot#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/netapp_volume_snapshot google_netapp_volume_snapshot} Resource
  *
  * @param scope The scope in which to define this construct
