...
// https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/netapp_volume_snapshot
...
export class NetappVolumeSnapshot extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NetappVolumeSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/netapp_volume_snapshot#import import section} in the documentation of this resource for the id to use
