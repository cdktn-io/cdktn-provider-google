...
// https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/resources/healthcare_consent_store_iam_member
...
export class HealthcareConsentStoreIamMember extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing HealthcareConsentStoreIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/resources/healthcare_consent_store_iam_member#import import section} in the documentation of this resource for the id to use
