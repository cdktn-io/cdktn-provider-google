...
// https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/data-sources/logging_sink
...
export class DataGoogleLoggingSink extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleLoggingSink that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/data-sources/logging_sink#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/data-sources/logging_sink google_logging_sink} Data Source
  *
  * @param scope The scope in which to define this construct
