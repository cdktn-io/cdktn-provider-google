...
// https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/cloud_run_service_iam_policy
...
export class CloudRunServiceIamPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudRunServiceIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/cloud_run_service_iam_policy#import import section} in the documentation of this resource for the id to use
