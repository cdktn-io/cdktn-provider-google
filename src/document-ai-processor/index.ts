...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/document_ai_processor
...
export interface DocumentAiProcessorConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function documentAiProcessorTimeoutsToTerraform(struct?: DocumentAiProcessorTimeouts | cdktn.IResolvable): any {
...
export function documentAiProcessorTimeoutsToHclTerraform(struct?: DocumentAiProcessorTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DocumentAiProcessorTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DocumentAiProcessorTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DocumentAiProcessorTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class DocumentAiProcessor extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DocumentAiProcessor that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/document_ai_processor#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/document_ai_processor google_document_ai_processor} Resource
  *
  * @param scope The scope in which to define this construct
