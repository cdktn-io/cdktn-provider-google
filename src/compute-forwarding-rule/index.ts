...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/compute_forwarding_rule
...
export interface ComputeForwardingRuleConfig extends cdktn.TerraformMetaArguments {
  ...
  * @pattern: \d+(?:-\d+)?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/compute_forwarding_rule#port_range ComputeForwardingRule#port_range}
  */
  ...
  * @pattern: \d+(?:-\d+)?
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/compute_forwarding_rule#ports ComputeForwardingRule#ports}
  */
...
export class ComputeForwardingRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ComputeForwardingRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/compute_forwarding_rule#import import section} in the documentation of this resource for the id to use
