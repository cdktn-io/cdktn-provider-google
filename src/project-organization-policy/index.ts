...
// https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/project_organization_policy
...
export class ProjectOrganizationPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ProjectOrganizationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/project_organization_policy#import import section} in the documentation of this resource for the id to use
