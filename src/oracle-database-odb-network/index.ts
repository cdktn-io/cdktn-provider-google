...
// https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/resources/oracle_database_odb_network
...
export class OracleDatabaseOdbNetwork extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OracleDatabaseOdbNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/resources/oracle_database_odb_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/resources/oracle_database_odb_network google_oracle_database_odb_network} Resource
  *
  * @param scope The scope in which to define this construct
