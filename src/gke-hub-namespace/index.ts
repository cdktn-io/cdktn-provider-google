...
// https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/gke_hub_namespace
...
export class GkeHubNamespace extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing GkeHubNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/gke_hub_namespace#import import section} in the documentation of this resource for the id to use
