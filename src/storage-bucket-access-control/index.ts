...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/storage_bucket_access_control
...
export class StorageBucketAccessControl extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageBucketAccessControl that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/storage_bucket_access_control#import import section} in the documentation of this resource for the id to use
