...
// https://registry.terraform.io/providers/hashicorp/google/7.32.0/docs/data-sources/access_context_manager_supported_services
...
export class DataGoogleAccessContextManagerSupportedServices extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleAccessContextManagerSupportedServices that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.32.0/docs/data-sources/access_context_manager_supported_services#import import section} in the documentation of this resource for the id to use
