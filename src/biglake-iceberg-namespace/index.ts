...
// https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/biglake_iceberg_namespace
...
export class BiglakeIcebergNamespace extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BiglakeIcebergNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/biglake_iceberg_namespace#import import section} in the documentation of this resource for the id to use
