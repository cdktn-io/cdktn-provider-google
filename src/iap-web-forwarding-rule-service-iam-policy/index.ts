...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/iap_web_forwarding_rule_service_iam_policy
...
export class IapWebForwardingRuleServiceIamPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IapWebForwardingRuleServiceIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/iap_web_forwarding_rule_service_iam_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/iap_web_forwarding_rule_service_iam_policy google_iap_web_forwarding_rule_service_iam_policy} Resource
  *
  * @param scope The scope in which to define this construct
