...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/data-sources/lustre_instance
...
export class DataGoogleLustreInstance extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleLustreInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/data-sources/lustre_instance#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/data-sources/lustre_instance google_lustre_instance} Data Source
  *
  * @param scope The scope in which to define this construct
