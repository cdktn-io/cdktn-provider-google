...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/data_catalog_taxonomy
...
export interface DataCatalogTaxonomyConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function dataCatalogTaxonomyTimeoutsToTerraform(struct?: DataCatalogTaxonomyTimeouts | cdktn.IResolvable): any {
...
export function dataCatalogTaxonomyTimeoutsToHclTerraform(struct?: DataCatalogTaxonomyTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataCatalogTaxonomyTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataCatalogTaxonomyTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataCatalogTaxonomyTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class DataCatalogTaxonomy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DataCatalogTaxonomy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/data_catalog_taxonomy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/data_catalog_taxonomy google_data_catalog_taxonomy} Resource
  *
  * @param scope The scope in which to define this construct
