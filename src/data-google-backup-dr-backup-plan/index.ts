...
// https://registry.terraform.io/providers/hashicorp/google/7.35.0/docs/data-sources/backup_dr_backup_plan
...
export class DataGoogleBackupDrBackupPlan extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleBackupDrBackupPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.35.0/docs/data-sources/backup_dr_backup_plan#import import section} in the documentation of this resource for the id to use
