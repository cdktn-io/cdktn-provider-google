...
// https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/resources/blockchain_node_engine_blockchain_nodes
...
export interface BlockchainNodeEngineBlockchainNodesConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class BlockchainNodeEngineBlockchainNodesConnectionInfoEndpointInfoOutputReference extends cdktn.ComplexObject {
...
export class BlockchainNodeEngineBlockchainNodesConnectionInfoEndpointInfoList extends cdktn.ComplexList {
...
export class BlockchainNodeEngineBlockchainNodesConnectionInfoOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class BlockchainNodeEngineBlockchainNodesConnectionInfoList extends cdktn.ComplexList {
...
export class BlockchainNodeEngineBlockchainNodesEthereumDetailsAdditionalEndpointsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class BlockchainNodeEngineBlockchainNodesEthereumDetailsAdditionalEndpointsList extends cdktn.ComplexList {
...
export class BlockchainNodeEngineBlockchainNodesEthereumDetailsGethDetailsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface BlockchainNodeEngineBlockchainNodesEthereumDetailsValidatorConfig {
  ...
  */
  readonly beaconFeeRecipient?: string;
  /**
...
export function blockchainNodeEngineBlockchainNodesEthereumDetailsValidatorConfigToTerraform(struct?: BlockchainNodeEngineBlockchainNodesEthereumDetailsValidatorConfigOutputReference | BlockchainNodeEngineBlockchainNodesEthereumDetailsValidatorConfig): any {
  ...
  return {
    beacon_fee_recipient: cdktn.stringToTerraform(struct!.beaconFeeRecipient),
...
export function blockchainNodeEngineBlockchainNodesEthereumDetailsValidatorConfigToHclTerraform(struct?: BlockchainNodeEngineBlockchainNodesEthereumDetailsValidatorConfigOutputReference | BlockchainNodeEngineBlockchainNodesEthereumDetailsValidatorConfig): any {
  ...
  const attrs = {
    beacon_fee_recipient: {
      value: cdktn.stringToHclTerraform(struct!.beaconFeeRecipient),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class BlockchainNodeEngineBlockchainNodesEthereumDetailsValidatorConfigOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): BlockchainNodeEngineBlockchainNodesEthereumDetailsValidatorConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._beaconFeeRecipient !== undefined) {
      hasAnyValues = true;
      internalValueResult.beaconFeeRecipient = this._beaconFeeRecipient;
    }
  ...
  public set internalValue(value: BlockchainNodeEngineBlockchainNodesEthereumDetailsValidatorConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._beaconFeeRecipient = undefined;
      this._mevRelayUrls = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      this._beaconFeeRecipient = value.beaconFeeRecipient;
      this._mevRelayUrls = value.mevRelayUrls;
    }
  }

  // beacon_fee_recipient - computed: false, optional: true, required: false
  private _beaconFeeRecipient?: string; 
  public get beaconFeeRecipient() {
    return this.getStringAttribute('beacon_fee_recipient');
  }
  public set beaconFeeRecipient(value: string) {
    this._beaconFeeRecipient = value;
  }
  public resetBeaconFeeRecipient() {
    this._beaconFeeRecipient = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get beaconFeeRecipientInput() {
    return this._beaconFeeRecipient;
  }
...
export class BlockchainNodeEngineBlockchainNodesEthereumDetailsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function blockchainNodeEngineBlockchainNodesTimeoutsToTerraform(struct?: BlockchainNodeEngineBlockchainNodesTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function blockchainNodeEngineBlockchainNodesTimeoutsToHclTerraform(struct?: BlockchainNodeEngineBlockchainNodesTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class BlockchainNodeEngineBlockchainNodesTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): BlockchainNodeEngineBlockchainNodesTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: BlockchainNodeEngineBlockchainNodesTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class BlockchainNodeEngineBlockchainNodes extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BlockchainNodeEngineBlockchainNodes that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/resources/blockchain_node_engine_blockchain_nodes#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/resources/blockchain_node_engine_blockchain_nodes google_blockchain_node_engine_blockchain_nodes} Resource
  *
  * @param scope The scope in which to define this construct
