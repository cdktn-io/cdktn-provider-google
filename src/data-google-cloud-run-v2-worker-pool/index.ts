...
// https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/data-sources/cloud_run_v2_worker_pool
...
export class DataGoogleCloudRunV2WorkerPool extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleCloudRunV2WorkerPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/data-sources/cloud_run_v2_worker_pool#import import section} in the documentation of this resource for the id to use
