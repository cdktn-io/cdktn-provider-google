...
// https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/compute_network
...
export interface ComputeNetworkConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly deleteBgpAlwaysCompareMed?: boolean | cdktn.IResolvable;
  /**
...
export class ComputeNetworkParamsOutputReference extends cdktn.ComplexObject {
...
export function computeNetworkTimeoutsToTerraform(struct?: ComputeNetworkTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function computeNetworkTimeoutsToHclTerraform(struct?: ComputeNetworkTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ComputeNetworkTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ComputeNetworkTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ComputeNetworkTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class ComputeNetwork extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ComputeNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/compute_network#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/compute_network google_compute_network} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  public constructor(scope: Construct, id: string, config: ComputeNetworkConfig) {
    ...
    this._deleteBgpAlwaysCompareMed = config.deleteBgpAlwaysCompareMed;
  ...
  // delete_bgp_always_compare_med - computed: false, optional: true, required: false
  private _deleteBgpAlwaysCompareMed?: boolean | cdktn.IResolvable; 
  public get deleteBgpAlwaysCompareMed() {
    return this.getBooleanAttribute('delete_bgp_always_compare_med');
  }
  public set deleteBgpAlwaysCompareMed(value: boolean | cdktn.IResolvable) {
    this._deleteBgpAlwaysCompareMed = value;
  }
  public resetDeleteBgpAlwaysCompareMed() {
    this._deleteBgpAlwaysCompareMed = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get deleteBgpAlwaysCompareMedInput() {
    return this._deleteBgpAlwaysCompareMed;
  }
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      delete_bgp_always_compare_med: cdktn.booleanToTerraform(this._deleteBgpAlwaysCompareMed),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      delete_bgp_always_compare_med: {
        value: cdktn.booleanToHclTerraform(this._deleteBgpAlwaysCompareMed),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
