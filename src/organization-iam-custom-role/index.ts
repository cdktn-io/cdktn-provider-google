...
// https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/organization_iam_custom_role
...
export class OrganizationIamCustomRole extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OrganizationIamCustomRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/organization_iam_custom_role#import import section} in the documentation of this resource for the id to use
