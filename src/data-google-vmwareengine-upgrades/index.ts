...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/data-sources/vmwareengine_upgrades
...
export class DataGoogleVmwareengineUpgrades extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleVmwareengineUpgrades that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/data-sources/vmwareengine_upgrades#import import section} in the documentation of this resource for the id to use
