...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/firebase_app_check_debug_token
...
export class FirebaseAppCheckDebugToken extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FirebaseAppCheckDebugToken that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/firebase_app_check_debug_token#import import section} in the documentation of this resource for the id to use
