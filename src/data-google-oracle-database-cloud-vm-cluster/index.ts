...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/oracle_database_cloud_vm_cluster
...
export interface DataGoogleOracleDatabaseCloudVmClusterConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/oracle_database_cloud_vm_cluster#cloud_vm_cluster_id DataGoogleOracleDatabaseCloudVmCluster#cloud_vm_cluster_id}
  */
  readonly cloudVmClusterId: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/oracle_database_cloud_vm_cluster#id DataGoogleOracleDatabaseCloudVmCluster#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/oracle_database_cloud_vm_cluster#location DataGoogleOracleDatabaseCloudVmCluster#location}
  */
  readonly location: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/oracle_database_cloud_vm_cluster#project DataGoogleOracleDatabaseCloudVmCluster#project}
  */
  readonly project?: string;
}
export interface DataGoogleOracleDatabaseCloudVmClusterIdentityConnector {
}

export function dataGoogleOracleDatabaseCloudVmClusterIdentityConnectorToTerraform(struct?: DataGoogleOracleDatabaseCloudVmClusterIdentityConnector): any {
...
export function dataGoogleOracleDatabaseCloudVmClusterIdentityConnectorToHclTerraform(struct?: DataGoogleOracleDatabaseCloudVmClusterIdentityConnector): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataGoogleOracleDatabaseCloudVmClusterIdentityConnectorOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataGoogleOracleDatabaseCloudVmClusterIdentityConnector | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGoogleOracleDatabaseCloudVmClusterIdentityConnector | undefined) {
    if (value === undefined) {
...
export class DataGoogleOracleDatabaseCloudVmClusterIdentityConnectorList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataGoogleOracleDatabaseCloudVmClusterIdentityConnectorOutputReference {
    return new DataGoogleOracleDatabaseCloudVmClusterIdentityConnectorOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataGoogleOracleDatabaseCloudVmClusterPropertiesDiagnosticsDataCollectionOptionsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleOracleDatabaseCloudVmClusterPropertiesDiagnosticsDataCollectionOptionsList extends cdktn.ComplexList {
...
export class DataGoogleOracleDatabaseCloudVmClusterPropertiesTimeZoneOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleOracleDatabaseCloudVmClusterPropertiesTimeZoneList extends cdktn.ComplexList {
...
export class DataGoogleOracleDatabaseCloudVmClusterPropertiesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleOracleDatabaseCloudVmClusterPropertiesList extends cdktn.ComplexList {
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/oracle_database_cloud_vm_cluster google_oracle_database_cloud_vm_cluster}
*/
export class DataGoogleOracleDatabaseCloudVmCluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleOracleDatabaseCloudVmCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/oracle_database_cloud_vm_cluster#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/oracle_database_cloud_vm_cluster google_oracle_database_cloud_vm_cluster} Data Source
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // backup_odb_subnet - computed: true, optional: false, required: false
  ...
  // exascale_db_storage_vault - computed: true, optional: false, required: false
  ...
  private _identityConnector = new DataGoogleOracleDatabaseCloudVmClusterIdentityConnectorList(this, "identity_connector", false);
