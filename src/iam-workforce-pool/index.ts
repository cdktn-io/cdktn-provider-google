...
// https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/iam_workforce_pool
...
export class IamWorkforcePool extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IamWorkforcePool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/iam_workforce_pool#import import section} in the documentation of this resource for the id to use
