...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/edgecontainer_vpn_connection
...
export class EdgecontainerVpnConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EdgecontainerVpnConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/edgecontainer_vpn_connection#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/edgecontainer_vpn_connection google_edgecontainer_vpn_connection} Resource
  *
  * @param scope The scope in which to define this construct
