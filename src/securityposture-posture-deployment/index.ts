...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/securityposture_posture_deployment
...
export class SecurityposturePostureDeployment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SecurityposturePostureDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/securityposture_posture_deployment#import import section} in the documentation of this resource for the id to use
