...
// https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/hypercomputecluster_cluster
...
export class HypercomputeclusterCluster extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing HypercomputeclusterCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/hypercomputecluster_cluster#import import section} in the documentation of this resource for the id to use
