...
// https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/beyondcorp_app_connector
...
export class BeyondcorpAppConnector extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BeyondcorpAppConnector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/beyondcorp_app_connector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/beyondcorp_app_connector google_beyondcorp_app_connector} Resource
  *
  * @param scope The scope in which to define this construct
