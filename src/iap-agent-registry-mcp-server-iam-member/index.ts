...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/iap_agent_registry_mcp_server_iam_member
...
export interface IapAgentRegistryMcpServerIamMemberConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: IapAgentRegistryMcpServerIamMemberCondition;
}
export interface IapAgentRegistryMcpServerIamMemberCondition {
  /**
...
export function iapAgentRegistryMcpServerIamMemberConditionToTerraform(struct?: IapAgentRegistryMcpServerIamMemberConditionOutputReference | IapAgentRegistryMcpServerIamMemberCondition): any {
...
export function iapAgentRegistryMcpServerIamMemberConditionToHclTerraform(struct?: IapAgentRegistryMcpServerIamMemberConditionOutputReference | IapAgentRegistryMcpServerIamMemberCondition): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class IapAgentRegistryMcpServerIamMemberConditionOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): IapAgentRegistryMcpServerIamMemberCondition | undefined {
  ...
  public set internalValue(value: IapAgentRegistryMcpServerIamMemberCondition | undefined) {
    if (value === undefined) {
...
*/
export class IapAgentRegistryMcpServerIamMember extends cdktn.TerraformResource {

  // =================
  // STATIC PROPERTIES
  // =================
  public static readonly tfResourceType = "google_iap_agent_registry_mcp_server_iam_member";
  ...
  * @param importToId The construct id used in the generated config for the IapAgentRegistryMcpServerIamMember to import
  * @param importFromId The id of the existing IapAgentRegistryMcpServerIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/iap_agent_registry_mcp_server_iam_member#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the IapAgentRegistryMcpServerIamMember to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_iap_agent_registry_mcp_server_iam_member", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/iap_agent_registry_mcp_server_iam_member google_iap_agent_registry_mcp_server_iam_member} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options IapAgentRegistryMcpServerIamMemberConfig
  */
  public constructor(scope: Construct, id: string, config: IapAgentRegistryMcpServerIamMemberConfig) {
    super(scope, id, {
      terraformResourceType: 'google_iap_agent_registry_mcp_server_iam_member',
  ...
  private _condition = new IapAgentRegistryMcpServerIamMemberConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: IapAgentRegistryMcpServerIamMemberCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: iapAgentRegistryMcpServerIamMemberConditionToTerraform(this._condition.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      condition: {
        value: iapAgentRegistryMcpServerIamMemberConditionToHclTerraform(this._condition.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "IapAgentRegistryMcpServerIamMemberConditionList",
      },
    };
