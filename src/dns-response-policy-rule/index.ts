...
// https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dns_response_policy_rule
...
export class DnsResponsePolicyRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DnsResponsePolicyRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dns_response_policy_rule#import import section} in the documentation of this resource for the id to use
