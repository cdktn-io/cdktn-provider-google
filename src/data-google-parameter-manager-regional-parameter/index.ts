...
// https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/data-sources/parameter_manager_regional_parameter
...
export class DataGoogleParameterManagerRegionalParameter extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleParameterManagerRegionalParameter that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/data-sources/parameter_manager_regional_parameter#import import section} in the documentation of this resource for the id to use
