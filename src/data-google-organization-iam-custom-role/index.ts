...
// https://registry.terraform.io/providers/hashicorp/google/7.39.0/docs/data-sources/organization_iam_custom_role
...
export class DataGoogleOrganizationIamCustomRole extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleOrganizationIamCustomRole that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.39.0/docs/data-sources/organization_iam_custom_role#import import section} in the documentation of this resource for the id to use
