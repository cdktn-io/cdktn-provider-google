...
// https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/bigtable_authorized_view
...
export class BigtableAuthorizedView extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BigtableAuthorizedView that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/bigtable_authorized_view#import import section} in the documentation of this resource for the id to use
