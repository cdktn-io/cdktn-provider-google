...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/gke_hub_membership
...
export class DataGoogleGkeHubMembership extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleGkeHubMembership that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/gke_hub_membership#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/gke_hub_membership google_gke_hub_membership} Data Source
  *
  * @param scope The scope in which to define this construct
