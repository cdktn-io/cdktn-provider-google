...
// https://registry.terraform.io/providers/hashicorp/google/7.35.0/docs/data-sources/vmwareengine_network_policy
...
export interface DataGoogleVmwareengineNetworkPolicyConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataGoogleVmwareengineNetworkPolicyExternalIpOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleVmwareengineNetworkPolicyExternalIpList extends cdktn.ComplexList {
...
export class DataGoogleVmwareengineNetworkPolicyInternetAccessOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleVmwareengineNetworkPolicyInternetAccessList extends cdktn.ComplexList {
...
*/
export class DataGoogleVmwareengineNetworkPolicy extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleVmwareengineNetworkPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.35.0/docs/data-sources/vmwareengine_network_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.35.0/docs/data-sources/vmwareengine_network_policy google_vmwareengine_network_policy} Data Source
  *
  * @param scope The scope in which to define this construct
