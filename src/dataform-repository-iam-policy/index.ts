...
// https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/dataform_repository_iam_policy
...
export interface DataformRepositoryIamPolicyConfig extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataformRepositoryIamPolicy extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the DataformRepositoryIamPolicy to import
  * @param importFromId The id of the existing DataformRepositoryIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/dataform_repository_iam_policy#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataformRepositoryIamPolicy to import is found
  */
  ...
  * @param options DataformRepositoryIamPolicyConfig
  */
  public constructor(scope: Construct, id: string, config: DataformRepositoryIamPolicyConfig) {
    super(scope, id, {
