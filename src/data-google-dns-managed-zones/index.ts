...
// https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/data-sources/dns_managed_zones
...
export class DataGoogleDnsManagedZones extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleDnsManagedZones that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/data-sources/dns_managed_zones#import import section} in the documentation of this resource for the id to use
