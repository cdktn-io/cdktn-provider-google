...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/agent_registry_service
...
export class AgentRegistryService extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AgentRegistryService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/agent_registry_service#import import section} in the documentation of this resource for the id to use
