...
// https://registry.terraform.io/providers/hashicorp/google/7.35.0/docs/resources/network_connectivity_transport
...
export class NetworkConnectivityTransport extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NetworkConnectivityTransport that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.35.0/docs/resources/network_connectivity_transport#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.35.0/docs/resources/network_connectivity_transport google_network_connectivity_transport} Resource
  *
  * @param scope The scope in which to define this construct
