...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/logging_organization_sink
...
export class LoggingOrganizationSink extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LoggingOrganizationSink that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/logging_organization_sink#import import section} in the documentation of this resource for the id to use
