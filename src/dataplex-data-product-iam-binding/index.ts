...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dataplex_data_product_iam_binding
...
export interface DataplexDataProductIamBindingConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly condition?: DataplexDataProductIamBindingCondition;
}
export interface DataplexDataProductIamBindingCondition {
  /**
...
export function dataplexDataProductIamBindingConditionToTerraform(struct?: DataplexDataProductIamBindingConditionOutputReference | DataplexDataProductIamBindingCondition): any {
...
export function dataplexDataProductIamBindingConditionToHclTerraform(struct?: DataplexDataProductIamBindingConditionOutputReference | DataplexDataProductIamBindingCondition): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataplexDataProductIamBindingConditionOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataplexDataProductIamBindingCondition | undefined {
  ...
  public set internalValue(value: DataplexDataProductIamBindingCondition | undefined) {
    if (value === undefined) {
...
*/
export class DataplexDataProductIamBinding extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the DataplexDataProductIamBinding to import
  * @param importFromId The id of the existing DataplexDataProductIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dataplex_data_product_iam_binding#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the DataplexDataProductIamBinding to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dataplex_data_product_iam_binding google_dataplex_data_product_iam_binding} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options DataplexDataProductIamBindingConfig
  */
  public constructor(scope: Construct, id: string, config: DataplexDataProductIamBindingConfig) {
    super(scope, id, {
  ...
  private _condition = new DataplexDataProductIamBindingConditionOutputReference(this, "condition");
  public get condition() {
    return this._condition;
  }
  public putCondition(value: DataplexDataProductIamBindingCondition) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      condition: dataplexDataProductIamBindingConditionToTerraform(this._condition.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      condition: {
        value: dataplexDataProductIamBindingConditionToHclTerraform(this._condition.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "DataplexDataProductIamBindingConditionList",
      },
    };
