...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/spanner_database
...
export interface DataGoogleSpannerDatabaseConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataGoogleSpannerDatabaseEncryptionConfigOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleSpannerDatabaseEncryptionConfigList extends cdktn.ComplexList {
...
*/
export class DataGoogleSpannerDatabase extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleSpannerDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/spanner_database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/spanner_database google_spanner_database} Data Source
  *
  * @param scope The scope in which to define this construct
