...
// https://registry.terraform.io/providers/hashicorp/google/7.35.0/docs/resources/firebase_app_check_service_config
...
export interface FirebaseAppCheckServiceConfigConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function firebaseAppCheckServiceConfigTimeoutsToTerraform(struct?: FirebaseAppCheckServiceConfigTimeouts | cdktn.IResolvable): any {
...
export function firebaseAppCheckServiceConfigTimeoutsToHclTerraform(struct?: FirebaseAppCheckServiceConfigTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class FirebaseAppCheckServiceConfigTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): FirebaseAppCheckServiceConfigTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: FirebaseAppCheckServiceConfigTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class FirebaseAppCheckServiceConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FirebaseAppCheckServiceConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.35.0/docs/resources/firebase_app_check_service_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.35.0/docs/resources/firebase_app_check_service_config google_firebase_app_check_service_config} Resource
  *
  * @param scope The scope in which to define this construct
