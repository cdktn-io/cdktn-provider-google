...
// https://registry.terraform.io/providers/hashicorp/google/7.35.0/docs/data-sources/organization_iam_custom_roles
...
export class DataGoogleOrganizationIamCustomRoles extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleOrganizationIamCustomRoles that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.35.0/docs/data-sources/organization_iam_custom_roles#import import section} in the documentation of this resource for the id to use
