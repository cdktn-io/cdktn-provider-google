...
// https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/resources/contact_center_insights_view
...
export class ContactCenterInsightsView extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ContactCenterInsightsView that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/resources/contact_center_insights_view#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/resources/contact_center_insights_view google_contact_center_insights_view} Resource
  *
  * @param scope The scope in which to define this construct
