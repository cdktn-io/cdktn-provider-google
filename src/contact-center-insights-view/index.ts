...
// https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/contact_center_insights_view
...
export interface ContactCenterInsightsViewConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function contactCenterInsightsViewTimeoutsToTerraform(struct?: ContactCenterInsightsViewTimeouts | cdktf.IResolvable): any {
...
export function contactCenterInsightsViewTimeoutsToHclTerraform(struct?: ContactCenterInsightsViewTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ContactCenterInsightsViewTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ContactCenterInsightsViewTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: ContactCenterInsightsViewTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class ContactCenterInsightsView extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing ContactCenterInsightsView that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/contact_center_insights_view#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_contact_center_insights_view", importId: importFromId, provider });
      }
