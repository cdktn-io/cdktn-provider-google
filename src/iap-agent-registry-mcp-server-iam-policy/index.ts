...
// https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/iap_agent_registry_mcp_server_iam_policy
...
export class IapAgentRegistryMcpServerIamPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IapAgentRegistryMcpServerIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/iap_agent_registry_mcp_server_iam_policy#import import section} in the documentation of this resource for the id to use
