...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/compute_snapshot
...
export class DataGoogleComputeSnapshotSnapshotEncryptionKeyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleComputeSnapshotSnapshotEncryptionKeyList extends cdktn.ComplexList {
...
export class DataGoogleComputeSnapshotSourceDiskEncryptionKeyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleComputeSnapshotSourceDiskEncryptionKeyList extends cdktn.ComplexList {
...
export class DataGoogleComputeSnapshot extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/compute_snapshot#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/compute_snapshot google_compute_snapshot} Data Source
  *
  * @param scope The scope in which to define this construct
