...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/service_directory_namespace
...
export interface ServiceDirectoryNamespaceConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: ServiceDirectoryNamespaceTimeouts;
}
export interface ServiceDirectoryNamespaceTimeouts {
  /**
...
export function serviceDirectoryNamespaceTimeoutsToTerraform(struct?: ServiceDirectoryNamespaceTimeouts | cdktn.IResolvable): any {
...
export function serviceDirectoryNamespaceTimeoutsToHclTerraform(struct?: ServiceDirectoryNamespaceTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ServiceDirectoryNamespaceTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ServiceDirectoryNamespaceTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ServiceDirectoryNamespaceTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class ServiceDirectoryNamespace extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the ServiceDirectoryNamespace to import
  * @param importFromId The id of the existing ServiceDirectoryNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/service_directory_namespace#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ServiceDirectoryNamespace to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/service_directory_namespace google_service_directory_namespace} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ServiceDirectoryNamespaceConfig
  */
  public constructor(scope: Construct, id: string, config: ServiceDirectoryNamespaceConfig) {
    super(scope, id, {
  ...
  private _timeouts = new ServiceDirectoryNamespaceTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: ServiceDirectoryNamespaceTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: serviceDirectoryNamespaceTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: serviceDirectoryNamespaceTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ServiceDirectoryNamespaceTimeouts",
      },
    };
