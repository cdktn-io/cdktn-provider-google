...
// https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/service_directory_namespace
...
export class ServiceDirectoryNamespace extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceDirectoryNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/resources/service_directory_namespace#import import section} in the documentation of this resource for the id to use
