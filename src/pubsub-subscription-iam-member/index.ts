...
// https://registry.terraform.io/providers/hashicorp/google/7.35.0/docs/resources/pubsub_subscription_iam_member
...
export class PubsubSubscriptionIamMember extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PubsubSubscriptionIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.35.0/docs/resources/pubsub_subscription_iam_member#import import section} in the documentation of this resource for the id to use
