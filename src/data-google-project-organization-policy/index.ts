...
// https://registry.terraform.io/providers/hashicorp/google/7.33.0/docs/data-sources/project_organization_policy
...
export class DataGoogleProjectOrganizationPolicy extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleProjectOrganizationPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.33.0/docs/data-sources/project_organization_policy#import import section} in the documentation of this resource for the id to use
