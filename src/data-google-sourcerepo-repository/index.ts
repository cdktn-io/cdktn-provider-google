...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/sourcerepo_repository
...
export interface DataGoogleSourcerepoRepositoryConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataGoogleSourcerepoRepositoryPubsubConfigsOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleSourcerepoRepositoryPubsubConfigsList extends cdktn.ComplexList {
...
*/
export class DataGoogleSourcerepoRepository extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleSourcerepoRepository that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/sourcerepo_repository#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/sourcerepo_repository google_sourcerepo_repository} Data Source
  *
  * @param scope The scope in which to define this construct
