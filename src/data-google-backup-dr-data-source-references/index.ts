...
// https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/data-sources/backup_dr_data_source_references
...
export class DataGoogleBackupDrDataSourceReferences extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleBackupDrDataSourceReferences that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/data-sources/backup_dr_data_source_references#import import section} in the documentation of this resource for the id to use
