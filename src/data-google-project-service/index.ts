...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/data-sources/project_service
...
export class DataGoogleProjectService extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleProjectService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/data-sources/project_service#import import section} in the documentation of this resource for the id to use
