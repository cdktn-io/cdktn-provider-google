...
// https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/beyondcorp_application_iam_member
...
export interface BeyondcorpApplicationIamMemberConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class BeyondcorpApplicationIamMemberConditionOutputReference extends cdktn.ComplexObject {
...
*/
export class BeyondcorpApplicationIamMember extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BeyondcorpApplicationIamMember that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/beyondcorp_application_iam_member#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_beyondcorp_application_iam_member", importId: importFromId, provider });
      }
