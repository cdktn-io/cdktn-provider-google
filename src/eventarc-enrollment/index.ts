...
// https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/eventarc_enrollment
...
export interface EventarcEnrollmentConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function eventarcEnrollmentTimeoutsToTerraform(struct?: EventarcEnrollmentTimeouts | cdktn.IResolvable): any {
...
export function eventarcEnrollmentTimeoutsToHclTerraform(struct?: EventarcEnrollmentTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class EventarcEnrollmentTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): EventarcEnrollmentTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: EventarcEnrollmentTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class EventarcEnrollment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EventarcEnrollment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/eventarc_enrollment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/resources/eventarc_enrollment google_eventarc_enrollment} Resource
  *
  * @param scope The scope in which to define this construct
