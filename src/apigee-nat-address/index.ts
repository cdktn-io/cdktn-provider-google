...
// https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/resources/apigee_nat_address
...
export class ApigeeNatAddress extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigeeNatAddress that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/resources/apigee_nat_address#import import section} in the documentation of this resource for the id to use
