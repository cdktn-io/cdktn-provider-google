...
// https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/privateca_ca_pool
...
export class PrivatecaCaPool extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivatecaCaPool that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/privateca_ca_pool#import import section} in the documentation of this resource for the id to use
