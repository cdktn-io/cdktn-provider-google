...
// https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/monitoring_monitored_project
...
export class MonitoringMonitoredProject extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitoringMonitoredProject that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/monitoring_monitored_project#import import section} in the documentation of this resource for the id to use
