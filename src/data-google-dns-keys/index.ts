...
// https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/data-sources/dns_keys
...
export class DataGoogleDnsKeys extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleDnsKeys that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/data-sources/dns_keys#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/data-sources/dns_keys google_dns_keys} Data Source
  *
  * @param scope The scope in which to define this construct
