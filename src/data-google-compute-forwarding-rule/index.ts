...
// https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/data-sources/compute_forwarding_rule
...
export class DataGoogleComputeForwardingRule extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeForwardingRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/data-sources/compute_forwarding_rule#import import section} in the documentation of this resource for the id to use
