...
// https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/resources/netapp_host_group
...
export class NetappHostGroup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NetappHostGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/resources/netapp_host_group#import import section} in the documentation of this resource for the id to use
