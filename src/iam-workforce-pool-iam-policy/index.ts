...
// https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/resources/iam_workforce_pool_iam_policy
...
export class IamWorkforcePoolIamPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IamWorkforcePoolIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/resources/iam_workforce_pool_iam_policy#import import section} in the documentation of this resource for the id to use
