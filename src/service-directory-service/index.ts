...
// https://registry.terraform.io/providers/hashicorp/google/7.35.0/docs/resources/service_directory_service
...
export interface ServiceDirectoryServiceConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: ServiceDirectoryServiceTimeouts;
}
export interface ServiceDirectoryServiceTimeouts {
  /**
...
export function serviceDirectoryServiceTimeoutsToTerraform(struct?: ServiceDirectoryServiceTimeouts | cdktn.IResolvable): any {
...
export function serviceDirectoryServiceTimeoutsToHclTerraform(struct?: ServiceDirectoryServiceTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class ServiceDirectoryServiceTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ServiceDirectoryServiceTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ServiceDirectoryServiceTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class ServiceDirectoryService extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the ServiceDirectoryService to import
  * @param importFromId The id of the existing ServiceDirectoryService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.35.0/docs/resources/service_directory_service#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ServiceDirectoryService to import is found
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.35.0/docs/resources/service_directory_service google_service_directory_service} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options ServiceDirectoryServiceConfig
  */
  public constructor(scope: Construct, id: string, config: ServiceDirectoryServiceConfig) {
    super(scope, id, {
  ...
  private _timeouts = new ServiceDirectoryServiceTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: ServiceDirectoryServiceTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: serviceDirectoryServiceTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: serviceDirectoryServiceTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "ServiceDirectoryServiceTimeouts",
      },
    };
