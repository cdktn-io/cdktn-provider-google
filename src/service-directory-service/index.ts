...
// https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/service_directory_service
...
export class ServiceDirectoryService extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ServiceDirectoryService that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/service_directory_service#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/service_directory_service google_service_directory_service} Resource
  *
  * @param scope The scope in which to define this construct
