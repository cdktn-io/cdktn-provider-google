...
// https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/clouddeploy_automation
...
export class ClouddeployAutomation extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ClouddeployAutomation that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/clouddeploy_automation#import import section} in the documentation of this resource for the id to use
