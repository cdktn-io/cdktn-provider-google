...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/sql_user
...
export class SqlUser extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SqlUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/sql_user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/sql_user google_sql_user} Resource
  *
  * @param scope The scope in which to define this construct
