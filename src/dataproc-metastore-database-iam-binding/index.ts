...
// https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/dataproc_metastore_database_iam_binding
...
export interface DataprocMetastoreDatabaseIamBindingConfig extends cdktf.TerraformMetaArguments {
  /**
...
export class DataprocMetastoreDatabaseIamBindingConditionOutputReference extends cdktf.ComplexObject {
...
*/
export class DataprocMetastoreDatabaseIamBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing DataprocMetastoreDatabaseIamBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/dataproc_metastore_database_iam_binding#import import section} in the documentation of this resource for the id to use
