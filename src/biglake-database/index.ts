...
// https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/biglake_database
...
export class BiglakeDatabase extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BiglakeDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/biglake_database#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/biglake_database google_biglake_database} Resource
  *
  * @param scope The scope in which to define this construct
