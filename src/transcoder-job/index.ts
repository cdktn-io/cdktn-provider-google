...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/transcoder_job
...
export class TranscoderJob extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing TranscoderJob that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/transcoder_job#import import section} in the documentation of this resource for the id to use
