...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config
...
export interface IntegrationsAuthConfigConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#deletion_policy IntegrationsAuthConfig#deletion_policy}
  */
  readonly deletionPolicy?: string;
  /**
  * A description of the auth config.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#description IntegrationsAuthConfig#description}
  */
  readonly description?: string;
  /**
  * The name of the auth config.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#display_name IntegrationsAuthConfig#display_name}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#expiry_notification_duration IntegrationsAuthConfig#expiry_notification_duration}
  */
  readonly expiryNotificationDuration?: string[];
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#id IntegrationsAuthConfig#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#location IntegrationsAuthConfig#location}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#override_valid_time IntegrationsAuthConfig#override_valid_time}
  */
  readonly overrideValidTime?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#project IntegrationsAuthConfig#project}
  */
  readonly project?: string;
  /**
  * The visibility of the auth config. Possible values: ["PRIVATE", "CLIENT_VISIBLE"]
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#visibility IntegrationsAuthConfig#visibility}
  */
  readonly visibility?: string;
  /**
  * client_certificate block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#client_certificate IntegrationsAuthConfig#client_certificate}
  */
  readonly clientCertificate?: IntegrationsAuthConfigClientCertificate;
  /**
  * decrypted_credential block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#decrypted_credential IntegrationsAuthConfig#decrypted_credential}
  */
  readonly decryptedCredential?: IntegrationsAuthConfigDecryptedCredential;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#timeouts IntegrationsAuthConfig#timeouts}
  */
...
export interface IntegrationsAuthConfigClientCertificate {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#encrypted_private_key IntegrationsAuthConfig#encrypted_private_key}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#passphrase IntegrationsAuthConfig#passphrase}
  */
  readonly passphrase?: string;
  /**
  * The ssl certificate encoded in PEM format. This string must include the begin header and end footer lines.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#ssl_certificate IntegrationsAuthConfig#ssl_certificate}
  */
...
export function integrationsAuthConfigClientCertificateToHclTerraform(struct?: IntegrationsAuthConfigClientCertificateOutputReference | IntegrationsAuthConfigClientCertificate): any {
  ...
  const attrs = {
    encrypted_private_key: {
      value: cdktn.stringToHclTerraform(struct!.encryptedPrivateKey),
      isBlock: false,
      type: "simple",
...
export class IntegrationsAuthConfigClientCertificateOutputReference extends cdktn.ComplexObject {
...
export interface IntegrationsAuthConfigDecryptedCredentialAuthToken {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#token IntegrationsAuthConfig#token}
  */
  readonly token?: string;
  /**
  * Authentication type, e.g. "Basic", "Bearer", etc.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#type IntegrationsAuthConfig#type}
  */
...
export class IntegrationsAuthConfigDecryptedCredentialAuthTokenOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface IntegrationsAuthConfigDecryptedCredentialJwt {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#jwt_header IntegrationsAuthConfig#jwt_header}
  */
  readonly jwtHeader?: string;
  /**
  * Contains a set of claims. The JWT specification defines seven Registered Claim Names which are the standard fields commonly included in tokens. Custom claims are usually also included, depending on the purpose of the token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#jwt_payload IntegrationsAuthConfig#jwt_payload}
  */
  readonly jwtPayload?: string;
  /**
  * User's pre-shared secret to sign the token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#secret IntegrationsAuthConfig#secret}
  */
...
export function integrationsAuthConfigDecryptedCredentialJwtToTerraform(struct?: IntegrationsAuthConfigDecryptedCredentialJwtOutputReference | IntegrationsAuthConfigDecryptedCredentialJwt): any {
  ...
  return {
    ...
    jwt_payload: cdktn.stringToTerraform(struct!.jwtPayload),
...
export function integrationsAuthConfigDecryptedCredentialJwtToHclTerraform(struct?: IntegrationsAuthConfigDecryptedCredentialJwtOutputReference | IntegrationsAuthConfigDecryptedCredentialJwt): any {
  ...
  const attrs = {
    jwt_header: {
      value: cdktn.stringToHclTerraform(struct!.jwtHeader),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
    jwt_payload: {
      value: cdktn.stringToHclTerraform(struct!.jwtPayload),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class IntegrationsAuthConfigDecryptedCredentialJwtOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface IntegrationsAuthConfigDecryptedCredentialOauth2AuthorizationCode {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#auth_endpoint IntegrationsAuthConfig#auth_endpoint}
  */
  readonly authEndpoint?: string;
  /**
  * The client's id.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#client_id IntegrationsAuthConfig#client_id}
  */
  readonly clientId?: string;
  /**
  * The client's secret.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#client_secret IntegrationsAuthConfig#client_secret}
  */
  readonly clientSecret?: string;
  /**
  * A space-delimited list of requested scope permissions.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#scope IntegrationsAuthConfig#scope}
  */
  readonly scope?: string;
  /**
  * The token url endpoint to send the token request to.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#token_endpoint IntegrationsAuthConfig#token_endpoint}
  */
...
export class IntegrationsAuthConfigDecryptedCredentialOauth2AuthorizationCodeOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParamsEntriesKeyLiteralValue {
  ...
  * String.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#string_value IntegrationsAuthConfig#string_value}
  */
...
export class IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParamsEntriesKeyLiteralValueOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParamsEntriesKey {
  ...
  * literal_value block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#literal_value IntegrationsAuthConfig#literal_value}
  */
...
export class IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParamsEntriesKeyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParamsEntriesValueLiteralValueOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParamsEntriesValueOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParamsEntries {
  ...
  * key block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#key IntegrationsAuthConfig#key}
  */
  readonly key?: IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParamsEntriesKey;
  /**
  * value block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#value IntegrationsAuthConfig#value}
  */
...
export class IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParamsEntriesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParamsEntries | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParamsEntries | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParamsEntriesList extends cdktn.ComplexList {
  public internalValue? : IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParamsEntries[] | cdktn.IResolvable
...
export interface IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParams {
  ...
  * entries block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#entries IntegrationsAuthConfig#entries}
  */
...
export function integrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParamsToHclTerraform(struct?: IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParamsOutputReference | IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParams): any {
  ...
  const attrs = {
    entries: {
      value: cdktn.listMapperHcl(integrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParamsEntriesToHclTerraform, true)(struct!.entries),
      isBlock: true,
      type: "list",
...
export class IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParamsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public putEntries(value: IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsTokenParamsEntries[] | cdktn.IResolvable) {
...
export interface IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#request_type IntegrationsAuthConfig#request_type}
  */
  ...
  * token_params block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#token_params IntegrationsAuthConfig#token_params}
  */
...
export class IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentialsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface IntegrationsAuthConfigDecryptedCredentialOidcToken {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#audience IntegrationsAuthConfig#audience}
  */
  readonly audience?: string;
  /**
  * The service account email to be used as the identity for the token.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#service_account_email IntegrationsAuthConfig#service_account_email}
  */
...
export class IntegrationsAuthConfigDecryptedCredentialOidcTokenOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface IntegrationsAuthConfigDecryptedCredentialServiceAccountCredentials {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#service_account IntegrationsAuthConfig#service_account}
  */
...
export class IntegrationsAuthConfigDecryptedCredentialServiceAccountCredentialsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface IntegrationsAuthConfigDecryptedCredentialUsernameAndPassword {
  ...
  * Password to be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#password IntegrationsAuthConfig#password}
  */
  readonly password?: string;
  /**
  * Username to be used.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#username IntegrationsAuthConfig#username}
  */
...
export class IntegrationsAuthConfigDecryptedCredentialUsernameAndPasswordOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface IntegrationsAuthConfigDecryptedCredential {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#credential_type IntegrationsAuthConfig#credential_type}
  */
  readonly credentialType: string;
  /**
  * auth_token block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#auth_token IntegrationsAuthConfig#auth_token}
  */
  readonly authToken?: IntegrationsAuthConfigDecryptedCredentialAuthToken;
  /**
  * jwt block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#jwt IntegrationsAuthConfig#jwt}
  */
  readonly jwt?: IntegrationsAuthConfigDecryptedCredentialJwt;
  /**
  * oauth2_authorization_code block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#oauth2_authorization_code IntegrationsAuthConfig#oauth2_authorization_code}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#oauth2_client_credentials IntegrationsAuthConfig#oauth2_client_credentials}
  */
  readonly oauth2ClientCredentials?: IntegrationsAuthConfigDecryptedCredentialOauth2ClientCredentials;
  /**
  * oidc_token block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#oidc_token IntegrationsAuthConfig#oidc_token}
  */
  readonly oidcToken?: IntegrationsAuthConfigDecryptedCredentialOidcToken;
  /**
  * service_account_credentials block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#service_account_credentials IntegrationsAuthConfig#service_account_credentials}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#username_and_password IntegrationsAuthConfig#username_and_password}
  */
...
export class IntegrationsAuthConfigDecryptedCredentialOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface IntegrationsAuthConfigTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#create IntegrationsAuthConfig#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#delete IntegrationsAuthConfig#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#update IntegrationsAuthConfig#update}
  */
...
export class IntegrationsAuthConfigTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  private resolvableValue?: cdktn.IResolvable;
  ...
  */
  ...
  public get internalValue(): IntegrationsAuthConfigTimeouts | cdktn.IResolvable | undefined {
    if (this.resolvableValue) {
      return this.resolvableValue;
    }
    let hasAnyValues = this.isEmptyObject;
  ...
  public set internalValue(value: IntegrationsAuthConfigTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this.resolvableValue = undefined;
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config google_integrations_auth_config}
*/
export class IntegrationsAuthConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IntegrationsAuthConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_integrations_auth_config", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/integrations_auth_config google_integrations_auth_config} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      expiry_notification_duration: cdktn.listMapper(cdktn.stringToTerraform, false)(this._expiryNotificationDuration),
      id: cdktn.stringToTerraform(this._id),
      location: cdktn.stringToTerraform(this._location),
      override_valid_time: cdktn.stringToTerraform(this._overrideValidTime),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      expiry_notification_duration: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._expiryNotificationDuration),
        isBlock: false,
        type: "list",
      ...
      override_valid_time: {
        value: cdktn.stringToHclTerraform(this._overrideValidTime),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
