...
export function gkeBackupRestoreChannelTimeoutsToTerraform(struct?: GkeBackupRestoreChannelTimeouts | cdktf.IResolvable): any {
...
export function gkeBackupRestoreChannelTimeoutsToHclTerraform(struct?: GkeBackupRestoreChannelTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GkeBackupRestoreChannelTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GkeBackupRestoreChannelTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GkeBackupRestoreChannelTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
export class GkeBackupRestoreChannel extends cdktf.TerraformResource {
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktf.TerraformProvider) {
        return new cdktf.ImportableResource(scope, importToId, { terraformResourceType: "google_gke_backup_restore_channel", importId: importFromId, provider });
      }
