...
// https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/dataplex_task
...
export class DataplexTask extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DataplexTask that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/dataplex_task#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/dataplex_task google_dataplex_task} Resource
  *
  * @param scope The scope in which to define this construct
