...
// https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/resources/apihub_curation
...
export class ApihubCuration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApihubCuration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/resources/apihub_curation#import import section} in the documentation of this resource for the id to use
