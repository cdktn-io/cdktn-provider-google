...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apihub_curation
...
export interface ApihubCurationConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  * are /a-z[0-9]-_/.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apihub_curation#curation_id ApihubCuration#curation_id}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apihub_curation#deletion_policy ApihubCuration#deletion_policy}
  */
  readonly deletionPolicy?: string;
  /**
  * The description of the curation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apihub_curation#description ApihubCuration#description}
  */
  readonly description?: string;
  /**
  * The display name of the curation.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apihub_curation#display_name ApihubCuration#display_name}
  */
  readonly displayName: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apihub_curation#id ApihubCuration#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apihub_curation#location ApihubCuration#location}
  */
  readonly location: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apihub_curation#project ApihubCuration#project}
  */
  readonly project?: string;
  /**
  * endpoint block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apihub_curation#endpoint ApihubCuration#endpoint}
  */
  readonly endpoint: ApihubCurationEndpoint;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apihub_curation#timeouts ApihubCuration#timeouts}
  */
...
export class ApihubCurationPluginInstanceActionsOutputReference extends cdktn.ComplexObject {
...
export class ApihubCurationPluginInstanceActionsList extends cdktn.ComplexList {
...
export function apihubCurationEndpointApplicationIntegrationEndpointDetailsToTerraform(struct?: ApihubCurationEndpointApplicationIntegrationEndpointDetailsOutputReference | ApihubCurationEndpointApplicationIntegrationEndpointDetails): any {
  ...
  return {
    trigger_id: cdktn.stringToTerraform(struct!.triggerId),
...
export function apihubCurationEndpointApplicationIntegrationEndpointDetailsToHclTerraform(struct?: ApihubCurationEndpointApplicationIntegrationEndpointDetailsOutputReference | ApihubCurationEndpointApplicationIntegrationEndpointDetails): any {
  ...
  const attrs = {
    trigger_id: {
      value: cdktn.stringToHclTerraform(struct!.triggerId),
      isBlock: false,
      type: "simple",
...
export class ApihubCurationEndpointApplicationIntegrationEndpointDetailsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface ApihubCurationEndpoint {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apihub_curation#application_integration_endpoint_details ApihubCuration#application_integration_endpoint_details}
  */
...
export class ApihubCurationEndpointOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export interface ApihubCurationTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apihub_curation#create ApihubCuration#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apihub_curation#delete ApihubCuration#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apihub_curation#update ApihubCuration#update}
  */
  readonly update?: string;
}

export function apihubCurationTimeoutsToTerraform(struct?: ApihubCurationTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function apihubCurationTimeoutsToHclTerraform(struct?: ApihubCurationTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ApihubCurationTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ApihubCurationTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ApihubCurationTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class ApihubCuration extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApihubCuration that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apihub_curation#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ApihubCuration to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_apihub_curation", importId: importFromId, provider });
      }
