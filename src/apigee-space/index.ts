...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apigee_space
...
export class ApigeeSpace extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigeeSpace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apigee_space#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/apigee_space google_apigee_space} Resource
  *
  * @param scope The scope in which to define this construct
