...
// https://registry.terraform.io/providers/hashicorp/google/7.39.0/docs/resources/colab_notebook_execution
...
export class ColabNotebookExecution extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ColabNotebookExecution that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.39.0/docs/resources/colab_notebook_execution#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.39.0/docs/resources/colab_notebook_execution google_colab_notebook_execution} Resource
  *
  * @param scope The scope in which to define this construct
