...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/compute_subnetwork
...
export interface DataGoogleComputeSubnetworkConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataGoogleComputeSubnetworkSecondaryIpRangeOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleComputeSubnetworkSecondaryIpRangeList extends cdktn.ComplexList {
...
*/
export class DataGoogleComputeSubnetwork extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeSubnetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/compute_subnetwork#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/compute_subnetwork google_compute_subnetwork} Data Source
  *
  * @param scope The scope in which to define this construct
