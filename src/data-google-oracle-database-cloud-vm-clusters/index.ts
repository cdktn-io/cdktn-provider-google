...
// https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/data-sources/oracle_database_cloud_vm_clusters
...
export class DataGoogleOracleDatabaseCloudVmClusters extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleOracleDatabaseCloudVmClusters that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.44.0/docs/data-sources/oracle_database_cloud_vm_clusters#import import section} in the documentation of this resource for the id to use
