...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/oracle_database_cloud_vm_clusters
...
export interface DataGoogleOracleDatabaseCloudVmClustersConfig extends cdktn.TerraformMetaArguments {
  /**
...
export interface DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersIdentityConnector {
}

export function dataGoogleOracleDatabaseCloudVmClustersCloudVmClustersIdentityConnectorToTerraform(struct?: DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersIdentityConnector): any {
...
export function dataGoogleOracleDatabaseCloudVmClustersCloudVmClustersIdentityConnectorToHclTerraform(struct?: DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersIdentityConnector): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersIdentityConnectorOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersIdentityConnector | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    return hasAnyValues ? internalValueResult : undefined;
  }

  public set internalValue(value: DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersIdentityConnector | undefined) {
    if (value === undefined) {
...
export class DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersIdentityConnectorList extends cdktn.ComplexList {
  ...
  */
  public get(index: number): DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersIdentityConnectorOutputReference {
    return new DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersIdentityConnectorOutputReference(this.terraformResource, this.terraformAttribute, index, this.wrapsSet);
  }
}
...
export class DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersPropertiesDiagnosticsDataCollectionOptionsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersPropertiesDiagnosticsDataCollectionOptionsList extends cdktn.ComplexList {
...
export class DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersPropertiesTimeZoneOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersPropertiesTimeZoneList extends cdktn.ComplexList {
...
export class DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersPropertiesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersPropertiesList extends cdktn.ComplexList {
...
export class DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  private _identityConnector = new DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersIdentityConnectorList(this, "identity_connector", false);
...
export class DataGoogleOracleDatabaseCloudVmClustersCloudVmClustersList extends cdktn.ComplexList {
...
*/
export class DataGoogleOracleDatabaseCloudVmClusters extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleOracleDatabaseCloudVmClusters that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/oracle_database_cloud_vm_clusters#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_oracle_database_cloud_vm_clusters", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/data-sources/oracle_database_cloud_vm_clusters google_oracle_database_cloud_vm_clusters} Data Source
  *
  * @param scope The scope in which to define this construct
