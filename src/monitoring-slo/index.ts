...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/monitoring_slo
...
export class MonitoringSlo extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitoringSlo that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/monitoring_slo#import import section} in the documentation of this resource for the id to use
