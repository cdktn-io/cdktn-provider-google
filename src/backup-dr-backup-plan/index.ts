...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/backup_dr_backup_plan
...
export interface BackupDrBackupPlanConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly computeInstanceBackupPlanProperties?: BackupDrBackupPlanComputeInstanceBackupPlanProperties;
  /**
  ...
  */
  readonly diskBackupPlanProperties?: BackupDrBackupPlanDiskBackupPlanProperties;
  /**
  * timeouts block
  *
...
export interface BackupDrBackupPlanComputeInstanceBackupPlanProperties {
  /**
...
export function backupDrBackupPlanComputeInstanceBackupPlanPropertiesToTerraform(struct?: BackupDrBackupPlanComputeInstanceBackupPlanPropertiesOutputReference | BackupDrBackupPlanComputeInstanceBackupPlanProperties): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function backupDrBackupPlanComputeInstanceBackupPlanPropertiesToHclTerraform(struct?: BackupDrBackupPlanComputeInstanceBackupPlanPropertiesOutputReference | BackupDrBackupPlanComputeInstanceBackupPlanProperties): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class BackupDrBackupPlanComputeInstanceBackupPlanPropertiesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): BackupDrBackupPlanComputeInstanceBackupPlanProperties | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: BackupDrBackupPlanComputeInstanceBackupPlanProperties | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export interface BackupDrBackupPlanDiskBackupPlanProperties {
  /**
...
export function backupDrBackupPlanDiskBackupPlanPropertiesToTerraform(struct?: BackupDrBackupPlanDiskBackupPlanPropertiesOutputReference | BackupDrBackupPlanDiskBackupPlanProperties): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function backupDrBackupPlanDiskBackupPlanPropertiesToHclTerraform(struct?: BackupDrBackupPlanDiskBackupPlanPropertiesOutputReference | BackupDrBackupPlanDiskBackupPlanProperties): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class BackupDrBackupPlanDiskBackupPlanPropertiesOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): BackupDrBackupPlanDiskBackupPlanProperties | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._guestFlush !== undefined) {
      hasAnyValues = true;
  ...
  public set internalValue(value: BackupDrBackupPlanDiskBackupPlanProperties | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._guestFlush = undefined;
    }
...
export class BackupDrBackupPlan extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BackupDrBackupPlan that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/backup_dr_backup_plan#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/backup_dr_backup_plan google_backup_dr_backup_plan} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _computeInstanceBackupPlanProperties = new BackupDrBackupPlanComputeInstanceBackupPlanPropertiesOutputReference(this, "compute_instance_backup_plan_properties");
  public get computeInstanceBackupPlanProperties() {
    return this._computeInstanceBackupPlanProperties;
  }
  public putComputeInstanceBackupPlanProperties(value: BackupDrBackupPlanComputeInstanceBackupPlanProperties) {
  ...
  private _diskBackupPlanProperties = new BackupDrBackupPlanDiskBackupPlanPropertiesOutputReference(this, "disk_backup_plan_properties");
  public get diskBackupPlanProperties() {
    return this._diskBackupPlanProperties;
  }
  public putDiskBackupPlanProperties(value: BackupDrBackupPlanDiskBackupPlanProperties) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      compute_instance_backup_plan_properties: backupDrBackupPlanComputeInstanceBackupPlanPropertiesToTerraform(this._computeInstanceBackupPlanProperties.internalValue),
      disk_backup_plan_properties: backupDrBackupPlanDiskBackupPlanPropertiesToTerraform(this._diskBackupPlanProperties.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      compute_instance_backup_plan_properties: {
        value: backupDrBackupPlanComputeInstanceBackupPlanPropertiesToHclTerraform(this._computeInstanceBackupPlanProperties.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "BackupDrBackupPlanComputeInstanceBackupPlanPropertiesList",
      },
      disk_backup_plan_properties: {
        value: backupDrBackupPlanDiskBackupPlanPropertiesToHclTerraform(this._diskBackupPlanProperties.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "BackupDrBackupPlanDiskBackupPlanPropertiesList",
      },
      timeouts: {
