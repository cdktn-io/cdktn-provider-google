...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_security_settings
...
export interface DialogflowCxSecuritySettingsConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DialogflowCxSecuritySettingsAudioExportSettingsOutputReference extends cdktn.ComplexObject {
...
export class DialogflowCxSecuritySettingsInsightsExportSettingsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function dialogflowCxSecuritySettingsTimeoutsToTerraform(struct?: DialogflowCxSecuritySettingsTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dialogflowCxSecuritySettingsTimeoutsToHclTerraform(struct?: DialogflowCxSecuritySettingsTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DialogflowCxSecuritySettingsTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DialogflowCxSecuritySettingsTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DialogflowCxSecuritySettingsTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class DialogflowCxSecuritySettings extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DialogflowCxSecuritySettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_security_settings#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/dialogflow_cx_security_settings google_dialogflow_cx_security_settings} Resource
  *
  * @param scope The scope in which to define this construct
