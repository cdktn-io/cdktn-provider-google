...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/kms_crypto_key_version
...
export class KmsCryptoKeyVersion extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing KmsCryptoKeyVersion that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/kms_crypto_key_version#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/kms_crypto_key_version google_kms_crypto_key_version} Resource
  *
  * @param scope The scope in which to define this construct
