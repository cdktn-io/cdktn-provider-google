...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/apigee_env_references
...
export interface ApigeeEnvReferencesConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function apigeeEnvReferencesTimeoutsToTerraform(struct?: ApigeeEnvReferencesTimeouts | cdktn.IResolvable): any {
...
export function apigeeEnvReferencesTimeoutsToHclTerraform(struct?: ApigeeEnvReferencesTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ApigeeEnvReferencesTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ApigeeEnvReferencesTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ApigeeEnvReferencesTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class ApigeeEnvReferences extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigeeEnvReferences that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/apigee_env_references#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/apigee_env_references google_apigee_env_references} Resource
  *
  * @param scope The scope in which to define this construct
