...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/privateca_certificate_template
...
export class PrivatecaCertificateTemplate extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PrivatecaCertificateTemplate that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/privateca_certificate_template#import import section} in the documentation of this resource for the id to use
