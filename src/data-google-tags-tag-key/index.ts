...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/data-sources/tags_tag_key
...
export class DataGoogleTagsTagKey extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleTagsTagKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/data-sources/tags_tag_key#import import section} in the documentation of this resource for the id to use
