...
// https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/iap_settings
...
export class IapSettings extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing IapSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/iap_settings#import import section} in the documentation of this resource for the id to use
