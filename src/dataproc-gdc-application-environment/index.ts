...
// https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment
...
export interface DataprocGdcApplicationEnvironmentConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment#annotations DataprocGdcApplicationEnvironment#annotations}
  */
  readonly annotations?: { [key: string]: string };
  /**
  * The id of the application environment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment#application_environment_id DataprocGdcApplicationEnvironment#application_environment_id}
  */
  ...
  * 
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment#deletion_policy DataprocGdcApplicationEnvironment#deletion_policy}
  */
  readonly deletionPolicy?: string;
  /**
  * User-provided human-readable name to be used in user interfaces.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment#display_name DataprocGdcApplicationEnvironment#display_name}
  */
  readonly displayName?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment#id DataprocGdcApplicationEnvironment#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment#labels DataprocGdcApplicationEnvironment#labels}
  */
  readonly labels?: { [key: string]: string };
  /**
  * The location of the application environment
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment#location DataprocGdcApplicationEnvironment#location}
  */
  readonly location: string;
  /**
  * The name of the namespace in which to create this ApplicationEnvironment. This namespace must already exist in the cluster
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment#namespace DataprocGdcApplicationEnvironment#namespace}
  */
  readonly namespace?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment#project DataprocGdcApplicationEnvironment#project}
  */
  readonly project?: string;
  /**
  * The id of the service instance to which this application environment belongs.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment#serviceinstance DataprocGdcApplicationEnvironment#serviceinstance}
  */
  readonly serviceinstance: string;
  /**
  * spark_application_environment_config block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment#spark_application_environment_config DataprocGdcApplicationEnvironment#spark_application_environment_config}
  */
  readonly sparkApplicationEnvironmentConfig?: DataprocGdcApplicationEnvironmentSparkApplicationEnvironmentConfig;
  /**
  * timeouts block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment#timeouts DataprocGdcApplicationEnvironment#timeouts}
  */
...
export interface DataprocGdcApplicationEnvironmentSparkApplicationEnvironmentConfig {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment#default_properties DataprocGdcApplicationEnvironment#default_properties}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment#default_version DataprocGdcApplicationEnvironment#default_version}
  */
...
export function dataprocGdcApplicationEnvironmentSparkApplicationEnvironmentConfigToTerraform(struct?: DataprocGdcApplicationEnvironmentSparkApplicationEnvironmentConfigOutputReference | DataprocGdcApplicationEnvironmentSparkApplicationEnvironmentConfig): any {
  ...
  return {
    default_properties: cdktn.hashMapper(cdktn.stringToTerraform)(struct!.defaultProperties),
    default_version: cdktn.stringToTerraform(struct!.defaultVersion),
  }
}
...
export function dataprocGdcApplicationEnvironmentSparkApplicationEnvironmentConfigToHclTerraform(struct?: DataprocGdcApplicationEnvironmentSparkApplicationEnvironmentConfigOutputReference | DataprocGdcApplicationEnvironmentSparkApplicationEnvironmentConfig): any {
  ...
  const attrs = {
    default_properties: {
      value: cdktn.hashMapperHcl(cdktn.stringToHclTerraform)(struct!.defaultProperties),
      isBlock: false,
      type: "map",
      storageClassType: "stringMap",
    },
    default_version: {
      value: cdktn.stringToHclTerraform(struct!.defaultVersion),
      isBlock: false,
      type: "simple",
...
export class DataprocGdcApplicationEnvironmentSparkApplicationEnvironmentConfigOutputReference extends cdktn.ComplexObject {
...
export interface DataprocGdcApplicationEnvironmentTimeouts {
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment#create DataprocGdcApplicationEnvironment#create}
  */
  readonly create?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment#delete DataprocGdcApplicationEnvironment#delete}
  */
  readonly delete?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment#update DataprocGdcApplicationEnvironment#update}
  */
  readonly update?: string;
}

export function dataprocGdcApplicationEnvironmentTimeoutsToTerraform(struct?: DataprocGdcApplicationEnvironmentTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function dataprocGdcApplicationEnvironmentTimeoutsToHclTerraform(struct?: DataprocGdcApplicationEnvironmentTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class DataprocGdcApplicationEnvironmentTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): DataprocGdcApplicationEnvironmentTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: DataprocGdcApplicationEnvironmentTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment google_dataproc_gdc_application_environment}
*/
export class DataprocGdcApplicationEnvironment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DataprocGdcApplicationEnvironment that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_dataproc_gdc_application_environment", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/dataproc_gdc_application_environment google_dataproc_gdc_application_environment} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      application_environment_id: cdktn.stringToTerraform(this._applicationEnvironmentId),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      application_environment_id: {
        value: cdktn.stringToHclTerraform(this._applicationEnvironmentId),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
