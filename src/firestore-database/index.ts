...
// https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/firestore_database
...
export class FirestoreDatabase extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FirestoreDatabase that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/firestore_database#import import section} in the documentation of this resource for the id to use
