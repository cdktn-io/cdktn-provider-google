...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/compute_snapshot
...
export interface ComputeSnapshotConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly params?: ComputeSnapshotParams;
  /**
...
export function computeSnapshotParamsToTerraform(struct?: ComputeSnapshotParamsOutputReference | ComputeSnapshotParams): any {
...
export function computeSnapshotParamsToHclTerraform(struct?: ComputeSnapshotParamsOutputReference | ComputeSnapshotParams): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ComputeSnapshotParamsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): ComputeSnapshotParams | undefined {
  ...
  public set internalValue(value: ComputeSnapshotParams | undefined) {
    if (value === undefined) {
...
export class ComputeSnapshotSnapshotEncryptionKeyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class ComputeSnapshotSourceDiskEncryptionKeyOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export function computeSnapshotTimeoutsToTerraform(struct?: ComputeSnapshotTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function computeSnapshotTimeoutsToHclTerraform(struct?: ComputeSnapshotTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class ComputeSnapshotTimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ComputeSnapshotTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ComputeSnapshotTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
*/
export class ComputeSnapshot extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ComputeSnapshot that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/compute_snapshot#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ComputeSnapshot to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_compute_snapshot", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/compute_snapshot google_compute_snapshot} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _params = new ComputeSnapshotParamsOutputReference(this, "params");
  public get params() {
    return this._params;
  }
  public putParams(value: ComputeSnapshotParams) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      params: computeSnapshotParamsToTerraform(this._params.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      chain_name: {
        value: cdktn.stringToHclTerraform(this._chainName),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
      ...
      params: {
        value: computeSnapshotParamsToHclTerraform(this._params.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "ComputeSnapshotParamsList",
      },
