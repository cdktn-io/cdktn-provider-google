...
// https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/edgenetwork_network
...
export class EdgenetworkNetwork extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EdgenetworkNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/resources/edgenetwork_network#import import section} in the documentation of this resource for the id to use
