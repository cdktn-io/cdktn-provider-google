...
// https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/resources/migration_center_source
...
export class MigrationCenterSource extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MigrationCenterSource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/resources/migration_center_source#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/resources/migration_center_source google_migration_center_source} Resource
  *
  * @param scope The scope in which to define this construct
