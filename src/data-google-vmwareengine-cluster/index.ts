...
// https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/data-sources/vmwareengine_cluster
...
export class DataGoogleVmwareengineCluster extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleVmwareengineCluster that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/data-sources/vmwareengine_cluster#import import section} in the documentation of this resource for the id to use
