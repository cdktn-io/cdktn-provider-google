...
// https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/eventarc_trigger
...
export class EventarcTrigger extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing EventarcTrigger that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/eventarc_trigger#import import section} in the documentation of this resource for the id to use
