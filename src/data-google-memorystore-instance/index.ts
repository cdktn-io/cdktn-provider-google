...
// https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/memorystore_instance
...
export class DataGoogleMemorystoreInstance extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleMemorystoreInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/memorystore_instance#import import section} in the documentation of this resource for the id to use
