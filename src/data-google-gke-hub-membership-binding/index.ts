...
// https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/data-sources/gke_hub_membership_binding
...
export interface DataGoogleGkeHubMembershipBindingConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataGoogleGkeHubMembershipBindingStateOutputReference extends cdktn.ComplexObject {
...
export class DataGoogleGkeHubMembershipBindingStateList extends cdktn.ComplexList {
...
*/
export class DataGoogleGkeHubMembershipBinding extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleGkeHubMembershipBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/data-sources/gke_hub_membership_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/data-sources/gke_hub_membership_binding google_gke_hub_membership_binding} Data Source
  *
  * @param scope The scope in which to define this construct
