...
// https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/gemini_release_channel_setting_binding
...
export interface GeminiReleaseChannelSettingBindingConfig extends cdktf.TerraformMetaArguments {
  /**
...
export function geminiReleaseChannelSettingBindingTimeoutsToTerraform(struct?: GeminiReleaseChannelSettingBindingTimeouts | cdktf.IResolvable): any {
...
export function geminiReleaseChannelSettingBindingTimeoutsToHclTerraform(struct?: GeminiReleaseChannelSettingBindingTimeouts | cdktf.IResolvable): any {
  if (!cdktf.canInspect(struct) || cdktf.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktf.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class GeminiReleaseChannelSettingBindingTimeoutsOutputReference extends cdktf.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GeminiReleaseChannelSettingBindingTimeouts | cdktf.IResolvable | undefined {
  ...
  public set internalValue(value: GeminiReleaseChannelSettingBindingTimeouts | cdktf.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GeminiReleaseChannelSettingBinding extends cdktf.TerraformResource {
  ...
  * @param importFromId The id of the existing GeminiReleaseChannelSettingBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/6.50.0/docs/resources/gemini_release_channel_setting_binding#import import section} in the documentation of this resource for the id to use
