...
// https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/storage_insights_dataset_config
...
export class StorageInsightsDatasetConfig extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StorageInsightsDatasetConfig that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.1/docs/resources/storage_insights_dataset_config#import import section} in the documentation of this resource for the id to use
