...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/bigtable_logical_view
...
export interface BigtableLogicalViewConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function bigtableLogicalViewTimeoutsToTerraform(struct?: BigtableLogicalViewTimeouts | cdktn.IResolvable): any {
...
export function bigtableLogicalViewTimeoutsToHclTerraform(struct?: BigtableLogicalViewTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class BigtableLogicalViewTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): BigtableLogicalViewTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: BigtableLogicalViewTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class BigtableLogicalView extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BigtableLogicalView that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/bigtable_logical_view#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/bigtable_logical_view google_bigtable_logical_view} Resource
  *
  * @param scope The scope in which to define this construct
