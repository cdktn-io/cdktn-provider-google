...
// https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/resources/os_login_ssh_public_key
...
export class OsLoginSshPublicKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OsLoginSshPublicKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/resources/os_login_ssh_public_key#import import section} in the documentation of this resource for the id to use
