...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/gemini_gemini_gcp_enablement_setting_binding
...
export interface GeminiGeminiGcpEnablementSettingBindingConfig extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly timeouts?: GeminiGeminiGcpEnablementSettingBindingTimeouts;
}
export interface GeminiGeminiGcpEnablementSettingBindingTimeouts {
  /**
...
export function geminiGeminiGcpEnablementSettingBindingTimeoutsToTerraform(struct?: GeminiGeminiGcpEnablementSettingBindingTimeouts | cdktn.IResolvable): any {
...
export function geminiGeminiGcpEnablementSettingBindingTimeoutsToHclTerraform(struct?: GeminiGeminiGcpEnablementSettingBindingTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class GeminiGeminiGcpEnablementSettingBindingTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): GeminiGeminiGcpEnablementSettingBindingTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: GeminiGeminiGcpEnablementSettingBindingTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class GeminiGeminiGcpEnablementSettingBinding extends cdktn.TerraformResource {
  ...
  * @param importToId The construct id used in the generated config for the GeminiGeminiGcpEnablementSettingBinding to import
  * @param importFromId The id of the existing GeminiGeminiGcpEnablementSettingBinding that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/gemini_gemini_gcp_enablement_setting_binding#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/gemini_gemini_gcp_enablement_setting_binding google_gemini_gemini_gcp_enablement_setting_binding} Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options GeminiGeminiGcpEnablementSettingBindingConfig
  */
  public constructor(scope: Construct, id: string, config: GeminiGeminiGcpEnablementSettingBindingConfig) {
    super(scope, id, {
  ...
  private _timeouts = new GeminiGeminiGcpEnablementSettingBindingTimeoutsOutputReference(this, "timeouts");
  public get timeouts() {
    return this._timeouts;
  }
  public putTimeouts(value: GeminiGeminiGcpEnablementSettingBindingTimeouts) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      timeouts: geminiGeminiGcpEnablementSettingBindingTimeoutsToTerraform(this._timeouts.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      timeouts: {
        value: geminiGeminiGcpEnablementSettingBindingTimeoutsToHclTerraform(this._timeouts.internalValue),
        isBlock: true,
        type: "struct",
        storageClassType: "GeminiGeminiGcpEnablementSettingBindingTimeouts",
      },
    };
