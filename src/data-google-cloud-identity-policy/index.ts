...
// https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/data-sources/cloud_identity_policy
...
export class DataGoogleCloudIdentityPolicy extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleCloudIdentityPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.41.0/docs/data-sources/cloud_identity_policy#import import section} in the documentation of this resource for the id to use
