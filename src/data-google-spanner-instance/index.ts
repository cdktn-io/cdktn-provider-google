...
// https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/data-sources/spanner_instance
...
export class DataGoogleSpannerInstance extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleSpannerInstance that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/data-sources/spanner_instance#import import section} in the documentation of this resource for the id to use
