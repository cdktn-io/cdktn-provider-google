...
// https://registry.terraform.io/providers/hashicorp/google/7.33.0/docs/data-sources/vmwareengine_network
...
export class DataGoogleVmwareengineNetwork extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleVmwareengineNetwork that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.33.0/docs/data-sources/vmwareengine_network#import import section} in the documentation of this resource for the id to use
