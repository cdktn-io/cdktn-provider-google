...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/filestore_backup
...
export interface FilestoreBackupConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function filestoreBackupTimeoutsToTerraform(struct?: FilestoreBackupTimeouts | cdktn.IResolvable): any {
...
export function filestoreBackupTimeoutsToHclTerraform(struct?: FilestoreBackupTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class FilestoreBackupTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): FilestoreBackupTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: FilestoreBackupTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class FilestoreBackup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FilestoreBackup that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/filestore_backup#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the FilestoreBackup to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_filestore_backup", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/filestore_backup google_filestore_backup} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      source_file_share: cdktn.stringToTerraform(this._sourceFileShare),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      source_file_share: {
        value: cdktn.stringToHclTerraform(this._sourceFileShare),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
