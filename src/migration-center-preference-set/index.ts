...
// https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/migration_center_preference_set
...
export interface MigrationCenterPreferenceSetVirtualMachinePreferencesComputeEnginePreferences {
  ...
  */
  readonly persistentDiskType?: string;
  /**
...
export function migrationCenterPreferenceSetVirtualMachinePreferencesComputeEnginePreferencesToTerraform(struct?: MigrationCenterPreferenceSetVirtualMachinePreferencesComputeEnginePreferencesOutputReference | MigrationCenterPreferenceSetVirtualMachinePreferencesComputeEnginePreferences): any {
  ...
  return {
    ...
    persistent_disk_type: cdktn.stringToTerraform(struct!.persistentDiskType),
...
export function migrationCenterPreferenceSetVirtualMachinePreferencesComputeEnginePreferencesToHclTerraform(struct?: MigrationCenterPreferenceSetVirtualMachinePreferencesComputeEnginePreferencesOutputReference | MigrationCenterPreferenceSetVirtualMachinePreferencesComputeEnginePreferences): any {
  ...
  const attrs = {
    ...
    persistent_disk_type: {
      value: cdktn.stringToHclTerraform(struct!.persistentDiskType),
      isBlock: false,
      type: "simple",
      storageClassType: "string",
    },
...
export class MigrationCenterPreferenceSetVirtualMachinePreferencesComputeEnginePreferencesOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): MigrationCenterPreferenceSetVirtualMachinePreferencesComputeEnginePreferences | undefined {
    ...
    if (this._persistentDiskType !== undefined) {
      hasAnyValues = true;
      internalValueResult.persistentDiskType = this._persistentDiskType;
    }
  ...
  public set internalValue(value: MigrationCenterPreferenceSetVirtualMachinePreferencesComputeEnginePreferences | undefined) {
    if (value === undefined) {
      ...
      this._persistentDiskType = undefined;
      this._machinePreferences.internalValue = undefined;
    }
    else {
      this.isEmptyObject = Object.keys(value).length === 0;
      this._licenseType = value.licenseType;
      this._persistentDiskType = value.persistentDiskType;
  ...
  // persistent_disk_type - computed: false, optional: true, required: false
  private _persistentDiskType?: string; 
  public get persistentDiskType() {
    return this.getStringAttribute('persistent_disk_type');
  }
  public set persistentDiskType(value: string) {
    this._persistentDiskType = value;
  }
  public resetPersistentDiskType() {
    this._persistentDiskType = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get persistentDiskTypeInput() {
    return this._persistentDiskType;
  }
...
export class MigrationCenterPreferenceSet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MigrationCenterPreferenceSet that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/migration_center_preference_set#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.34.0/docs/resources/migration_center_preference_set google_migration_center_preference_set} Resource
  *
  * @param scope The scope in which to define this construct
