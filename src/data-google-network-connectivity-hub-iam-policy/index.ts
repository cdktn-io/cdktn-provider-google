...
// https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/data-sources/network_connectivity_hub_iam_policy
...
export class DataGoogleNetworkConnectivityHubIamPolicy extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleNetworkConnectivityHubIamPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/data-sources/network_connectivity_hub_iam_policy#import import section} in the documentation of this resource for the id to use
