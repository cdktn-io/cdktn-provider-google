...
// https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/apigee_data_collector
...
export class ApigeeDataCollector extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigeeDataCollector that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/apigee_data_collector#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.40.0/docs/resources/apigee_data_collector google_apigee_data_collector} Resource
  *
  * @param scope The scope in which to define this construct
