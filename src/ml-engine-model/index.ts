...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/ml_engine_model
...
export class MlEngineModel extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MlEngineModel that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/ml_engine_model#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/ml_engine_model google_ml_engine_model} Resource
  *
  * @param scope The scope in which to define this construct
