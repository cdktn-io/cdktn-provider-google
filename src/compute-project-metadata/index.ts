...
// https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/resources/compute_project_metadata
...
export class ComputeProjectMetadata extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ComputeProjectMetadata that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.38.0/docs/resources/compute_project_metadata#import import section} in the documentation of this resource for the id to use
