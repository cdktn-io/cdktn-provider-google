...
// https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/discovery_engine_data_store
...
export interface DiscoveryEngineDataStoreConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly aclEnabled?: boolean | cdktn.IResolvable;
  /**
...
export interface DiscoveryEngineDataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfig {
  ...
  */
  readonly enableGetProcessedDocument?: boolean | cdktn.IResolvable;
  /**
  ...
  */
  readonly enableLlmLayoutParsing?: boolean | cdktn.IResolvable;
  /**
...
export function discoveryEngineDataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfigToTerraform(struct?: DiscoveryEngineDataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfigOutputReference | DiscoveryEngineDataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfig): any {
  ...
  return {
    enable_get_processed_document: cdktn.booleanToTerraform(struct!.enableGetProcessedDocument),
    enable_image_annotation: cdktn.booleanToTerraform(struct!.enableImageAnnotation),
    enable_llm_layout_parsing: cdktn.booleanToTerraform(struct!.enableLlmLayoutParsing),
...
export function discoveryEngineDataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfigToHclTerraform(struct?: DiscoveryEngineDataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfigOutputReference | DiscoveryEngineDataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfig): any {
  ...
  const attrs = {
    enable_get_processed_document: {
      value: cdktn.booleanToHclTerraform(struct!.enableGetProcessedDocument),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
    ...
    enable_llm_layout_parsing: {
      value: cdktn.booleanToHclTerraform(struct!.enableLlmLayoutParsing),
      isBlock: false,
      type: "simple",
      storageClassType: "boolean",
    },
...
export class DiscoveryEngineDataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfigOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): DiscoveryEngineDataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfig | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
    if (this._enableGetProcessedDocument !== undefined) {
      hasAnyValues = true;
      internalValueResult.enableGetProcessedDocument = this._enableGetProcessedDocument;
    }
    if (this._enableImageAnnotation !== undefined) {
      hasAnyValues = true;
      internalValueResult.enableImageAnnotation = this._enableImageAnnotation;
    }
    if (this._enableLlmLayoutParsing !== undefined) {
      hasAnyValues = true;
      internalValueResult.enableLlmLayoutParsing = this._enableLlmLayoutParsing;
    }
  ...
  public set internalValue(value: DiscoveryEngineDataStoreDocumentProcessingConfigDefaultParsingConfigLayoutParsingConfig | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._enableGetProcessedDocument = undefined;
      this._enableImageAnnotation = undefined;
      this._enableLlmLayoutParsing = undefined;
      ...
      this.isEmptyObject = Object.keys(value).length === 0;
      this._enableGetProcessedDocument = value.enableGetProcessedDocument;
      this._enableImageAnnotation = value.enableImageAnnotation;
      this._enableLlmLayoutParsing = value.enableLlmLayoutParsing;
  ...
  // enable_get_processed_document - computed: false, optional: true, required: false
  private _enableGetProcessedDocument?: boolean | cdktn.IResolvable; 
  public get enableGetProcessedDocument() {
    return this.getBooleanAttribute('enable_get_processed_document');
  }
  public set enableGetProcessedDocument(value: boolean | cdktn.IResolvable) {
    this._enableGetProcessedDocument = value;
  }
  public resetEnableGetProcessedDocument() {
    this._enableGetProcessedDocument = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get enableGetProcessedDocumentInput() {
    return this._enableGetProcessedDocument;
  }
  ...
  // enable_llm_layout_parsing - computed: false, optional: true, required: false
  private _enableLlmLayoutParsing?: boolean | cdktn.IResolvable; 
  public get enableLlmLayoutParsing() {
    return this.getBooleanAttribute('enable_llm_layout_parsing');
  }
  public set enableLlmLayoutParsing(value: boolean | cdktn.IResolvable) {
    this._enableLlmLayoutParsing = value;
  }
  public resetEnableLlmLayoutParsing() {
    this._enableLlmLayoutParsing = undefined;
  }
  // Temporarily expose input value. Use with caution.
  public get enableLlmLayoutParsingInput() {
    return this._enableLlmLayoutParsing;
  }
...
export class DiscoveryEngineDataStore extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DiscoveryEngineDataStore that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/discovery_engine_data_store#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.45.0/docs/resources/discovery_engine_data_store google_discovery_engine_data_store} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // acl_enabled - computed: false, optional: true, required: false
  private _aclEnabled?: boolean | cdktn.IResolvable; 
  public get aclEnabled() {
    return this.getBooleanAttribute('acl_enabled');
  }
  public set aclEnabled(value: boolean | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      acl_enabled: cdktn.booleanToTerraform(this._aclEnabled),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      acl_enabled: {
        value: cdktn.booleanToHclTerraform(this._aclEnabled),
        isBlock: false,
        type: "simple",
        storageClassType: "boolean",
      },
