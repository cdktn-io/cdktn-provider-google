...
// https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/data-sources/compute_disk
...
export class DataGoogleComputeDisk extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleComputeDisk that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/data-sources/compute_disk#import import section} in the documentation of this resource for the id to use
