...
// https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/resources/apigee_security_feedback
...
export class ApigeeSecurityFeedback extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApigeeSecurityFeedback that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.31.0/docs/resources/apigee_security_feedback#import import section} in the documentation of this resource for the id to use
