...
// https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/sql_database_instances
...
export interface DataGoogleSqlDatabaseInstancesConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/sql_database_instances#database_version DataGoogleSqlDatabaseInstances#database_version}
  */
  readonly databaseVersion?: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/sql_database_instances#id DataGoogleSqlDatabaseInstances#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/sql_database_instances#project DataGoogleSqlDatabaseInstances#project}
  */
  readonly project?: string;
  /**
  * To filter out the database instances which are located in this specified region.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/sql_database_instances#region DataGoogleSqlDatabaseInstances#region}
  */
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/sql_database_instances#state DataGoogleSqlDatabaseInstances#state}
  */
  readonly state?: string;
  /**
  * To filter out the database instances based on the machine type.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/sql_database_instances#tier DataGoogleSqlDatabaseInstances#tier}
  */
  readonly tier?: string;
  /**
  * To filter out the database instances which are located in this specified zone.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/sql_database_instances#zone DataGoogleSqlDatabaseInstances#zone}
  */
...
export class DataGoogleSqlDatabaseInstancesInstancesSettingsActiveDirectoryConfigOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // admin_credential_secret_name - computed: true, optional: false, required: false
  public get adminCredentialSecretName() {
    return this.getStringAttribute('admin_credential_secret_name');
  }
...
export class DataGoogleSqlDatabaseInstancesInstancesSettingsIpConfigurationPscConfigPscAutoConnectionsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // instance_auto_dns_status - computed: true, optional: false, required: false
  public get instanceAutoDnsStatus() {
    return this.getStringAttribute('instance_auto_dns_status');
  }
  ...
  // write_endpoint_auto_dns_status - computed: true, optional: false, required: false
  public get writeEndpointAutoDnsStatus() {
    return this.getStringAttribute('write_endpoint_auto_dns_status');
  }
}
...
export class DataGoogleSqlDatabaseInstancesInstancesSettingsIpConfigurationPscConfigOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // psc_auto_dns_enabled - computed: true, optional: false, required: false
  public get pscAutoDnsEnabled() {
    return this.getBooleanAttribute('psc_auto_dns_enabled');
  }
  ...
  // psc_write_endpoint_dns_enabled - computed: true, optional: false, required: false
  public get pscWriteEndpointDnsEnabled() {
    return this.getBooleanAttribute('psc_write_endpoint_dns_enabled');
  }
}
...
export class DataGoogleSqlDatabaseInstancesInstancesSettingsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // replication_lag_max_seconds - computed: true, optional: false, required: false
  public get replicationLagMaxSeconds() {
    return this.getNumberAttribute('replication_lag_max_seconds');
  }
...
export class DataGoogleSqlDatabaseInstancesInstancesOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // include_replicas_for_major_version_upgrade - computed: true, optional: false, required: false
  public get includeReplicasForMajorVersionUpgrade() {
    return this.getBooleanAttribute('include_replicas_for_major_version_upgrade');
  }
  ...
  // switch_transaction_logs_to_cloud_storage_enabled - computed: true, optional: false, required: false
  public get switchTransactionLogsToCloudStorageEnabled() {
    return this.getBooleanAttribute('switch_transaction_logs_to_cloud_storage_enabled');
  }
}
...
/**
* Represents a {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/sql_database_instances google_sql_database_instances}
*/
export class DataGoogleSqlDatabaseInstances extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleSqlDatabaseInstances that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/sql_database_instances#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.46.0/docs/data-sources/sql_database_instances google_sql_database_instances} Data Source
  *
  * @param scope The scope in which to define this construct
