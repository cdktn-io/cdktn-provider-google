...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/public_ca_external_account_key
...
export class PublicCaExternalAccountKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PublicCaExternalAccountKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/public_ca_external_account_key#import import section} in the documentation of this resource for the id to use
