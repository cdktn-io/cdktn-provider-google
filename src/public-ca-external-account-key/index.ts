...
// https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/public_ca_external_account_key
...
export interface PublicCaExternalAccountKeyConfig extends cdktn.TerraformMetaArguments {
  /**
...
export function publicCaExternalAccountKeyTimeoutsToTerraform(struct?: PublicCaExternalAccountKeyTimeouts | cdktn.IResolvable): any {
...
export function publicCaExternalAccountKeyTimeoutsToHclTerraform(struct?: PublicCaExternalAccountKeyTimeouts | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class PublicCaExternalAccountKeyTimeoutsOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  public get internalValue(): PublicCaExternalAccountKeyTimeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: PublicCaExternalAccountKeyTimeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
...
*/
export class PublicCaExternalAccountKey extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PublicCaExternalAccountKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/public_ca_external_account_key#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "google_public_ca_external_account_key", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/google/7.42.0/docs/resources/public_ca_external_account_key google_public_ca_external_account_key} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // mac_key - computed: true, optional: false, required: false
  public get macKey() {
    return this.getStringAttribute('mac_key');
  }
