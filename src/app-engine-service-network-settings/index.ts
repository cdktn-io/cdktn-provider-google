...
// https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/app_engine_service_network_settings
...
export class AppEngineServiceNetworkSettings extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AppEngineServiceNetworkSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.43.0/docs/resources/app_engine_service_network_settings#import import section} in the documentation of this resource for the id to use
