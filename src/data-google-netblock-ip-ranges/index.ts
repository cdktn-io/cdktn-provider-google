...
// https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/data-sources/netblock_ip_ranges
...
export class DataGoogleNetblockIpRanges extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleNetblockIpRanges that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.36.0/docs/data-sources/netblock_ip_ranges#import import section} in the documentation of this resource for the id to use
