...
// https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/data-sources/beyondcorp_app_connection
...
export class DataGoogleBeyondcorpAppConnection extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataGoogleBeyondcorpAppConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/google/7.37.0/docs/data-sources/beyondcorp_app_connection#import import section} in the documentation of this resource for the id to use
